	...
	switch (Global_112380)
	{
		case 0:
			if (!Global_112380.f_27)
			{
				...
				{
					iVar0 = iVar1;
					if (func_66(func_67(iVar0)) && (Global_112380.f_15[iVar1] + 120000) < unk_0x9CD27B0045628463())
					{
						if (func_64(iVar0))
						{
							func_63(iVar0, 0);
						...
						else
						{
							...
							else if (((unk_0x9CD27B0045628463() >= Global_112380.f_4[iVar1] && func_51()) && func_50(iVar0)) && func_49(iVar0) >= func_48(iVar0))
							{
							...
							if (func_47() == 2)
							{
								func_55(&uLocal_36, 0, unk_0xD80958FC74E988A6(), "TREVOR", 0, 1);
							}
							else if (func_47() == 0)
							{
								func_55(&uLocal_36, 0, unk_0xD80958FC74E988A6(), "MICHAEL", 0, 1);
							}
							else if (func_47() == 1)
							{
								func_55(&uLocal_36, 0, unk_0xD80958FC74E988A6(), "FRANKLIN", 0, 1);
							}
	...
	if (func_51())
	{
		...
		else
		{
			...
			if (iVar1 == 1)
			{
				...
				Var2.f_4 = 1;
				Var2.f_5 = 0;
				unk_0xB8BA7F44DF1575E1("stripperhome", &Var2, 6, 1424);
				func_29(Global_112380.f_1, -1);
				Global_112380 = 3;
			}
			else
...
void func_29(int iParam0, int iParam1)
{
	if (iParam1 > -1)
	{
		Global_112380.f_4[iParam0] = (unk_0x9CD27B0045628463() + iParam1);
	}
	else
	{
		Global_112380.f_4[iParam0] = (unk_0x9CD27B0045628463() + unk_0xD53343AA4FB7DD28(1200000, 2100000));
	}
}
...
void func_68()
{
	...
	switch (Global_112380)
	{
		case 0:
			...
			{
				if (unk_0x9CD27B0045628463() >= Global_112380.f_3)
				{
...
int func_76()
{
	...
	while (iVar0 < 10)
	{
		if (Global_113386.f_243[func_47() /*53*/].f_2[iVar0 /*5*/].f_4 && unk_0x9CD27B0045628463() >= Global_112380.f_4[iVar0])
		{
			iVar2[bVar1] = iVar0;
			bVar1++;
		}
...
void func_79()
{
	...
	{
		if (Global_112380.f_3 < (unk_0x9CD27B0045628463() + 120000))
		{
			func_82(1800000);
		}
...
void func_82(int iParam0)
{
	if (iParam0 != -1)
	{
		Global_112380.f_3 = (unk_0x9CD27B0045628463() + iParam0);
	}
	else
	{
