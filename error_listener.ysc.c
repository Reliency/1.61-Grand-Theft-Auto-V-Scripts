...
void func_2()
{
	...
	iVar0 = 0;
	while (iVar0 < unk_0x5F92A689A06620AA(2))
	{
		iVar1 = unk_0xD8F66A3A60C62153(2, iVar0);
		if (func_10(iVar1))
		{
			func_9(&Var2);
			func_8(2, iVar0, iVar1, &Var2);
			Var2.f_1 = (unk_0xFC8202EFC642E6F2() - 1);
			Var2.f_0 = iVar1;
...
void func_3(int iParam0)
{
	...
	iVar0 = *iParam0;
	if (((func_5() && func_4(iVar0)) && iVar0 != 248) && unk_0x580CE4438479CC61())
	{
		unk_0x95914459A87EBA28(0, 1, 0);
	}
}
...
void func_8(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	{
		if (unk_0x2902843FCD2B2D79(iParam0, iParam1, &uVar0, 1))
		{
			uParam3->f_2 = uVar0;
		}
	}
