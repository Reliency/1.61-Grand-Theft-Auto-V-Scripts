...
void func_186(int iParam0, bool bParam1, struct<3> Param2)
{
	if (unk_0x5E9564D8246B909A(unk_0x4F8644AF03D0E0D6()))
	{
...
void func_196(bool bParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_129(bParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_198(uParam1) || !unk_0x1F0B79228E461EC9(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_197(iParam2) && !unk_0xD71649DB0A545AA3(bParam0, unk_0xD80958FC74E988A6(), 25f))
					{
						unk_0x5AD23D40115353AC(bParam0, unk_0xD80958FC74E988A6(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_198(uParam1) && uParam1->f_4 == 0) && unk_0xF1B760881820C952(unk_0x3FEF770D40960D5A(unk_0xD80958FC74E988A6(), true), unk_0x3FEF770D40960D5A(bParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_197(iParam2) || unk_0xD71649DB0A545AA3(bParam0, unk_0xD80958FC74E988A6(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0xEA47FE3719165B94(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
			...
			if (unk_0x7239B21A38F536BA(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_204(unk_0xD80958FC74E988A6(), uParam0->f_35[iVar0]))
							{
...
int func_207(bool bParam0, float fParam1)
{
	float fVar0;
	
	if (func_129(unk_0xD80958FC74E988A6()) && func_129(bParam0))
	{
		if (func_218(bParam0) || unk_0x7912F7FC4F6264B6(unk_0x4F8644AF03D0E0D6(), bParam0))
		{
...
{
	return func_209(bParam0, unk_0xD80958FC74E988A6(), fParam1, 1, 250, 7);
}

bool func_209(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	
	iVar2 = func_217(bParam0, bParam1);
	...
	if (!func_213(bParam0, bParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar2 == -1)
	...
	uVar0 = func_210(&(Local_37[iVar2 /*4*/]), Var1, bParam1, &(Local_37[iVar2 /*4*/].f_3), bParam0, bParam5);
	return (uVar0 || (unk_0x9CD27B0045628463() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_210(var uParam0, struct<3> Param1, bool bParam2, var uParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_211(bool bParam0, bool bParam1)
{
	bool bVar0;
...
int func_213(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_215(unk_0x3FEF770D40960D5A(bParam1, true) - unk_0x3FEF770D40960D5A(bParam0, true)) };
	...
	{
		Var1 = { func_215(unk_0x17C07FC640E86B4E(bParam0, 31086, 0f, 5f, 0f) - unk_0x17C07FC640E86B4E(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_219(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_129(unk_0xD80958FC74E988A6()) && func_129(bParam0))
	{
		...
		if (!bParam2)
		{
			if (func_223(bParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_220(bParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_220(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_221(bool bParam0, float fParam1)
{
	...
	{
		if (func_222(bParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_222(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_215(Param1 - unk_0x3FEF770D40960D5A(bParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_223(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (unk_0x34616828CD07F1A1(unk_0xD80958FC74E988A6()))
...
int func_234(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_239(&iVar0) || !unk_0xD031A9162D01088C("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 3:
			if (func_128(uParam0->f_28[0]) && func_129(uParam0->f_41[0]))
			{
				...
				iVar3 += 512;
				iVar3 += 4096;
				unk_0xC77720A12FE14A86(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar3, 1000f);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_235(bool bParam0, int iParam1, struct<3> Param2, bool bParam3, char* sParam4, int iParam5)
{
	if (func_236(bParam0, iParam1, Param2, bParam3, 1))
	{
		if (unk_0x7239B21A38F536BA(*bParam0))
		{
			if (!unk_0x5F9532F3B5CC2551(*bParam0, false))
...
int func_236(bool bParam0, int iParam1, struct<3> Param2, bool bParam3, bool bParam4)
{
	bool bVar0;
	
	if (!func_36(iParam1))
	{
		bVar0 = func_241(iParam1);
...
void func_238(bool bParam0, bool bParam1, struct<3> Param2, bool bParam3)
{
	func_201(bParam0);
...
void func_240(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_52 = unk_0x1B5C85C612E5256E(Var0, Var1, false, true, true, true);
