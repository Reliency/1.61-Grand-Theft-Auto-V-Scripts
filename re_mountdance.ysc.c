...
void __EntryFunction__()
{
	...
	iLocal_41 = 49;
	iLocal_42 = 64;
	bLocal_88 = joaat("u_m_o_taphillbilly");
	bLocal_94 = "SPECIAL_PED@MOUNTAIN_DANCER@MONOLOGUE_1@MONOLOGUE_1A";
	bLocal_97 = -1;
	Local_89 = { ScriptParam_98.f_1[0 /*3*/] };
	bLocal_90 = ScriptParam_98.f_17[0];
	...
	while (true)
	{
		...
		if (unk_0x7239B21A38F536BA(bLocal_91))
		{
			if (unk_0x5F9532F3B5CC2551(bLocal_91, false) && !iLocal_95 == 7)
			{
		...
		{
			case 0:
				if ((unk_0xC5042CC6F5E3D450() && !func_34()) && !func_12())
				{
					if (func_11())
					{
						bLocal_91 = unk_0xD49F9B0955C367DE(26, bLocal_88, Local_89, bLocal_90, true, true);
						unk_0x9F8AA94D6D97DBF4(bLocal_91, true);
						bLocal_92 = unk_0x509D5878EB39E842(joaat("prop_tapeplayer_01"), 704.7615f, 4179.574f, 39.7093f, true, true, false);
						unk_0x8E2530AA8ADA980E(bLocal_92, (233.8288f + 180f));
						unk_0x93376B65A266EB5F(bLocal_91, 0, false, false, false);
						iLocal_95 = 1;
					}
				}
				else
			...
			case 1:
				bLocal_97 = unk_0x8C18E0F9080ADD73(Local_89 + Vector(1f, 0f, 0f), 0f, 0f, bLocal_90, 2);
				unk_0xEEA929141F699854(bLocal_91, bLocal_97, bLocal_94, "MTN_DNC_if_you_want_to_get_to_heaven", 2f, -2f, 1, 0, 1000f, 0);
				unk_0x950A154B8DAB6185("MNT_DNC", bLocal_91);
				iLocal_95 = 2;
				break;
			
			case 2:
				if (unk_0x029FE7CD1B7E2E75(bLocal_97, "MNT_DNC") == 1)
				{
					unk_0x8B2FD4560E55DD2D(bLocal_97);
					iLocal_95 = 3;
				}
				break;
			
			case 3:
				Var0 = { unk_0x3FEF770D40960D5A(bLocal_91, true) };
				unk_0xDC2C5C242AAC342B(bLocal_91, 3f);
				if (func_10(unk_0xD80958FC74E988A6(), bLocal_91) < 10f)
				{
					unk_0xC32779C16FCEECD9(unk_0xD80958FC74E988A6(), 1, bLocal_91, 31086, 0f, 0f, 0f, 0, -1, -1);
					unk_0xC32779C16FCEECD9(bLocal_91, 1, unk_0xD80958FC74E988A6(), 31086, 0f, 0f, 0f, 0, -1, -1);
				}
				if (func_9(bLocal_91, unk_0xD80958FC74E988A6(), 1) < 25f)
				{
					if (!unk_0xA6DB27D19ECBB7DA(bLocal_96))
					{
						func_5(&bLocal_96, &bLocal_91, 0);
						unk_0x03D7FB09E75D6B7E(bLocal_96, 3);
					}
				}
				else if (unk_0xA6DB27D19ECBB7DA(bLocal_96))
				{
					func_4(&bLocal_96);
				}
				if (unk_0xE4A310B1D7FA73CC(bLocal_97) > 0.9999999f)
				{
					iLocal_95 = 1;
				}
				if (unk_0x47E4E977581C5B55(bLocal_91))
				{
					unk_0x92D6A88E64A94430(bLocal_97);
					iLocal_95 = 4;
				}
				if (((((unk_0x84A2DD9AC37C35C1(bLocal_91) || unk_0x3F2023999AD51C1F(Var0, 50f, true)) || unk_0x3F2023999AD51C1F(Var0, 50f, false)) || unk_0x5270A8FBC098C3F8(Var0, 20f, 20f, 20f, false)) || unk_0xAB0F816885B0E483(-1, Var0, 50f)) || (((unk_0x3C06B5C839B38F7B(unk_0x4F8644AF03D0E0D6(), bLocal_91) || unk_0x7912F7FC4F6264B6(unk_0x4F8644AF03D0E0D6(), bLocal_91)) && unk_0xF1B760881820C952(unk_0x3FEF770D40960D5A(unk_0xD80958FC74E988A6(), true), Var0, true) < 25f) && func_1(bLocal_91, unk_0xD80958FC74E988A6(), 1126825984, 0)))
				{
					unk_0x92D6A88E64A94430(bLocal_97);
					iLocal_95 = 4;
					iLocal_93 = 1;
			...
			case 4:
				...
				if (!unk_0x47E4E977581C5B55(bLocal_91))
				{
					if (iLocal_93 == 1)
					{
						unk_0x15D3A79D4E44B913(bLocal_91, 723.1315f, 4171.957f, 39.7091f, 2f, -1, 1f, 1024, 1193033728);
					}
					else
					{
						unk_0x15D3A79D4E44B913(bLocal_91, 723.1315f, 4171.957f, 39.7091f, 1f, -1, 1f, 1024, 1193033728);
					}
					unk_0x971D38760FBC02EF(bLocal_91, true);
					iLocal_95 = 6;
				}
				break;
			
			case 6:
				if (unk_0x77F1BEB8863288D5(bLocal_91, 713668775) != 1 && unk_0x77F1BEB8863288D5(bLocal_91, 713668775) != 0)
				{
					unk_0x9F8AA94D6D97DBF4(bLocal_91, false);
					if (iLocal_93 == 1)
					{
						unk_0x22B0D0E37CCB840D(bLocal_91, unk_0xD80958FC74E988A6(), 100f, -1, false, false);
					}
					else
					{
						unk_0xBB9CE077274F6A1B(bLocal_91, 1193033728, 0);
					}
					unk_0x971D38760FBC02EF(bLocal_91, true);
					iLocal_95 = 5;
				}
			...
			case 5:
				if ((unk_0xE31C2C72B8692B64(bLocal_91) && unk_0xF1B760881820C952(unk_0x3FEF770D40960D5A(bLocal_91, true), unk_0x3FEF770D40960D5A(unk_0xD80958FC74E988A6(), true), true) > 50f) && !unk_0xC5042CC6F5E3D450())
				{
					func_37(1);
				}
				break;
...
int func_1(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_3(unk_0x3FEF770D40960D5A(bParam1, true) - unk_0x3FEF770D40960D5A(bParam0, true)) };
	...
	{
		Var1 = { func_3(unk_0x17C07FC640E86B4E(bParam0, 31086, 0f, 5f, 0f) - unk_0x17C07FC640E86B4E(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_5(bool bParam0, bool bParam1, bool bParam2)
{
	if (!unk_0xA6DB27D19ECBB7DA(*bParam0))
	{
		if (unk_0x7239B21A38F536BA(*bParam1))
		{
			...
			{
				*bParam0 = func_6(*bParam1, bParam2, 145);
				if (bParam2 == 0)
				{
...
bool func_6(bool bParam0, bool bParam1, int iParam2)
{
	bool bVar0;
	
	bVar0 = func_7(bParam0, !bParam1, 0);
...
bool func_7(bool bParam0, bool bParam1, bool bParam2)
{
	bool bVar0;
	...
	{
		unk_0xD38744167B2FA257(bVar0, func_8(unk_0x10FAB35428CCC9D7(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xD38744167B2FA257(bVar0, func_8(unk_0x10FAB35428CCC9D7(), 0.7f, 0.7f));
		unk_0x6F6F290102C02AB4(bVar0, bParam1);
	}
...
float func_9(bool bParam0, bool bParam1, bool bParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_11()
{
	...
	unk_0xD3BD40951412FEF6(bLocal_94);
	if (unk_0x98A4EB5D89A0C952(bLocal_88) && unk_0xD031A9162D01088C(bLocal_94))
	{
		return 1;
	}
	return 0;
...
int func_12()
{
	...
	{
		if (unk_0xA8CEACB4F35AE058(unk_0x4805D2B1D8CF94A9(unk_0xD80958FC74E988A6())) > 1369f && !func_27())
		{
			return 0;
		}
	}
...
{
	if (unk_0x7239B21A38F536BA(bLocal_92))
	{
		unk_0x539E0AE3E6634B9F(&bLocal_92);
	}
	if (unk_0xA6DB27D19ECBB7DA(bLocal_96))
	{
		func_4(&bLocal_96);
	...
	if (unk_0x7239B21A38F536BA(bLocal_91))
	{
		if (bParam0)
		{
			unk_0x9614299DCB53E54B(&bLocal_91);
		}
		else
		{
			unk_0x2595DD4236549CE3(&bLocal_91);
		}
	}
