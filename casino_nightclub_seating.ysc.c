...
int func_66()
{
	...
	if (func_77(unk_0x4F8644AF03D0E0D6()) && unk_0xB16FCE9DDC7BA182())
	{
		return 1;
	}
	if (func_69())
...
int func_80(bool bParam0)
{
	if (bParam0 != func_53())
	{
		if (func_54(bParam0, 1, 1))
		{
			...
			{
				return func_81(Global_2689235[bParam0 /*453*/].f_318.f_6) == 19;
			}
		}
	}
	return 0;
	...
	else
	{
		...
		if (unk_0xB8DFD30D6973E135(bParam0) && (unk_0x5E9564D8246B909A(bParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_94(unk_0x4F8644AF03D0E0D6(), 0) && !func_93()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_89(iVar27) && !unk_0x26AA915AD89BFB4B(iVar27))
				{
					if (!bVar22)
					{
...
void func_90(bool bParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		...
		if (func_94(unk_0x4F8644AF03D0E0D6(), 0))
		{
