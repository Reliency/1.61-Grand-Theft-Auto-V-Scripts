...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!Global_44247 && unk_0x9CD27B0045628463() > Global_43603)
		{
			iVar5 = 0;
			while (iVar5 < 122)
			{
			...
			iVar7 = 0;
			iVar8 = 0;
			func_20(bVar1, bVar2, &iVar7, &iVar7, &iVar6, &iVar7, &iVar7, &iVar7);
			if (iVar6 < 0)
			{
				iVar6 = (iVar6 * -1);
			}
...
void func_2(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_3(unk_0x1CCD9A37359072CF(&cVar2, &cVar2, false, 2, unk_0x7B5280EBA9840C72(func_4(iParam1)), 0));
		}
		else
		{
			func_3(unk_0x1CCD9A37359072CF("CHAR_DEFAULT", "CHAR_DEFAULT", false, 2, unk_0x7B5280EBA9840C72(func_4(iParam1)), 0));
		}
		switch (Global_20266)
		{
			case 0:
...
void func_20(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (func_30(bParam0, bParam1))
	{
		bVar0 = func_29(bParam1);
		iVar1 = func_27(bParam0);
		iVar2 = (func_27(bParam0) - func_27(bParam1));
		iVar3 = (func_29(bParam0) - func_29(bParam1));
		iVar4 = (func_26(bParam0) - func_26(bParam1));
		iVar5 = (func_25(bParam0) - func_25(bParam1));
		iVar6 = (func_24(bParam0) - func_24(bParam1));
		iVar7 = (func_23(bParam0) - func_23(bParam1));
	}
	else
	{
		bVar0 = func_29(bParam0);
		iVar1 = func_27(bParam1);
		iVar2 = (func_27(bParam1) - func_27(bParam0));
		iVar3 = (func_29(bParam1) - func_29(bParam0));
		iVar4 = (func_26(bParam1) - func_26(bParam0));
		iVar5 = (func_25(bParam1) - func_25(bParam0));
		iVar6 = (func_24(bParam1) - func_24(bParam0));
		iVar7 = (func_23(bParam1) - func_23(bParam0));
	}
	while (iVar7 < 0)
	{
		iVar7 += 60;
	...
	while (iVar4 < 0)
	{
		...
		iVar4 = (iVar4 + func_22(bVar0, iVar1));
		iVar3 = (iVar3 - 1);
		bVar0 = unk_0xF2DB717A73826179(func_21(unk_0xBBDA792448DB5A89(bVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
int func_30(bool bParam0, bool bParam1)
{
	...
	if (!func_31(bParam1) || !func_31(bParam0))
	{
		return 1;
	}
...
int func_34(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iParam3 != -1)
	{
		if (func_36(unk_0xD80958FC74E988A6(), iParam3, 0))
		{
			return 0;
		}
	}
...
var func_61()
{
	...
	func_67(&uVar0, unk_0x494E97C2EF27C470());
	func_66(&uVar0, unk_0x13D2B8ADD79640F2());
	func_65(&uVar0, unk_0x25223CA6B4D20B7F());
...
void func_64(var uParam0, bool bParam1)
{
	...
	if (bParam1 < 1 || bParam1 > func_22(iVar0, iVar1))
	{
		return;
	}
