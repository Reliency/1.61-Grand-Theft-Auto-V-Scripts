							...
							if (iLocal_57 == -1)
							{
								...
								if (iLocal_64)
								{
									...
									else if (unk_0x48AF36444B965238())
									{
										...
										{
											unk_0x933D6A9EEC1BACD0(&Global_4541229, 17);
...
void func_4()
{
	if (Global_53556 != -1)
	{
		unk_0xBE2CACCF5A8AA805(func_16(Global_53556));
		Global_53556 = -1;
	}
	Global_44247 = 0;
...
void func_5()
{
	...
	switch (Global_20266.f_1)
	{
		case 6:
			...
			if (Global_8741 == 1)
			{
				func_64(Global_20247, "DISPLAY_VIEW", 1f, unk_0xBBDA792448DB5A89(Global_20270), -1082130432, -1082130432, -1082130432);
				Global_20246 = Global_20270;
			}
			else
			{
				func_64(Global_20247, "DISPLAY_VIEW", 1f, unk_0xBBDA792448DB5A89(Global_20271), -1082130432, -1082130432, -1082130432);
		...
		case 9:
			...
			{
				func_10();
				func_64(Global_20247, "SET_THEME", unk_0xBBDA792448DB5A89(Global_113386.f_14051[Global_20266 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				if (Global_21618)
				{
				...
				{
					func_13(Global_20247, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(false), unk_0xBBDA792448DB5A89(2), -1f, -1f, &(Global_117[Global_7451 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
				}
				else
				{
					func_13(Global_20247, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(false), unk_0xBBDA792448DB5A89(2), -1f, -1f, &(Global_1998[Global_7451 /*29*/].f_3), &(Global_1998[Global_7451 /*29*/].f_7), "CELL_217", &(Global_1998[Global_7451 /*29*/].f_3), 0);
				}
				func_64(Global_20247, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_21605 == 4 || Global_21605 == 3)
			{
				...
				else
				{
					...
					if (func_8(Global_7451, Global_20266) == 0)
					{
						...
						func_13(Global_20247, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(false), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_117[Global_7451 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_64(Global_20247, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_13(Global_20247, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(false), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_1998[Global_7451 /*29*/].f_3), &(Global_1998[Global_7451 /*29*/].f_7), &cVar0, &(Global_1998[Global_7451 /*29*/].f_3), 0);
					}
				}
				func_64(Global_20247, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
					...
					if (bVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[bVar0] == 0)
						{
							...
							if (Global_2725398)
							{
								if (iVar1 == 14)
								{
									func_13(Global_20247, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(true), unk_0xBBDA792448DB5A89(bVar0), unk_0xBBDA792448DB5A89(Global_8143[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(Global_22668), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8705[bVar0] = 1;
						}
					...
					if (bVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[bVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_13(Global_20247, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(true), unk_0xBBDA792448DB5A89(bVar0), unk_0xBBDA792448DB5A89(Global_8143[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(Global_22673), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_78319)
								{
									...
									func_13(Global_20247, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(true), unk_0xBBDA792448DB5A89(bVar0), unk_0xBBDA792448DB5A89(Global_8143[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(bVar4), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20266)
									...
									func_13(Global_20247, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(true), unk_0xBBDA792448DB5A89(bVar0), unk_0xBBDA792448DB5A89(Global_8143[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(bVar6), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_8143[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_13(Global_20247, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(true), unk_0xBBDA792448DB5A89(bVar0), unk_0xBBDA792448DB5A89(Global_8143[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(bVar9), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_13(Global_20247, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(true), unk_0xBBDA792448DB5A89(bVar0), unk_0xBBDA792448DB5A89(Global_8143[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(false), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8705[bVar0] = 1;
						}
					}
...
void func_17()
{
	...
	{
		iLocal_56 = 0;
		fLocal_66 = unk_0xBBDA792448DB5A89(iLocal_56);
	...
	if (!iLocal_60)
	{
		...
		{
			iLocal_60 = 1;
			unk_0xF6E48914C7A8694E(Global_20247, "SET_INPUT_EVENT");
			unk_0xC3D0841A0CC546A6(true);
			unk_0xC6796A8FFA375E53();
	...
	{
		if (unk_0x83666F9FB8FEBD4B() > 100 && bLocal_56 != -1)
		{
			unk_0xF6E48914C7A8694E(Global_20247, "SET_INPUT_EVENT");
			unk_0xC3D0841A0CC546A6(true);
			unk_0xC6796A8FFA375E53();
	...
	{
		if (unk_0xC9D9444186B5A374() > 100 && bLocal_56 != -1)
		{
			unk_0xF6E48914C7A8694E(Global_20247, "SET_INPUT_EVENT");
			unk_0xC3D0841A0CC546A6(3);
			unk_0xC6796A8FFA375E53();
	...
	if (!iLocal_59)
	{
		if (unk_0xF3A21BCD95725A4A(2, 176) && unk_0xC9D9444186B5A374() > 100)
		{
			if (bLocal_56 == -1)
			{
				...
				iLocal_49 = unk_0xC50AA39A577AF886();
				while (!unk_0x768FF8961BA904D6(iLocal_49))
				{
					unk_0x4EDE34FBADD967A6(0);
				}
				iLocal_50 = unk_0x2DE7EFA66B906036(iLocal_49);
				bLocal_56 = iLocal_50;
				if (func_39(iLocal_51) == 0)
				{
					bLocal_56 = -1;
				...
				if (!bLocal_56 == -1)
				{
					if (iLocal_67 == 1)
					{
						fLocal_66 = unk_0xBBDA792448DB5A89(bLocal_56);
						iLocal_67 = 0;
					}
					Global_20266.f_1 = 8;
					iLocal_54 = 1;
			...
			{
				if (func_34(iLocal_51, bLocal_56) && !iLocal_55)
				{
					iLocal_57 = 0;
					iLocal_54 = 1;
					unk_0x5AE11BC36633DE4E(0);
			...
			{
				iLocal_57 = 0;
				func_22(iLocal_51, bLocal_56, iLocal_57);
				iLocal_55 = 1;
				iLocal_57 = -1;
				iLocal_54 = 1;
				func_37();
		...
		if (unk_0xF3A21BCD95725A4A(2, 177))
		{
			...
			if (iLocal_58 == 0)
			{
				if (!bLocal_56 == -1)
				{
					if (iLocal_57 == -1)
					{
						bLocal_56 = unk_0xF2DB717A73826179(fLocal_66);
						iLocal_64 = 0;
						unk_0x5AE11BC36633DE4E(0);
						bVar0 = true;
						func_21();
...
int func_18(int iParam0, bool bParam1, int iParam2)
{
	...
	if (unk_0x2C83A9DA6BFFC4F9(joaat("appsecuroserv")) > 0)
	{
		if (bVar0)
		{
		}
	...
	if (unk_0x2C83A9DA6BFFC4F9(joaat("appbikerbusiness")) > 0)
	{
		if (bVar1)
		{
		}
	...
	if (unk_0x2C83A9DA6BFFC4F9(joaat("appimportexport")) > 0)
	{
		if (bVar2)
		{
		}
	...
	if (bVar0)
	{
		if (!unk_0xE6CC9F3BA0FB9EF1("appSecuroServ"))
		{
			unk_0x6EB5F71AA68F2E8E("appSecuroServ");
			if (bParam1)
			{
				return 0;
			}
		}
		while (!unk_0xE6CC9F3BA0FB9EF1("appSecuroServ"))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		unk_0xE81651AD79516E48("appSecuroServ", 4592);
		unk_0xC90D2DCACD56184C("appSecuroServ");
		return 1;
	}
	if (bVar1)
	{
		if (!unk_0xE6CC9F3BA0FB9EF1("appBikerBusiness"))
		{
			unk_0x6EB5F71AA68F2E8E("appBikerBusiness");
			if (bParam1)
			{
				return 0;
			}
		}
		while (!unk_0xE6CC9F3BA0FB9EF1("appBikerBusiness"))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		unk_0xE81651AD79516E48("appBikerBusiness", 4592);
		unk_0xC90D2DCACD56184C("appBikerBusiness");
		return 1;
	}
	if (bVar2)
	{
		if (!unk_0xE6CC9F3BA0FB9EF1("appImportExport"))
		{
			unk_0x6EB5F71AA68F2E8E("appImportExport");
			if (bParam1)
			{
				return 0;
			}
		}
		while (!unk_0xE6CC9F3BA0FB9EF1("appImportExport"))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		unk_0xE81651AD79516E48("appImportExport", 4592);
		unk_0xC90D2DCACD56184C("appImportExport");
		return 1;
	}
...
void func_22(int iParam0, bool bParam1, int iParam2)
{
	...
	iVar1 = ((Global_53195[iVar0 /*120*/] - 1) - bParam1);
	while (iVar1 >= 16)
	{
		iVar1 = (iVar1 - 16);
	}
...
void func_28(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_29(unk_0x1CCD9A37359072CF(&cVar2, &cVar2, false, 2, unk_0x7B5280EBA9840C72(func_30(iParam1)), 0));
		}
		else
		{
			func_29(unk_0x1CCD9A37359072CF("CHAR_DEFAULT", "CHAR_DEFAULT", false, 2, unk_0x7B5280EBA9840C72(func_30(iParam1)), 0));
		}
		switch (Global_20266)
		{
			case 0:
	...
	if (!bVar5)
	{
		...
		if (Global_47582[iVar2 /*46*/].f_42 > 1)
		{
			...
			while (iVar11 < iVar9)
			{
				...
				unk_0xF6E48914C7A8694E(iParam0, "SET_DATA_SLOT");
				unk_0xC3D0841A0CC546A6(9);
				unk_0xC3D0841A0CC546A6(iVar11 + 1);
	...
	else
	{
		...
		else
		{
			...
			if (!bVar19)
			{
				...
				{
					unk_0x80338406F3475E55(&Var18);
					iVar20 = 0;
					iVar20 = 0;
					while (iVar20 < Global_53557[iVar13 /*203*/].f_10[iVar3 /*48*/].f_6)
					{
						unk_0xC63CD5D2920ACBE7(&(Global_53557[iVar13 /*203*/].f_10[iVar3 /*48*/].f_7[iVar20 /*4*/]));
						iVar20++;
					}
					unk_0x362E2D3FE93A9959();
				}
...
int func_57(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	while (iVar5 < 16)
	{
		...
		if (bVar7)
		{
			...
			unk_0xC63CD5D2920ACBE7(sVar8);
			unk_0x03B504CF259931BC(Global_113386.f_24904[iVar6 /*4*/].f_3);
			unk_0x362E2D3FE93A9959();
			unk_0xC6796A8FFA375E53();
			bVar2++;
			iVar0 = 1;
...
void func_61(int iParam0, int iParam1)
{
	...
	Global_53556 = iVar5;
	unk_0xDFA2EF8E04127DD5(func_16(iVar5), false);
	while (!unk_0x0145F696AAAAD2E4(func_16(iVar5)))
	{
...
void func_63()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			unk_0xBE4390CB40B3E627(Global_44252[iVar0]);
...
float func_69(struct<3> Param0, struct<3> Param1, struct<3> Param2, struct<3> Param3, float fParam4, bool bParam5)
{
	...
	fVar1 = func_71((unk_0xBBDA792448DB5A89((unk_0x9CD27B0045628463() - iLocal_18)) / fParam4), 0f, 1f);
	if (fVar1 < 1f)
	{
		fVar2 = fVar1;
		if (bParam5)
...
void func_75(bool bParam0)
{
	...
	if (unk_0xF6201B4DAF662A9D() || func_76())
	{
	...
	if (bParam0)
	{
		unk_0xF6E48914C7A8694E(Global_20247, "SET_SOFT_KEYS");
		unk_0xC3D0841A0CC546A6(true);
		unk_0xC58424BA936EB458(true);
...
void func_80()
{
	...
	{
		if (func_83(Global_113386.f_2363.f_539.f_4321) != unk_0x9F47B058362C84B5(unk_0xD80958FC74E988A6()))
		{
