...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_33(unk_0xD80958FC74E988A6());
		if (func_1())
		{
			func_41();
		}
...
void func_16(bool bParam0)
{
	...
	while (bVar0 <= 26)
	{
		func_21(&(Local_42[bVar0 /*178*/]), bVar0);
		bVar0++;
	}
	bVar0 = false;
	while (bVar0 <= 29)
	{
		func_20(&(Local_44[bVar0 /*24*/]), bVar0);
		bVar0++;
	}
	bVar0 = false;
	while (bVar0 <= 23)
	{
		func_19(&(Local_46[bVar0 /*24*/]), bVar0);
		bVar0++;
	}
...
void func_17(bool bParam0)
{
	...
	{
		case 0:
			func_18(bParam0, 0, 10000);
			break;
		
		case 1:
			func_18(bParam0, 9000, 10000);
			break;
		
		case 2:
			func_18(bParam0, 27000, 32000);
			break;
		
		case 3:
			func_18(bParam0, 32000, 42000);
			break;
		
		case 4:
			func_18(bParam0, 51000, 63000);
			break;
		
		case 5:
			func_18(bParam0, 63600, 69000);
			break;
		
		case 6:
			func_18(bParam0, 66000, 70200);
			break;
		
		case 7:
			func_18(bParam0, 69600, joaat("ss1_03_98_lod"));
			break;
		
		case 8:
			func_18(bParam0, 77400, 84000);
			break;
		
		case 12:
			func_18(bParam0, 81000, 93600);
			break;
		...
		case 11:
			func_18(bParam0, 90000, 154200);
			break;
		
		case 10:
			func_18(bParam0, 129600, 133200);
			break;
		
		case 13:
			func_18(bParam0, 144600, 154200);
			break;
		
		case 14:
			func_18(bParam0, 152700, 154200);
			break;
		
		case 15:
			func_18(bParam0, 154200, 154200);
			break;
	}
}
...
int func_27(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
int func_28(bool bParam0, var uParam1, int iParam2)
{
	int iVar0;
	...
	if (*uParam1 == 0)
	{
		*uParam1 = unk_0x11FE353CF9733E6F(bParam0);
	}
...
int func_29(bool bParam0, int iParam1)
{
	...
	if (unk_0xD031A9162D01088C(bParam0))
	{
		return 1;
	}
	if (iParam1 == 0)
	...
	{
		unk_0x4EDE34FBADD967A6(false);
		if (unk_0x9CD27B0045628463() > iVar0 && !unk_0xD031A9162D01088C(bParam0))
		{
			return 0;
		}
	}
...
void func_31(int iParam0, int iParam1)
{
	...
	*iParam0 = unk_0x1B5C85C612E5256E(-7000f, -7000f, -100f, 7000f, 7000f, 315f, false, true, true, true);
	...
	if (func_33(unk_0xD80958FC74E988A6()) && iParam1 == 1)
	{
...
{
	unk_0xF66A602F829E2A06(bParam0);
}
...
void func_46(var uParam0)
{
	...
	while (iVar0 < uParam0->f_17)
	{
		...
		{
			unk_0x28004F88151E03E0(uParam0->f_17[iVar0], sVar2, bVar1, -1000f);
		}
