...
void __EntryFunction__()
{
	...
	iLocal_30 = 52;
	iLocal_28 = 77;
	if (unk_0x2C83A9DA6BFFC4F9(joaat("rampage_controller")) > 1)
	{
	...
	while (iVar0 < 5)
	{
		...
		unk_0x933D6A9EEC1BACD0(&(Global_113386.f_18574[(iLocal_30 + iVar0) /*6*/]), 3);
		iVar0++;
	}
	func_19(1);
	while (true)
...
void func_3()
{
	...
	{
		if (func_7(Global_113386.f_2363.f_539.f_4321) != unk_0x9F47B058362C84B5(unk_0xD80958FC74E988A6()))
		{
...
void func_14(bool bParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
void func_28()
{
	...
	{
		func_32(13, unk_0xF34EE736CF047844(Global_113386.f_10194.f_3853));
	}
