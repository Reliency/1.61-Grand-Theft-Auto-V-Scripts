...
void func_186(int iParam0)
{
	...
	if ((unk_0x9CD27B0045628463() - iLocal_58) > 1250)
	{
		if (func_129(iParam0->f_28[0]) && !unk_0xE659E47AF827484B(iParam0->f_28[0]))
		{
			if (func_129(unk_0xD80958FC74E988A6()) && !func_187(unk_0xD80958FC74E988A6(), iParam0->f_28[0], 50f, 1))
			{
				Var0 = { unk_0x3FEF770D40960D5A(iParam0->f_28[0], true) };
				Var1 = { unk_0x3FEF770D40960D5A(unk_0xD80958FC74E988A6(), true) };
				fVar3 = (Var1.f_0 - Var0.f_0);
				fVar4 = (Var1.f_1 - Var0.f_1);
				if (fVar4 != 0f)
				{
					bVar2 = unk_0x8927CBF9D22261A4(fVar3, fVar4);
				}
				else if (fVar3 < 0f)
				{
					bVar2 = -90f;
				...
				unk_0x8E2530AA8ADA980E(iParam0->f_28[0], bVar2);
			}
		}
...
bool func_187(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
...
void func_188()
{
	...
	unk_0xF6E48914C7A8694E(iLocal_56, "SET_COLOUR");
	...
	unk_0xF6E48914C7A8694E(iLocal_56, "SET_DISTANCE");
	unk_0xD69736AAE04DB51A(10f);
	unk_0xC6796A8FFA375E53();
	unk_0x5F15302936E07111(iLocal_57);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x54972ADAF0294A93(iLocal_56, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x9CD27B0045628463() - iLocal_58) > 1250)
	{
		unk_0x8D8686B622B88120(bLocal_59, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", false, 0, false);
		iLocal_58 = unk_0x9CD27B0045628463();
	}
}

int func_189(int iParam0, struct<3> Param1, char[4] cParam2, bool bParam3, int iParam4, char* sParam5, var uParam6)
{
	var uVar0;
	...
	if (!*uParam6 == 3)
	{
		if (func_177(2))
		{
			if (!func_148())
			{
				if ((func_129(unk_0xD80958FC74E988A6()) && func_129(iParam0->f_28[0])) && func_196(unk_0xD80958FC74E988A6(), Param1, 1) < 20f)
				{
			...
			if (func_196(unk_0xD80958FC74E988A6(), Param1, 1) < 20f && *uParam6 == 1)
			{
...
void func_197(int iParam0, bool bParam1, struct<3> Param2)
{
	if (unk_0x5E9564D8246B909A(unk_0x4F8644AF03D0E0D6()))
	{
...
void func_206(bool bParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_129(bParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_208(uParam1) || !unk_0x1F0B79228E461EC9(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_207(iParam2) && !unk_0xD71649DB0A545AA3(bParam0, unk_0xD80958FC74E988A6(), 25f))
					{
						unk_0x5AD23D40115353AC(bParam0, unk_0xD80958FC74E988A6(), false);
						uParam1->f_3 = 5;
					}
					else if ((func_208(uParam1) && uParam1->f_4 == 0) && unk_0xF1B760881820C952(unk_0x3FEF770D40960D5A(unk_0xD80958FC74E988A6(), true), unk_0x3FEF770D40960D5A(bParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_207(iParam2) || unk_0xD71649DB0A545AA3(bParam0, unk_0xD80958FC74E988A6(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0xEA47FE3719165B94(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, false, false, false, false);
			...
			if (unk_0x7239B21A38F536BA(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_214(unk_0xD80958FC74E988A6(), uParam0->f_35[iVar0]))
							{
...
int func_217(bool bParam0, float fParam1)
{
	float fVar0;
	
	if (func_129(unk_0xD80958FC74E988A6()) && func_129(bParam0))
	{
		if (func_228(bParam0) || unk_0x7912F7FC4F6264B6(unk_0x4F8644AF03D0E0D6(), bParam0))
		{
...
bool func_218(bool bParam0, float fParam1)
{
	return func_219(bParam0, unk_0xD80958FC74E988A6(), fParam1, 1, 250, 7);
}

bool func_219(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	
	iVar2 = func_227(bParam0, bParam1);
	...
	if (!func_223(bParam0, bParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar2 == -1)
	...
	uVar0 = func_220(&(Local_37[iVar2 /*4*/]), Var1, bParam1, &(Local_37[iVar2 /*4*/].f_3), bParam0, bParam5);
	return (uVar0 || (unk_0x9CD27B0045628463() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_220(var uParam0, struct<3> Param1, bool bParam2, var uParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_221(bool bParam0, bool bParam1)
{
	bool bVar0;
...
int func_223(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_225(unk_0x3FEF770D40960D5A(bParam1, true) - unk_0x3FEF770D40960D5A(bParam0, true)) };
	...
	{
		Var1 = { func_225(unk_0x17C07FC640E86B4E(bParam0, 31086, 0f, 5f, 0f) - unk_0x17C07FC640E86B4E(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_229(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_129(unk_0xD80958FC74E988A6()) && func_129(bParam0))
	{
		...
		if (!bParam2)
		{
			if (func_233(bParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_230(bParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_230(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_231(bool bParam0, float fParam1)
{
	...
	{
		if (func_232(bParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_232(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_225(Param1 - unk_0x3FEF770D40960D5A(bParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_233(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (unk_0x34616828CD07F1A1(unk_0xD80958FC74E988A6()))
...
void func_244()
{
	iLocal_56 = unk_0x11FE353CF9733E6F("digiscanner");
	while (!unk_0x85F01B8D5B90570E(iLocal_56))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	...
	if (unk_0x78DCDC15C9F116B4("digiscanner"))
	{
		iLocal_57 = unk_0x1A6478B61C6BDC3B("digiscanner");
	}
	bLocal_59 = unk_0x430386FE9BF80B45();
	iLocal_58 = unk_0x9CD27B0045628463();
}
...
void func_247(bool bParam0, bool bParam1, struct<3> Param2, bool bParam3)
{
	func_248(bParam0);
...
int func_255(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if ((func_129(uParam0->f_28[0]) && unk_0x7239B21A38F536BA(uParam0->f_41[0])) && unk_0x7239B21A38F536BA(uParam0->f_41[1]))
			{
...
void func_269(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && unk_0x7239B21A38F536BA(iParam0->f_41[1]))
		{
			unk_0x3AE22DEB5BA5A3E6(&(iParam0->f_41[1]));
		}
