...
int func_1(var uParam0, var uParam1)
{
	...
	if (uParam0->f_2)
	{
		if (unk_0xF0D31AD191A74F87(unk_0xA2C6FC031D46FFF0(unk_0x9CD27B0045628463(), uParam0->f_1)) >= uParam0->f_3)
		{
			func_5();
		}
	}
					...
					if (iVar2 >= Var3.f_4 && iVar2 != 27)
					{
						if (iVar7 != 0 && Var3.f_5 != 0)
						{
							if (unk_0xA0D79393A2E01ED3(iVar7, Var3.f_5, &fVar0))
							{
								...
								{
									uParam0->f_2 = 1;
									uParam0->f_3 = unk_0xD53343AA4FB7DD28(20000, 30000);
									uParam0->f_1 = unk_0x9CD27B0045628463();
								}
							}
							else if (unk_0x40FCE03E50E8DBE8(iVar7, Var3.f_5, &iVar1))
							{
...
void func_5()
{
	unk_0xB3CD58CCA6CDA852();
	unk_0x1A992DA297A4630C(-9f, -9f, -9f, -10f, -10f, -10f, -25f, -25f, -25f, -28f, -28f, -28f, 0f, 0f, 0f, 0, 0, 0);
	unk_0x1B5C85C612E5256E(-9f, -9f, -9f, -10f, -10f, -10f, false, true, true, true);
	func_5();
}
