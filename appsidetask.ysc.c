...
void func_5()
{
	unk_0x3A618A217E5154F0(0.824f, 0.5f, 0.253f, 0.313f, false, false, false, 155, false);
	func_6();
}
...
void func_7(float fParam0, float fParam1, char* sParam2, bool bParam3, bool bParam4)
{
