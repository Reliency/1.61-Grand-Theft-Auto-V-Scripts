...
void func_1()
{
	...
	if (bLocal_92)
	{
		...
		unk_0x8509B634FBE7DA11(&Local_94);
		if (bLocal_93)
		{
			unk_0x6C188BE134E074AA(&Local_95);
		}
		else
		{
			unk_0xC63CD5D2920ACBE7(&Global_43987);
			unk_0xC63CD5D2920ACBE7(&Local_95);
		}
		unk_0x238FFE5C7B0498A6(0, false, bVar0, 50);
	}
	else
	{
		unk_0x8509B634FBE7DA11(&Local_94);
...
void func_2(int iParam0)
{
	...
	if (iParam0 && !func_3())
	{
		unk_0x67C540AA08E4A6F5(-1, "Boss_Message_Orange", sVar0, false);
	}
}
...
{
	return func_5(unk_0x4F8644AF03D0E0D6(), bParam0);
}

int func_5(bool bParam0, bool bParam1)
{
	return func_6(bParam0, bParam1, 1);
}
...
void func_10(int iParam0)
{
	...
	while (iVar0 < 6)
	{
		if (Global_43792[iVar0 /*32*/] && Global_43792[iVar0 /*32*/].f_4)
		{
			...
			{
				if (!unk_0x46E9AE36D8FA6417(Global_43792[iVar0 /*32*/].f_31))
				{
					if (*iParam0 > -1)
					{
						func_11();
...
void func_26()
{
	if (!unk_0xD9D2CFFF49FAB35F() && !func_32())
	{
		if (func_31(0))
		{
			if (!unk_0xCA042B6957743895(&(Global_2714762.f_785.f_12)))
			{
				func_30();
				func_27(6, 0, 0);
			}
...
void func_35()
{
	...
	if (Global_1835455 != -1)
	{
		...
		if (unk_0xF6201B4DAF662A9D() || func_40())
		{
			if (!iLocal_97)
			{
				if (unk_0x9F0C0A981D73FA56(&(Var0[0 /*13*/])))
				{
					iLocal_97 = 1;
				}
			}
			if (iLocal_97)
			{
				...
				else
				{
					...
					{
						StringCopy(&(Global_2359296[func_39() /*5567*/].f_5390.f_18[Global_1835455 /*6*/]), unk_0x426141162EBE5CDB(&(Var0[0 /*13*/])), 24);
					}
					func_38();
				}
			}
		}
		else if (unk_0xCCA1072C29D096C2() || func_37())
		{
			if (func_36(Var0[0 /*13*/]))
			{
				...
				{
					case 0:
						iLocal_99 = unk_0xD66C9E72B3CC4982(&Var0, 1);
						if (iLocal_99 >= 0)
						{
							iLocal_98++;
						}
					...
					case 1:
						iVar2 = unk_0x58CC181719256197(iLocal_99, &Var1, 1);
						switch (iVar2)
						{
							case -1:
								func_38();
		...
		else
		{
			if (func_36(Var0[0 /*13*/]))
			{
				StringCopy(&(Global_2359296[func_39() /*5567*/].f_5390.f_18[Global_1835455 /*6*/]), unk_0xC82630132081BB6F(&(Var0[0 /*13*/])), 24);
			}
			func_38();
		}
	}
