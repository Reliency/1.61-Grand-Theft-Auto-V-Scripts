...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_23(unk_0x4F8644AF03D0E0D6()) && unk_0x7239B21A38F536BA(func_22()))
		{
			iLocal_31 = func_22();
		}
		else
		{
			iLocal_31 = unk_0xD80958FC74E988A6();
		}
		if (unk_0x5F9532F3B5CC2551(iLocal_31, false))
		{
		}
		func_1();
	}
...
void func_1()
{
	...
	{
		Var0 = { unk_0x3FEF770D40960D5A(iLocal_31, false) };
		Var1 = { func_19(iLocal_29) };
		if (unk_0xB7A628320EFF8E47(Var1, Var0) < IntToFloat(func_18(iLocal_29)))
		{
			bVar2 = false;
			iVar3 = 0;
			iVar3 = 0;
			while (iVar3 < func_17(iLocal_29))
			{
				if (!bVar2)
				{
					if (unk_0x51210CED3DA1C78A(iLocal_31, func_16(iLocal_29, iVar3), func_15(iLocal_29, iVar3), func_14(iLocal_29, iVar3), false, true, 0))
					{
						bVar2 = true;
					}
				}
			...
			if (bVar2)
			{
				unk_0x59E727A1C9D3E31A(unk_0xD24D37CC275948CC(func_13(iLocal_29)), Var1.f_0, Var1.f_1, func_12(iLocal_29), func_11(iLocal_29));
				func_10(iLocal_29);
			}
		}
	}
	if (unk_0x10FAB35428CCC9D7())
	{
		if (func_2())
		{
			...
			{
				unk_0xE80492A9AC099A93(&uLocal_32, true);
			}
			if (unk_0xB0034A223497FFCB())
			{
				if (!BitTest(uLocal_32, 0))
				{
					unk_0x75A9A10948D1DEA6(15, true, -1);
					unk_0x933D6A9EEC1BACD0(&uLocal_32, false);
				}
			}
			else if (BitTest(uLocal_32, 0))
			{
				unk_0x75A9A10948D1DEA6(15, false, -1);
				unk_0xE80492A9AC099A93(&uLocal_32, false);
			}
		}
		else if (!BitTest(uLocal_32, 1))
		{
			unk_0x75A9A10948D1DEA6(15, false, -1);
			unk_0xE80492A9AC099A93(&uLocal_32, false);
			unk_0x933D6A9EEC1BACD0(&uLocal_32, true);
		}
	}
}
...
int func_2()
{
	...
	if (func_5(unk_0x4F8644AF03D0E0D6(), 1))
	{
		bVar0 = func_4();
		if (bVar0 != func_3())
		{
