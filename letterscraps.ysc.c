...
void __EntryFunction__()
{
	...
	if (unk_0x2C83A9DA6BFFC4F9(joaat("letterscraps")) > 1)
	{
		...
		case 0:
			...
			else if (!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()))
			{
				if (unk_0x5A859503B0C08678())
				{
					if (!func_20())
					{
						if (((!unk_0x7497D2CE2C30D24C() && !func_14()) && !func_13()) && !func_12())
						{
							iLocal_58 = 0;
							iLocal_56 = 0;
							...
							iLocal_55 = unk_0x11FE353CF9733E6F("LETTER_SCRAPS");
							while (!unk_0x85F01B8D5B90570E(iLocal_55))
							{
								unk_0x4EDE34FBADD967A6(0);
							}
							unk_0xF6E48914C7A8694E(iLocal_55, "SET_LETTER_TEXT");
							func_11(sLocal_57[0]);
							unk_0xC6796A8FFA375E53();
							unk_0xC6372ECD45D73BCD(true);
							func_7(1);
							func_6(1, 1, 1, 0);
							unk_0x960C9FF8F616E41C("LETTERS_HELP2", false);
		...
		case 1:
			...
			if (iLocal_56 < 4)
			{
				if (!iLocal_58)
				{
					...
					else if (unk_0xF3A21BCD95725A4A(2, 189))
					{
				...
				unk_0x0DF606929C105BE1(iLocal_55, 255, 255, 255, 255, 0);
			}
			else
			{
				iLocal_43 = 2;
...
int func_2()
{
	if ((unk_0xF3A21BCD95725A4A(2, 190) || unk_0xF3A21BCD95725A4A(2, 189)) || unk_0xF3A21BCD95725A4A(2, 202))
	{
		return 1;
	}
	return 0;
...
{
	unk_0x0A24DA3A41B718F5(bParam1);
...
bool func_19(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	unk_0x0A24DA3A41B718F5(bParam1);
	unk_0xC63CD5D2920ACBE7(bParam2);
...
void func_21()
{
	switch (iLocal_43)
	{
		...
		case 1:
			if (!func_58(14) && !unk_0xB16FCE9DDC7BA182())
			{
		...
		if (!(iParam1[uParam0->f_10 /*11*/])->f_10)
		{
			if (!bVar1)
			{
				...
				else if (uParam0->f_10 == iLocal_51)
				{
					...
					{
						unk_0x3F6167F351168730((iParam1[uParam0->f_10 /*11*/])->f_1, sLocal_52);
					}
				}
				else
				{
...
void func_24(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int* iParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
	...
	if (*uParam0)
	{
		switch (*iParam4)
		{
			...
			case 1:
				...
				unk_0x03B504CF259931BC(func_26(iParam3));
				unk_0x362E2D3FE93A9959();
				unk_0xC6796A8FFA375E53();
...
int func_38(var uParam0, var uParam1, struct<3> Param2)
{
	...
	if ((uParam1[bVar0 /*11*/])->f_10)
	{
		...
		{
			if (unk_0x80EC48E6679313F9((uParam1[bVar0 /*11*/])->f_1) || func_53((uParam1[bVar0 /*11*/])->f_1))
			{
	...
	{
		if ((unk_0xB7A628320EFF8E47(Param2, unk_0x225B8B35C88029B3((uParam1[bVar0 /*11*/])->f_1)) > (60f * 60f) || func_58(13)) || func_58(14))
		{
...
void func_44()
{
	...
	bVar3 = false;
	unk_0x767FBC2AC802EF3D(func_46(0), &bVar0, -1);
	iVar1 = (iVar1 + bVar0);
	if (bVar0 > 0)
	{
		func_45(18, bVar0);
	}
	unk_0x767FBC2AC802EF3D(func_46(1), &bVar0, -1);
	iVar1 = (iVar1 + bVar0);
	if (bVar0 > 0)
	{
		func_45(19, bVar0);
	}
	unk_0x767FBC2AC802EF3D(func_46(3), &bVar0, -1);
	iVar1 = (iVar1 + bVar0);
	if (bVar0 > 0)
	{
		func_45(20, bVar0);
...
void func_55(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	bool bVar0;
...
void func_60(bool bParam0, var uParam1, var uParam2)
{
	...
	*bParam0 = 0;
	...
	{
		if (func_27((bParam0->f_2 + bVar0), -1))
		{
			iVar1++;
			func_51(bParam0, bVar0, 1);
			if (bLocal_40)
			{
			}
		}
...
void func_68()
{
	...
	if (!unk_0xBEDB96A7584AA8CF())
	{
		if (!Global_78319)
		{
			if (func_69() == 2 == 0 && !unk_0x10FAB35428CCC9D7())
			{
...
void func_73()
{
	...
	unk_0x1D132D614DD86811(&iLocal_55);
	...
	if (iLocal_60)
	{
		unk_0xE532F5D78798DAAB(Local_44.f_7);
	}
	unk_0x1090044AD1DA76FA();
}
