...
int func_2()
{
	...
	iVar0 = 0;
	while (iVar0 < bLocal_233)
	{
		func_26(bLocal_233[iVar0], iVar0);
		iVar0++;
	}
	if (unk_0x25D39B935A038A26(Global_97771))
	{
		fVar1 = unk_0xE4A310B1D7FA73CC(Global_97771);
		if (!unk_0xCA042B6957743895(&Local_318))
		{
			if (!iLocal_322)
			{
				if (fVar1 < fLocal_321)
	...
	if (unk_0x2A488C176D52CCA5(Var2, Local_243) < 100f)
	{
		return 0;
	}
	iVar0 = 0;
	while (iVar0 < bLocal_233)
	{
		if (!unk_0x84A2DD9AC37C35C1(bLocal_233[iVar0]))
		{
			Var3 = { unk_0x3FEF770D40960D5A(bLocal_233[iVar0], true) };
			if (unk_0x2A488C176D52CCA5(Var2, Var3) < 100f)
			{
				return 0;
			}
		}
...
void func_26(bool bParam0, int iParam1)
{
	...
	if (!unk_0x84A2DD9AC37C35C1(bParam0))
	{
		...
		{
			case 0:
				if (unk_0x1F0B79228E461EC9(bParam0, &Local_297, &(Local_307[iParam1 /*16*/]), 2))
				{
					fVar0 = -1f;
					fVar1 = -1f;
					if (unk_0x07F1BE2BCCAA27A7(&Local_297, &(Local_307[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1) || func_35(&Local_297, &(Local_307[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1))
					{
						fVar2 = unk_0xE4A310B1D7FA73CC(Global_97771);
						if (fVar2 > fVar0)
						{
							unk_0xE1EF3C1216AFF2CD(bParam0);
							unk_0x43D3807C077261E3(bParam0, -8f, true);
							...
							if (iLocal_66 == 263)
							{
								...
								func_33(bParam0, "GENERIC_FRIGHTENED_HIGH", "A_M_O_TRAMP_01_BLACK_FULL_01", 24);
							}
							if (iLocal_66 == 244)
							{
								fVar3 = 2f;
							...
							unk_0x15D3A79D4E44B913(bParam0, Local_243 + Local_246[iParam1 /*3*/], fVar3, -1, (fLocal_248[iParam1] * 0.1f), false, 1193033728);
							unk_0xF28965D04F570DCA(bParam0, iVar4, false, 0, false);
				...
				{
					unk_0xE1EF3C1216AFF2CD(bParam0);
					if (unk_0xCA042B6957743895(&(Local_308[iParam1 /*16*/])))
					{
						if (func_32(Local_246[iParam1 /*3*/], 0f, 0f, 0f, 0))
						{
							Var5 = { unk_0x3FEF770D40960D5A(bParam0, true) };
							Local_246[iParam1 /*3*/] = { Var5 - Local_243 * Vector(4f, 4f, 4f) };
						}
						if (!unk_0xCA042B6957743895(&(Local_316[iParam1 /*16*/])))
						{
							unk_0xAF8A94EDE7712BEF(bParam0, &(Local_316[iParam1 /*16*/]), 0.25f);
						}
						unk_0x15D3A79D4E44B913(bParam0, Local_243 + Local_246[iParam1 /*3*/], 1f, -1, 0.25f, false, 1193033728);
						iLocal_234[iParam1] = 1;
					}
					else
					{
						if (!unk_0x25D39B935A038A26(bLocal_317))
						{
							bLocal_317 = unk_0x8C18E0F9080ADD73(Local_243, 0f, 0f, bLocal_244, 2);
							unk_0xD9A897A4C6C2974F(bLocal_317, true);
						}
						iVar6 = 5;
						iVar7 = 144;
						iVar8 = 0;
						if (iLocal_240[0] == joaat("p_trev_rope_01_s") || iLocal_240[1] == joaat("p_trev_rope_01_s"))
						{
							...
							unk_0x9F8AA94D6D97DBF4(bLocal_233[iParam1], true);
							unk_0x63F58F7C80513AAD(bLocal_233[iParam1], false);
							unk_0xDF993EE5E90ABA25(bLocal_233[iParam1], false);
							unk_0x166E7CF68597D8B5(bLocal_233[iParam1], 1000);
							unk_0x6B76DC1F3AE6E6A3(bLocal_233[iParam1], unk_0x15D757606D170C3C(bLocal_233[iParam1]), false);
							unk_0xEBD76F2359F190AC(bLocal_233[iParam1], false);
							unk_0xC1E8A365BF3B29F2(bLocal_233[iParam1], 64, true);
							unk_0xC1E8A365BF3B29F2(bLocal_233[iParam1], 249, true);
							unk_0xC1E8A365BF3B29F2(bLocal_233[iParam1], 335, true);
							iVar9 = 0;
							while (iVar9 < iLocal_239)
							{
								unk_0x1760FFA8AB074D66(iLocal_239[iVar9], false);
								unk_0x8A7391690F5AFD81(iLocal_239[iVar9], false);
								iVar9++;
							}
						}
						if (!func_31(iVar7, 16))
						...
						unk_0xEEA929141F699854(bLocal_233[iParam1], bLocal_317, &Local_297, &(Local_308[iParam1 /*16*/]), 1000f, -1000f, iVar6, iVar7, 1000f, iVar8);
						iVar9 = 0;
						while (iVar9 < iLocal_239)
						{
							if (iLocal_240[iVar9] != 0)
							{
								if (!unk_0xCA042B6957743895(&(Local_313[iVar9 /*16*/])))
								{
									unk_0xC77720A12FE14A86(iLocal_239[iVar9], bLocal_317, &(Local_313[iVar9 /*16*/]), &Local_297, 8f, 8f, 0, 1000f);
								}
							}
							iVar9++;
						}
			...
			case 1:
				if (!unk_0x9BB01E3834671191(bLocal_233[iParam1], iLocal_238))
				{
					if (!unk_0x7C6B0C22F9F40BBE(iLocal_238))
					{
						iLocal_238 = unk_0x90370EBE0FEE1A3D(0);
					}
					if (iParam1 == 0)
					{
						unk_0x2A7819605465FBCE(bLocal_233[iParam1], iLocal_238);
					}
					else
					{
						unk_0x9F3480FE65DB31B5(bLocal_233[iParam1], iLocal_238);
					}
				}
				if (unk_0x77F1BEB8863288D5(bParam0, 713668775) != 1)
				{
					...
					{
						fLocal_248[iParam1] = (unk_0x652D2EEEF1D3E62C(Local_246[iParam1 /*3*/]) * 0.75f);
					}
					unk_0xE054346CA3A0F315(bParam0, Local_243 + Local_246[iParam1 /*3*/], fLocal_248[iParam1], 3f, 6f);
			...
			case 10:
				...
				unk_0xC1E8A365BF3B29F2(bLocal_233[iParam1], 249, true);
				unk_0xC1E8A365BF3B29F2(bLocal_233[iParam1], 335, true);
				if (unk_0x1F0B79228E461EC9(bLocal_233[iParam1], &Local_297, &(Local_308[iParam1 /*16*/]), 2))
				{
					if (iLocal_66 == 288)
					{
						if (iLocal_323 <= 0)
						{
							iLocal_323 = (unk_0x9CD27B0045628463() + unk_0xD53343AA4FB7DD28(10000, 15000));
						}
						...
						if (iLocal_323 > 0)
						{
							if (unk_0x9CD27B0045628463() > iLocal_323)
							{
								func_27(&uLocal_67, 3, bLocal_233[iParam1], "PIERWOMAN", 0, 1);
				...
				else
				{
					...
					unk_0xEEA929141F699854(bLocal_233[iParam1], bLocal_317, &Local_297, &(Local_308[iParam1 /*16*/]), 1000f, -1000f, iVar11, iVar12, 1000f, iVar13);
					iVar14 = 0;
					while (iVar14 < iLocal_239)
					{
						if (iLocal_240[iVar14] != 0)
						{
							if (!unk_0xCA042B6957743895(&(Local_313[iVar14 /*16*/])))
							{
								unk_0xC77720A12FE14A86(iLocal_239[iVar14], bLocal_317, &(Local_313[iVar14 /*16*/]), &Local_297, 8f, 8f, 0, 1000f);
							}
						}
						iVar14++;
					}
				...
				switch (iLocal_236[iParam1])
				{
					...
					case 0:
						bVar15 = unk_0xD53343AA4FB7DD28(1500, 4000);
						unk_0x69F4BE8C8CC4796C(bLocal_233[iParam1], unk_0xD80958FC74E988A6(), bVar15, 0, 2);
						iLocal_237[iParam1] = ((unk_0x9CD27B0045628463() + bVar15) + unk_0xD53343AA4FB7DD28(500, 2000));
						iLocal_236[iParam1] = 1;
						break;
					
					case 1:
						if (unk_0x9CD27B0045628463() > iLocal_237[iParam1])
						{
				...
				if (unk_0xC86D67D52A707CF8(bLocal_233[iParam1], unk_0xD80958FC74E988A6(), true))
				{
				}
				bVar16 = false;
				if (unk_0xEEF059FAD016D209(bLocal_233[iParam1]) < unk_0x15D757606D170C3C(bLocal_233[iParam1]))
				{
					bVar16 = true;
				}
				if (unk_0x28D3FED7190D3A0B(bLocal_233[iParam1]))
				{
					bVar16 = true;
				}
				if (bVar16)
				{
					unk_0x734292F4F0ABF6D0(bLocal_317, 0f);
					unk_0x394B9CD12435C981(bLocal_317, true);
					unk_0xD9A897A4C6C2974F(bLocal_317, false);
					iVar17 = 4;
					iVar18 = 4276;
					iVar19 = 0;
					unk_0xEEA929141F699854(bLocal_233[iParam1], bLocal_317, &Local_297, &(Local_309[iParam1 /*16*/]), 8f, -1000f, iVar17, iVar18, 8f, iVar19);
					unk_0x1760FFA8AB074D66(bLocal_233[iParam1], false);
					unk_0x26695EC767728D84(bLocal_233[iParam1], iVar18);
					unk_0x1913FE4CBF41C463(bLocal_233[iParam1], 208, true);
					iVar20 = 0;
					while (iVar20 < iLocal_239)
					{
						if (iLocal_240[iVar20] != 0)
						{
							if (!unk_0xCA042B6957743895(&(Local_314[iVar20 /*16*/])))
							{
								unk_0xC77720A12FE14A86(iLocal_239[iVar20], bLocal_317, &(Local_314[iVar20 /*16*/]), &Local_297, 8f, 8f, 0, 1000f);
								unk_0x1760FFA8AB074D66(iLocal_239[iVar20], false);
							}
						}
						iVar20++;
					}
			...
			case 11:
				...
				else if (unk_0xE4A310B1D7FA73CC(bLocal_317) >= 0.99f)
				{
					bVar21 = false;
				}
				if (!bVar21)
				{
					...
					unk_0x394B9CD12435C981(bLocal_317, false);
					unk_0xD9A897A4C6C2974F(bLocal_317, true);
					iVar22 = 0;
					iVar23 = 180;
					iVar24 = 0;
					unk_0xEEA929141F699854(bLocal_233[iParam1], bLocal_317, &Local_297, &(Local_310[iParam1 /*16*/]), 1000f, -1000f, iVar22, iVar23, 1000f, iVar24);
					iVar25 = 0;
					while (iVar25 < iLocal_239)
					{
						if (iLocal_240[iVar25] != 0)
						{
							if (!unk_0xCA042B6957743895(&(Local_315[iVar25 /*16*/])))
							{
								unk_0xC77720A12FE14A86(iLocal_239[iVar25], bLocal_317, &(Local_315[iVar25 /*16*/]), &Local_297, 8f, 8f, 0, 1000f);
							}
						}
						iVar25++;
					}
			...
			case 12:
				...
				unk_0xC1E8A365BF3B29F2(bLocal_233[iParam1], 249, true);
				unk_0xC1E8A365BF3B29F2(bLocal_233[iParam1], 335, true);
				if (!unk_0x1F0B79228E461EC9(bLocal_233[iParam1], &Local_297, &(Local_310[iParam1 /*16*/]), 2))
				{
					if (!unk_0x25D39B935A038A26(bLocal_317))
					{
						bLocal_317 = unk_0x8C18E0F9080ADD73(Local_243, 0f, 0f, bLocal_244, 2);
					}
					unk_0xEEA929141F699854(bLocal_233[iParam1], bLocal_317, &Local_297, &(Local_310[iParam1 /*16*/]), 1000f, -1000f, 0, 0, 1000f, 0);
					iVar26 = 0;
					while (iVar26 < iLocal_239)
					{
						if (iLocal_240[iVar26] != 0)
						{
							if (!unk_0xCA042B6957743895(&(Local_315[iVar26 /*16*/])))
							{
								unk_0xC77720A12FE14A86(iLocal_239[iVar26], bLocal_317, &(Local_315[iVar26 /*16*/]), &Local_297, 8f, 8f, 0, 1000f);
							}
						}
						iVar26++;
					}
	...
	else
	{
		...
		if (unk_0x7239B21A38F536BA(bParam0))
		{
			...
			{
				if (unk_0x7239B21A38F536BA(iLocal_239[iVar27]))
				{
					unk_0x43D3807C077261E3(iLocal_239[iVar27], -8f, true);
					unk_0x428CA6DBD1094446(iLocal_239[iVar27], false);
					unk_0x1718DE8E3F2823CA(iLocal_239[iVar27], true);
					unk_0x3AE22DEB5BA5A3E6(&(iLocal_239[iVar27]));
				}
				iVar27++;
			}
		}
...
int func_28(bool bParam0)
{
	...
	if (unk_0x7912F7FC4F6264B6(unk_0x4F8644AF03D0E0D6(), bParam0))
	{
		return 1;
	}
	...
	while (iVar0 < bLocal_233)
	{
		if (bParam0 != bLocal_233[iVar0])
		{
			if (iLocal_234[iVar0] < 0 && unk_0x7239B21A38F536BA(bLocal_233[iVar0]))
			{
				return 1;
			}
		}
...
int func_29(bool bParam0)
{
	...
	if (iLocal_66 == 237)
	{
		fVar1 = unk_0xB7A628320EFF8E47(unk_0x3FEF770D40960D5A(bParam0, false), unk_0x3FEF770D40960D5A(unk_0xD80958FC74E988A6(), false));
		if (fVar1 < (10f * 10f))
		{
			return 1;
		}
...
void func_33(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	unk_0x3523634255FC3318(bParam0, bParam1, bParam2, func_34(iParam3), false);
}
...
int func_35(bool bParam0, bool bParam1, bool bParam2, float fParam3, float fParam4)
{
	if (unk_0x0C515FAB3FF9EA92(bParam2, "WalkInterruptible"))
	{
		if (unk_0x0C515FAB3FF9EA92(bParam0, "SWITCH@TREVOR@SCARES_TRAMP"))
		{
			if (unk_0x0C515FAB3FF9EA92(bParam1, "trev_scares_tramp_exit_tramp"))
			{
				*fParam3 = 0.8f;
				*fParam4 = 1f;
				return 1;
		...
		if (unk_0x0C515FAB3FF9EA92(bParam0, "SWITCH@TREVOR@CHASE_STRIPPERS"))
		{
			if (unk_0x0C515FAB3FF9EA92(bParam1, "EXIT_STRIPPER_01") || unk_0x0C515FAB3FF9EA92(bParam1, "EXIT_STRIPPER_02"))
			{
				*fParam3 = 0.4f;
				*fParam4 = 1f;
				return 1;
		...
		if (unk_0x0C515FAB3FF9EA92(bParam0, "SWITCH@TREVOR@THROW_FOOD"))
		{
			if (unk_0x0C515FAB3FF9EA92(bParam1, "EXIT_Ped"))
			{
				*fParam3 = 0.7f;
				*fParam4 = 1f;
				return 1;
		...
		if (unk_0x25D39B935A038A26(Global_97771))
		{
			...
			while (iVar0 < bLocal_233)
			{
				if (!unk_0x84A2DD9AC37C35C1(bLocal_233[iVar0]))
				{
					...
					fVar6 = -1f;
					fVar7 = -1f;
					if (unk_0x07F1BE2BCCAA27A7(&Local_297, &(Local_307[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7) || func_35(&Local_297, &(Local_307[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7))
					{
						fVar1 = -8f;
						iVar2 = 2;
						iVar3 = 0;
					...
					unk_0xEEA929141F699854(bLocal_233[iVar0], Global_97771, &Local_297, &(Local_307[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_234[iVar0] = 0;
				}
				iVar0++;
			}
			...
			{
				if (unk_0x7239B21A38F536BA(iLocal_239[iVar0]))
				{
					if (!unk_0xCA042B6957743895(&(Local_312[iVar0 /*16*/])))
					{
						unk_0xC77720A12FE14A86(iLocal_239[iVar0], Global_97771, &(Local_312[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1000f);
					}
				}
				iVar0++;
			}
...
int func_38()
{
	...
	if (unk_0x25D39B935A038A26(Global_97770))
	{
		...
		while (iVar0 < bLocal_233)
		{
			if (!unk_0x84A2DD9AC37C35C1(bLocal_233[iVar0]))
			{
				unk_0xEEA929141F699854(bLocal_233[iVar0], Global_97770, &Local_297, &(Local_306[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_239)
		{
			if (unk_0x7239B21A38F536BA(iLocal_239[iVar0]))
			{
				if (!unk_0xCA042B6957743895(&(Local_311[iVar0 /*16*/])))
				{
					unk_0xC77720A12FE14A86(iLocal_239[iVar0], Global_97770, &(Local_311[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1000f);
				}
			}
			iVar0++;
		}
		if (!unk_0xCA042B6957743895(&Local_318))
		{
			func_27(&uLocal_67, 2, unk_0xD80958FC74E988A6(), "TREVOR", 0, 1);
			func_27(&uLocal_67, 7, bLocal_233[0], "STRIPPER1", 0, 1);
			func_27(&uLocal_67, 8, bLocal_233[1], "STRIPPER2", 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_39(int iParam0, bool bParam1)
{
	...
	if (!unk_0xD9D2CFFF49FAB35F())
	{
		...
		else if (bParam1 == func_40(Global_100162) && bParam1 != 0)
		{
			Global_100162 = 0;
		}
	}
...
void func_47()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_235)
		{
			...
			{
				unk_0x963D27A58DF860AC(iLocal_235[iVar0]);
				if (!unk_0x98A4EB5D89A0C952(iLocal_235[iVar0]))
				{
					bVar2 = false;
					unk_0x963D27A58DF860AC(iLocal_235[iVar0]);
				}
			}
			if (!unk_0xCA042B6957743895(&(Local_316[iVar0 /*16*/])))
			{
				unk_0xD2A71E1A77418A49(&(Local_316[iVar0 /*16*/]));
				if (!unk_0x318234F4F3738AF3(&(Local_316[iVar0 /*16*/])))
				{
					bVar2 = false;
				}
			}
		...
		unk_0xD3BD40951412FEF6(&Local_297);
		if (!unk_0xD031A9162D01088C(&Local_297))
		{
			bVar2 = false;
			unk_0xD3BD40951412FEF6(&Local_297);
		}
	...
	while (iVar0 < bLocal_233)
	{
		if (iLocal_235[iVar0] != 0)
		{
			bLocal_233[iVar0] = unk_0xD49F9B0955C367DE(26, iLocal_235[iVar0], Local_243 + Local_245[iVar0 /*3*/], false, true, true);
			unk_0x8E2530AA8ADA980E(bLocal_233[iVar0], (bLocal_244 + bLocal_247[iVar0]));
			unk_0xC8A9481A01E63C28(bLocal_233[iVar0], 0);
			if (iLocal_235[iVar0] == joaat("a_f_y_beach_01"))
			{
				if (iLocal_66 == 288)
				{
					unk_0x262B14F48D29DE80(bLocal_233[iVar0], 8, true, false, 0);
				}
			}
			unk_0x9F7794730795E019(bLocal_233[iVar0], 13, false);
			unk_0x9F7794730795E019(bLocal_233[iVar0], 17, true);
			unk_0xEA47FE3719165B94(bLocal_233[iVar0], &Local_297, &(Local_306[iVar0 /*16*/]), 8f, -8f, -1, 1, 0f, false, false, false);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_239)
	{
		if (iLocal_240[iVar0] != 0)
		{
			iLocal_239[iVar0] = unk_0x509D5878EB39E842(iLocal_240[iVar0], Local_243 + Local_245[iVar0 /*3*/] + Local_241[iVar0 /*3*/], true, true, false);
			unk_0x8524A8B0171D5E07(iLocal_239[iVar0], Vector((bLocal_244 + bLocal_247[iVar0]), 0f, 0f) + Local_242[iVar0 /*3*/], 2, true);
			if (!unk_0xCA042B6957743895(&(Local_311[iVar0 /*16*/])))
			{
				unk_0x7FB218262B810701(iLocal_239[iVar0], &(Local_311[iVar0 /*16*/]), &Local_297, 8f, true, false, false, 0f, 0);
			}
		}
		iVar0++;
	}
...
void func_48()
{
	...
	func_51(iLocal_66, &Local_243, &bLocal_244, &cVar0);
	...
	switch (iLocal_66)
	{
		case 237:
			...
			fLocal_321 = 0.15f;
			Local_245[0 /*3*/] = { unk_0x313CE5879CEB6FCD(-10f, 10f), unk_0x313CE5879CEB6FCD(-10f, 10f), 0f };
			Local_245[1 /*3*/] = { unk_0x313CE5879CEB6FCD(-10f, 10f), unk_0x313CE5879CEB6FCD(-10f, 10f), 0f };
			Local_246[0 /*3*/] = { 8.2284f, -35.8652f, -1.0334f };
			Local_246[1 /*3*/] = { 28.4066f, -23.8848f, -0.7887f };
			bLocal_247[0] = unk_0x313CE5879CEB6FCD(-180f, 180f);
			bLocal_247[1] = unk_0x313CE5879CEB6FCD(-180f, 180f);
			fLocal_248[0] = 50f;
			fLocal_248[1] = 50f;
		...
		case 244:
			...
			StringCopy(&(Local_308[0 /*16*/]), "", 64);
			Local_245[0 /*3*/] = { unk_0x313CE5879CEB6FCD(-5f, 5f), unk_0x313CE5879CEB6FCD(-5f, 5f), 0f };
...
void func_58()
{
	...
	while (iVar0 < iLocal_235)
	{
		if (iLocal_235[iVar0] != 0)
		{
			unk_0xE532F5D78798DAAB(iLocal_235[iVar0]);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_240)
	{
		if (iLocal_240[iVar0] != 0)
		{
			unk_0xE532F5D78798DAAB(iLocal_240[iVar0]);
		}
		iVar0++;
	}
	unk_0xF66A602F829E2A06(&Local_297);
	if (unk_0x7C6B0C22F9F40BBE(iLocal_238))
	{
		unk_0x8EB2F69076AF7053(iLocal_238);
	}
