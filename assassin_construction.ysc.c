...
void __EntryFunction__()
{
	...
	bLocal_140 = 100;
	bLocal_141 = 3;
	iLocal_744 = unk_0x4A9923385BDB9DAD();
	iLocal_745 = unk_0x186E5D252FA50E7D();
	iLocal_920 = -1;
	fLocal_922 = 1f;
	iLocal_938 = 1;
	...
	iLocal_1187 = unk_0xD80958FC74E988A6();
	...
	if (func_487())
	{
		...
		else if (iLocal_1174 == 1)
		{
			if (bLocal_1145)
			{
				...
				{
					unk_0x49733E92263139D1(iVar1, 5f);
				}
				else
				{
		...
		else if (iLocal_1174 == 2)
		{
			...
			{
				unk_0xAE287C923D891715(iLocal_1110);
			}
			iLocal_1110 = unk_0xD5C12A75C7B9497F(-182.0891f, -1004.055f, 113.1355f, 341.2941f, 1, 2, 0, false);
		...
		else if (iLocal_1174 == 3)
		{
			...
			{
				unk_0xAE287C923D891715(iLocal_1111);
			}
			iLocal_1111 = unk_0xD5C12A75C7B9497F(-150.5964f, -945.8911f, 268.1318f, 231.5456f, 2, 0, 0, false);
			unk_0x2208438012482A1A(iLocal_1187, true, false);
			unk_0x4172393E6BE1FECE(iLocal_1187, Local_1217, -1, false, 0f, false, false, 0, false);
			unk_0xB4EC2312F4E5B1F1(90f);
			unk_0x6D0858B8EDFD2B7D(0f, 1f);
	...
	while (true)
	{
		...
		else if (!unk_0x84A2DD9AC37C35C1(iLocal_1187))
		{
			func_1();
		}
		unk_0x4EDE34FBADD967A6(0);
...
void func_1()
{
	...
	switch (iLocal_938)
	{
		...
		case 5:
			if (func_391())
			{
				unk_0xE163A4BCE4DE6F11(iLocal_1177[0], true);
				iLocal_938 = 6;
			}
			break;
...
int func_25(var uParam0)
{
	...
	else if (iLocal_938 >= 11)
	{
		if (iLocal_938 == 13)
		{
			Var0 = { unk_0x3FEF770D40960D5A(iLocal_1187, true) };
			if (!bLocal_1141)
			{
				if (Var0.f_2 < (Local_1200.f_2 - 50f) && ((unk_0x7239B21A38F536BA(iLocal_1188) && !unk_0x84A2DD9AC37C35C1(iLocal_1188)) && !unk_0x997ABD671D25CA0B(iLocal_1188, false)))
				{
					return 1;
				}
			}
...
{
	return func_35(unk_0x43A66C31C68491C0(unk_0xA5EDC40EF369B48D()), Param0, bParam1);
}
...
float func_35(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	return unk_0xF1B760881820C952(unk_0x3FEF770D40960D5A(iParam0, true), Param1, bParam2);
}

int func_36()
{
	if (unk_0x7239B21A38F536BA(Local_1103[0 /*19*/]))
	{
		if (!unk_0x84A2DD9AC37C35C1(Local_1103[0 /*19*/]))
		{
			return 1;
		}
	}
...
{
	return func_39(unk_0x43A66C31C68491C0(unk_0xA5EDC40EF369B48D()), iParam0, bParam1);
}
...
void func_40()
{
	...
	{
		if (func_42(&iLocal_1188, &iLocal_1226) && unk_0x908CBECC2CAA3690(unk_0x4F8644AF03D0E0D6()))
		{
			if (!unk_0x84A2DD9AC37C35C1(Local_1102[3 /*19*/]))
			{
				unk_0x9F7794730795E019(Local_1102[3 /*19*/], 30, true);
				unk_0x06843DA7060A026B(Local_1102[3 /*19*/], -119.0637f, -973.7914f, 292.04f, true, false, false, true);
				unk_0xF166E48407BAC484(Local_1102[3 /*19*/], iLocal_1187, 0, 16);
			}
			func_41();
			iLocal_938 = 14;
		}
...
int func_42(int iParam0, int iParam1)
{
	if (unk_0x7239B21A38F536BA(*iParam0))
	{
		if (unk_0x84A2DD9AC37C35C1(*iParam0) || unk_0x5F9532F3B5CC2551(*iParam0, false))
		{
...
void func_43()
{
	...
	if (unk_0x7239B21A38F536BA(iLocal_1188))
	{
		if (!unk_0x84A2DD9AC37C35C1(iLocal_1188))
		{
		...
		if (unk_0x5A859503B0C08678() && !unk_0x7984C03AA5CC2F41())
		{
			...
			switch (iLocal_1162)
			{
					...
					if (iLocal_938 >= 11)
					{
						if (func_30(&iLocal_1233))
						{
							if (func_27(&iLocal_1233) > 13f)
							{
								...
								if (iLocal_1190 != 0)
								{
									if (unk_0x6CD5A433374D4CFB(iLocal_1190, unk_0xD80958FC74E988A6()))
									{
										func_392(&uLocal_1259, 7, iLocal_1190, "OJAcsGUARD4", 0, 1);
				...
				case 7:
					...
					{
						if (unk_0x60DFD0691A170B88(iLocal_1187, false) || func_45(&Local_1100, 6) < 4)
						{
							iLocal_1190 = func_66(75f);
							if (iLocal_1190 != 0)
							{
								if (unk_0x60DFD0691A170B88(iLocal_1187, false))
								{
									func_392(&uLocal_1259, 7, iLocal_1190, "OJAcsGUARD4", 0, 1);
				...
				case 10:
					if (unk_0x7239B21A38F536BA(Local_1102[0 /*19*/]) && unk_0x7239B21A38F536BA(iLocal_1188))
					{
						if (!unk_0x84A2DD9AC37C35C1(Local_1102[0 /*19*/]) && !unk_0x84A2DD9AC37C35C1(iLocal_1188))
						{
...
int func_49()
{
	...
	if (unk_0x4F8644AF03D0E0D6() == func_52())
	{
		return 0;
	}
...
void func_65(int iParam0)
{
	if (!unk_0x84A2DD9AC37C35C1(iParam0))
	{
		...
		if (unk_0x475768A975D5AD17(iLocal_1187, 6) && !unk_0x997ABD671D25CA0B(iLocal_1187, false))
		{
...
int func_66(float fParam0)
{
	...
	Var1 = { unk_0x3FEF770D40960D5A(iLocal_1187, true) };
	if (iLocal_938 < 10)
	{
		iVar2 = 0;
		while (iVar2 <= 4)
		{
			if (!unk_0x84A2DD9AC37C35C1(Local_1098[iVar2 /*19*/]))
			{
				fVar4 = unk_0xB7A628320EFF8E47(Var1, unk_0x3FEF770D40960D5A(Local_1098[iVar2 /*19*/], true));
				if (fVar4 < fVar3)
				{
					fVar3 = fVar4;
	...
	else if (iLocal_938 < 12)
	{
		...
		while (iVar2 <= 5)
		{
			if (!unk_0x84A2DD9AC37C35C1(Local_1100[iVar2 /*19*/]))
			{
				fVar4 = unk_0xB7A628320EFF8E47(Var1, unk_0x3FEF770D40960D5A(Local_1100[iVar2 /*19*/], true));
				if (fVar4 < fVar3)
				{
					fVar3 = fVar4;
	...
	else
	{
		...
		while (iVar2 <= 3)
		{
			if (!unk_0x84A2DD9AC37C35C1(Local_1102[iVar2 /*19*/]))
			{
				fVar4 = unk_0xB7A628320EFF8E47(Var1, unk_0x3FEF770D40960D5A(Local_1102[iVar2 /*19*/], true));
				if (fVar4 < fVar3)
				{
					fVar3 = fVar4;
			...
			if (!unk_0x7984C03AA5CC2F41())
			{
				switch (iLocal_1158)
				{
					...
					case 1:
						if (iLocal_1161 >= 2)
						{
							if (!unk_0x7239B21A38F536BA(iLocal_1188) || (!unk_0x5F9532F3B5CC2551(iLocal_1188, false) && iLocal_938 < 13))
							{
					...
					case 2:
						if (iLocal_1161 >= 5)
						{
							if (iLocal_938 < 13)
							{
								if (!unk_0x7239B21A38F536BA(iLocal_1188) || !unk_0x5F9532F3B5CC2551(iLocal_1188, false))
								{
...
int func_70(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11)
{
	bool bVar0;
	...
	if (unk_0x7239B21A38F536BA(iParam0))
	{
		if (!unk_0x84A2DD9AC37C35C1(iParam0))
		{
			if (func_76())
			{
				...
				if ((fVar0 <= 33f && unk_0x6CD5A433374D4CFB(iParam0, iLocal_1187)) || (unk_0x997ABD671D25CA0B(iLocal_1187, false) && fVar0 <= 5f))
				{
					return 1;
				}
			}
...
int func_76()
{
	if (unk_0x51210CED3DA1C78A(iLocal_1187, -140.6299f, -1029.231f, 26.29815f, -109.2613f, -943.295f, 29.2294f, 107f, false, false, 0) || unk_0x51210CED3DA1C78A(iLocal_1187, -169.2749f, -1096.598f, 18.68888f, -142.4606f, -1029.005f, 27.31028f, 99.5f, false, false, 0))
	{
		return 1;
	}
	return 0;
...
int func_77(int iParam0, int iParam1)
{
	...
	if (unk_0x7239B21A38F536BA(iParam0))
	{
		if (unk_0xC86D67D52A707CF8(iParam0, unk_0xD80958FC74E988A6(), true) && !unk_0x5F9532F3B5CC2551(iParam0, false))
		{
			return 1;
		}
...
int func_78(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	...
	if (!unk_0x5F9532F3B5CC2551(iVar0, false) && !unk_0x5F9532F3B5CC2551(iParam0, false))
	{
...
int func_79(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		...
		iLocal_117 = unk_0xEEF059FAD016D209(iParam0);
	...
	if (func_80(unk_0xD80958FC74E988A6(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (unk_0x47E4E977581C5B55(iParam0) && func_38(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_82(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (unk_0x475768A975D5AD17(iParam0, 2))
	{
		...
		else
		{
			...
			{
				iVar1 = unk_0x9A9112A0FE9A4713(unk_0x04A2A40C73395041(iParam1), false);
			}
			if (unk_0xC70B5FAE151982D8(iParam0) || func_83(iVar1))
			{
				if (unk_0x20B60995556D004F(iParam1, unk_0x3FEF770D40960D5A(iParam0, true), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), false, true, 0))
				{
					if (unk_0xD71649DB0A545AA3(unk_0x04A2A40C73395041(iParam1), iParam0, 120f) && unk_0xFCDFF7B72D23A1AC(iParam1, iParam0, 17))
...
int func_83(int iParam0)
{
	...
	if (unk_0x7239B21A38F536BA(iParam0))
	{
		...
		{
			if (unk_0xBB40DD2270B65366(iParam0, -1, false) != 0)
			{
				if (unk_0x3A87E44BB9A01D54(unk_0xD80958FC74E988A6(), &iVar0, true))
				{
					if (iVar0 == joaat("weapon_stickybomb"))
					{
						if (func_39(unk_0xD80958FC74E988A6(), iParam0, 1) < 40f)
						{
							if (unk_0x2975C866E6713290(unk_0x4F8644AF03D0E0D6(), &iVar1))
							{
								if ((unk_0x6AC7003FA6E5575E(iVar1) && unk_0x4B53F92932ADFAC0(iVar1) == iParam0) || (unk_0x524AC5ECEA15343E(iVar1) && unk_0x04A2A40C73395041(iVar1) == unk_0xBB40DD2270B65366(iParam0, -1, false)))
								{
...
void func_86()
{
	switch (iLocal_971)
	{
		...
		case 1:
			...
			if (func_175(&uLocal_145, 1, 0) && unk_0x6F259F82D873B8B8())
			{
...
void func_92(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	int iVar1;
	...
	func_93(func_125(iParam0), 1, iParam1, bParam2, 0);
	if (bParam3)
	{
		bVar0 = false;
		if (bParam4)
...
void func_96(bool bParam0)
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_98() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		unk_0xE80492A9AC099A93(&(Global_113386.f_20564.f_471), bParam0);
		unk_0xE80492A9AC099A93(&(Global_2359296[func_98() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		unk_0x202709F4C58A0424("COUP_RED");
		unk_0xC63CD5D2920ACBE7(func_97(bParam0));
...
void func_99(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
...
void func_128(var uParam0, int iParam1)
{
	...
	if (!Global_78587)
	{
		if (!unk_0x424D4687FA1E5652(unk_0xA5EDC40EF369B48D()))
		{
			if (!Global_78588)
			{
				if (unk_0xB16FCE9DDC7BA182() && !func_18(0))
				{
...
void func_131(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_137(uParam0->f_1, 256) || (func_137(uParam0->f_1, 8192) && unk_0x6CD79468A1E595C6(2)))
	{
		...
		if (unk_0x48AF36444B965238())
		{
			...
			unk_0xC58424BA936EB458(func_137(uParam0->f_1, 4096));
			unk_0xC6796A8FFA375E53();
		}
		bVar5 = false;
		iVar6 = 0;
...
void func_140(var uParam0, bool bParam1)
{
	...
	func_136(unk_0x0499D7B09FC9B407(2, 215, true));
	func_135("ES_HELP");
	if (unk_0x48AF36444B965238())
	{
		unk_0xC58424BA936EB458(true);
	...
	if (bParam1)
	{
		...
		func_136(unk_0x0499D7B09FC9B407(2, 216, true));
		func_135("ES_XPAND");
		if (unk_0x48AF36444B965238())
		{
			unk_0xC58424BA936EB458(true);
...
void func_142(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_163();
		unk_0x3A618A217E5154F0(0.5f, (fVar1 - (func_166((2f - 0.5f)) - 0.001388889f)), fVar6, func_157(1f), bVar13, bVar14, bVar15, unk_0xF2DB717A73826179((fVar12 * IntToFloat(iVar16))), false);
	}
	else
	{
		return;
	...
	while (iVar17 < uParam0->f_56)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			func_154(uParam0, iVar17, (fVar1 + func_166(2f)), fVar9, fVar10, unk_0xF2DB717A73826179((IntToFloat(bVar0) * fVar12)));
		}
		else
		{
			return;
		...
		if (uParam0->f_560 == 4)
		{
			if (iVar17 == (uParam0->f_580 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_141((fVar11 / (0.6f * func_166(25f))), 0f, 1f);
					func_163();
					unk_0x3A618A217E5154F0(0.5f, (fVar1 + func_166((2f * 0.5f))), fVar6, func_157(1f), bVar13, bVar14, bVar15, unk_0xF2DB717A73826179((fVar12 * IntToFloat(iVar16))), false);
					fVar1 = (fVar1 + func_166((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_166((25f * 0.2f)));
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_560)
			{
				case 0:
					...
					unk_0xCD015E5BB0D96A57(fVar20, (fVar1 + func_166((2f * 2f))), 0);
					break;
...
var func_150(int iParam0, bool bParam1)
{
	...
	if (!unk_0xCA042B6957743895(&(Global_23150.f_7420[iParam0 /*16*/])))
	{
		...
		{
			Var2 = { func_152(unk_0x4F8644AF03D0E0D6()) };
...
char* func_153(int iParam0)
{
	...
	if (!unk_0xCA042B6957743895(&(Global_23150.f_6411[iParam0 /*16*/])))
	{
		...
		{
			Var1 = { func_152(unk_0x4F8644AF03D0E0D6()) };
...
void func_154(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	unk_0x4E096588B13FFECA(1);
	unk_0x07C837F9A01C34C9(1f, func_156(14f));
	unk_0xC02F4DBFB51D988B(false);
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			unk_0xE7FFAE5EBF23D890("CommonMenu", func_150(7, 0), (fParam4 - 0.006f), ((fParam2 + func_166(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, bParam5, false, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_146(5, 0, 1, &fVar5, &fVar6, 0);
			unk_0xE7FFAE5EBF23D890("CommonMenu", func_150(5, 0), (fParam4 - 0.006f), ((fParam2 + func_166(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, bParam5, false, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_146(6, 0, 1, &fVar5, &fVar6, 0);
			unk_0xE7FFAE5EBF23D890("CommonMenu", func_150(6, 0), (fParam4 - 0.006f), ((fParam2 + func_166(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, bParam5, false, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_155(bool bParam0, bool bParam1, float fParam2, float fParam3, char* sParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	switch (iParam5)
	{
		case 4:
		case 5:
			unk_0x07C837F9A01C34C9(1f, func_156(18f));
...
void func_176(var uParam0)
{
	...
	unk_0xF6E48914C7A8694E(uParam0->f_4, "SET_DATA_SLOT");
	unk_0xC3D0841A0CC546A6(2);
	func_136(unk_0x0499D7B09FC9B407(2, 188, true));
	func_135("ES_HELP_TU");
	unk_0xC6796A8FFA375E53();
	unk_0xF6E48914C7A8694E(uParam0->f_4, "SET_DATA_SLOT");
	unk_0xC3D0841A0CC546A6(true);
	func_136(unk_0x0499D7B09FC9B407(2, 187, true));
	func_135("ES_HELP_TD");
	unk_0xC6796A8FFA375E53();
	unk_0xF6E48914C7A8694E(uParam0->f_4, "SET_DATA_SLOT");
	unk_0xC3D0841A0CC546A6(false);
	func_136(unk_0x0499D7B09FC9B407(2, 202, true));
	func_135("ES_HELP_AB");
	unk_0xC6796A8FFA375E53();
	unk_0xF6E48914C7A8694E(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	unk_0xC6796A8FFA375E53();
...
void func_177(var uParam0)
{
	...
	fVar0 = 0f;
	unk_0x4E096588B13FFECA(0);
	unk_0x07C837F9A01C34C9(1f, func_156(16f));
	if (uParam0->f_31 == 0)
	{
		if (uParam0->f_29)
		{
...
void func_179()
{
	...
	if (!iLocal_134)
	{
		...
		if (Global_94618)
		{
			func_184(&uLocal_145, 6, &(Local_726.f_12), "MTPHPERSKI", unk_0xF34EE736CF047844(fLocal_129), 0, 3, 0);
			func_184(&uLocal_145, 6, &(Local_726.f_24), "MTPHPERSKI", 0, 0, 3, 0);
			func_184(&uLocal_145, 6, &(Local_726.f_30), "MTPHPERSKI", unk_0xF2DB717A73826179((fLocal_131 + fLocal_130)), 0, 3, 0);
			func_183();
		}
		else
		{
			if (bLocal_133)
			{
				func_184(&uLocal_145, 6, &(Local_726.f_12), "MTPHPERRET", unk_0xF34EE736CF047844(fLocal_129), 0, 3, 0);
			}
			else
			{
				func_184(&uLocal_145, 9, &(Local_726.f_12), "", unk_0xF34EE736CF047844(fLocal_129), 0, 0, 0);
			}
			if (!unk_0xCA042B6957743895(&(Local_726.f_18)))
			{
				if (bLocal_132)
				{
					func_184(&uLocal_145, 6, &(Local_726.f_24), "", 0, 0, 2, 0);
					func_184(&uLocal_145, 3, &(Local_726.f_30), "", unk_0xF2DB717A73826179((fLocal_131 + fLocal_130)), 0, 2, 0);
				}
				else
				{
					func_184(&uLocal_145, 6, &(Local_726.f_24), "", 0, 0, 1, 0);
					func_184(&uLocal_145, 3, &(Local_726.f_30), "", unk_0xF2DB717A73826179(fLocal_130), 0, 0, 0);
				}
			}
			else
			{
		...
		if (iVar0 == 1)
		{
			bLocal_140 = 50;
			bLocal_141 = true;
			func_182(&uLocal_145, 1, &(Local_726.f_48), bLocal_140, 0, 0, 1, 0);
		}
		else if (bLocal_132)
		{
			if (bLocal_133)
			{
				bLocal_140 = 75;
				bLocal_141 = 2;
				func_182(&uLocal_145, 1, &(Local_726.f_42), bLocal_140, 0, 0, 2, 0);
			}
			else
			{
				bLocal_140 = 100;
				bLocal_141 = 3;
				func_182(&uLocal_145, 1, &(Local_726.f_36), bLocal_140, 0, 0, 3, 0);
			}
		}
...
void func_180()
{
	...
	{
		func_181(38, unk_0xF34EE736CF047844(fLocal_129), 1);
		if (bLocal_132)
		{
			func_181(39, 1, 1);
		}
		...
		if (bLocal_132)
		{
			func_181(40, unk_0xF2DB717A73826179((fLocal_131 + fLocal_130)), 1);
		}
		else
		{
			func_181(40, unk_0xF2DB717A73826179(fLocal_130), 1);
		}
		func_181(41, bLocal_140, 1);
		func_181(42, bLocal_141, 1);
	}
	else if (unk_0x2C83A9DA6BFFC4F9(joaat("assassin_multi")) == 1)
	{
		func_181(52, unk_0xF34EE736CF047844(fLocal_129), 1);
		if (bLocal_132)
		{
			func_181(53, 1, 1);
		}
		...
		if (bLocal_132)
		{
			func_181(56, unk_0xF2DB717A73826179((fLocal_131 + fLocal_130)), 1);
		}
		else
		{
			func_181(56, unk_0xF2DB717A73826179(fLocal_130), 1);
		}
		func_181(54, bLocal_140, 1);
		func_181(55, bLocal_141, 1);
	}
	else if (unk_0x2C83A9DA6BFFC4F9(joaat("assassin_hooker")) == 1)
	{
		func_181(66, unk_0xF34EE736CF047844(fLocal_129), 1);
		if (bLocal_132)
		{
			func_181(67, 1, 1);
		}
		...
		if (bLocal_132)
		{
			func_181(68, unk_0xF2DB717A73826179((fLocal_131 + fLocal_130)), 1);
		}
		else
		{
			func_181(68, unk_0xF2DB717A73826179(fLocal_130), 1);
		}
		func_181(69, bLocal_140, 1);
		func_181(70, bLocal_141, 1);
	}
	else if (unk_0x2C83A9DA6BFFC4F9(joaat("assassin_bus")) == 1)
	{
		func_181(81, unk_0xF34EE736CF047844(fLocal_129), 1);
		if (bLocal_132)
		{
			func_181(82, 1, 1);
		}
		...
		if (bLocal_132)
		{
			func_181(83, unk_0xF2DB717A73826179((fLocal_131 + fLocal_130)), 1);
		}
		else
		{
			func_181(83, unk_0xF2DB717A73826179(fLocal_130), 1);
		}
		func_181(84, bLocal_140, 1);
		func_181(85, bLocal_141, 1);
	}
	else if (unk_0x2C83A9DA6BFFC4F9(joaat("assassin_construction")) == 1)
	{
		func_181(97, unk_0xF34EE736CF047844(fLocal_129), 1);
		if (bLocal_132)
		{
			func_181(98, 1, 1);
		}
		...
		if (bLocal_132)
		{
			func_181(99, unk_0xF2DB717A73826179((fLocal_131 + fLocal_130)), 1);
		}
		else
		{
			func_181(99, unk_0xF2DB717A73826179(fLocal_130), 1);
		}
		func_181(100, bLocal_140, 1);
		func_181(101, bLocal_141, 1);
	}
}
...
void func_184(var uParam0, int iParam1, char* sParam2, char* sParam3, bool bParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
...
void func_187()
{
	...
	{
		if ((func_27(&iLocal_1254) > 7f && !unk_0x7984C03AA5CC2F41()) && !unk_0x4D79439A6B55AC67())
		{
	...
	{
		case 0:
			if (unk_0x79CFD9827CC979B6(iLocal_1187) != -1)
			{
				if (!iLocal_1154 && !unk_0x16754C556D2EDE3D())
				{
				...
				if (unk_0x79CFD9827CC979B6(iLocal_1187) == 1 || unk_0x79CFD9827CC979B6(iLocal_1187) == 2)
				{
				...
				else if (unk_0x79CFD9827CC979B6(iLocal_1187) == 0)
				{
					if (unk_0xA6DB27D19ECBB7DA(iLocal_1109))
					{
						unk_0x86A652570E5F25DD(&iLocal_1109);
					}
			...
			else
			{
				...
				if (!func_76() && !unk_0x47E4E977581C5B55(iLocal_1187))
				{
					iLocal_1159 = 3;
				}
			}
		...
		case 1:
			if (!bLocal_1137)
			{
				if (unk_0x79CFD9827CC979B6(iLocal_1187) == 3)
				{
					unk_0xC1B1E9A034A63A62(0);
					unk_0xEAABE8FDFA21274C(false);
					iLocal_1159++;
				}
				else if (!unk_0x8DECB02F88F428BC(iLocal_1187, joaat("gadget_parachute"), false))
				{
					if (!unk_0x84A2DD9AC37C35C1(iLocal_1187))
					{
						unk_0xC1B1E9A034A63A62(0);
						unk_0xEAABE8FDFA21274C(false);
						iLocal_1159++;
			...
			{
				if (unk_0x7239B21A38F536BA(iLocal_1225))
				{
					if (unk_0x4C241E39B23DF959(iLocal_1225, false))
					{
						unk_0x49733E92263139D1(iLocal_1225, 5f);
					}
				}
				iLocal_1159++;
			}
		...
		case 2:
			if (unk_0x79CFD9827CC979B6(iLocal_1187) == -1 && !unk_0x886E37EC497200B6(iLocal_1187))
			{
				if (!unk_0x84A2DD9AC37C35C1(iLocal_1187))
				{
					if (func_76())
...
void func_189(bool bParam0)
{
	...
	if (bParam0)
	{
		if (unk_0x7239B21A38F536BA(iLocal_1188))
		{
			if (!unk_0x84A2DD9AC37C35C1(iLocal_1188))
			{
				if (unk_0x298B91AE825E5705(iLocal_1188))
				{
					unk_0x9F7794730795E019(iLocal_1188, 3, false);
					unk_0x70A2D1137C8ED7C9(iLocal_1188, 2, false);
					unk_0x971D38760FBC02EF(iLocal_1188, true);
				}
			}
			unk_0x2595DD4236549CE3(&iLocal_1188);
		}
		if (unk_0xA6DB27D19ECBB7DA(iLocal_1106))
		{
			unk_0x86A652570E5F25DD(&iLocal_1106);
		}
	}
}
		...
		if (unk_0x7239B21A38F536BA((*iParam0)[iVar0 /*19*/]))
		{
			if (!unk_0x84A2DD9AC37C35C1((*iParam0)[iVar0 /*19*/]))
			{
				if (unk_0xE31C2C72B8692B64((*iParam0)[iVar0 /*19*/]) || !unk_0xE659E47AF827484B((*iParam0)[iVar0 /*19*/]))
				{
					if (!unk_0x84A2DD9AC37C35C1((*iParam0)[iVar0 /*19*/]))
					{
						unk_0x6B76DC1F3AE6E6A3((*iParam0)[iVar0 /*19*/], false, 0);
					}
				}
				else
				{
...
void func_195()
{
	...
	switch (iLocal_1168)
	{
		case 0:
			...
			unk_0xA56F01F3765B93A0(Local_1200, 10f, true, false, false, false);
			unk_0x8DFCED7A656F8802(true);
			unk_0xC1B1E9A034A63A62(0);
			iLocal_1168++;
			break;
		...
		case 2:
			...
			{
				func_219(&iLocal_1164);
				unk_0x428CA6DBD1094446(iLocal_1187, false);
		...
		case 3:
			if (unk_0x7239B21A38F536BA(iLocal_1184[1]))
			{
				Var0 = { unk_0x3FEF770D40960D5A(iLocal_1184[1], true) };
				if (Var0.f_2 <= 32f)
				{
	...
	if (iLocal_1168 >= 3)
	{
		...
		else if (unk_0xB16FCE9DDC7BA182())
		{
			func_197();
			func_213(1);
			unk_0x8E2530AA8ADA980E(iLocal_1187, 74.1208f);
...
{
	if (func_199() && unk_0x9CD27B0045628463() >= iParam0 + 1000)
	{
...
void func_202(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (unk_0x10FAB35428CCC9D7())
		{
			if (((((!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()) && !func_206(unk_0x4F8644AF03D0E0D6())) && !func_204(unk_0x4F8644AF03D0E0D6(), 0)) && !func_203()) && !bParam4) && !bParam5)
			{
				unk_0x3882114BDE571AD4(unk_0xD80958FC74E988A6(), false);
			}
		}
		else if (((!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()) && !func_206(unk_0x4F8644AF03D0E0D6())) && !bParam4) && !bParam5)
		{
			unk_0x3882114BDE571AD4(unk_0xD80958FC74E988A6(), false);
		}
		Global_78317 = 0;
...
void func_210(int iParam0, int iParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, int iParam6)
{
	...
	if (bParam4)
	{
		if (unk_0x997ABD671D25CA0B(iLocal_1187, false))
		{
			iVar2 = unk_0x9A9112A0FE9A4713(iLocal_1187, false);
		}
		if (iVar2 == 0)
		{
			if (!unk_0xB346476EF1A64897(iLocal_1187))
			{
				fVar1 = unk_0xE83D4F9BA2A38914(iLocal_1187);
				if ((fVar1 + 90f) >= 360f)
				{
				...
				if (!unk_0x997ABD671D25CA0B(iLocal_1187, false))
				{
					unk_0x6B9BBD38AB0796DF(iLocal_1187, iParam0, 0, Local_1212, 0f, 0f, fVar1, false, false, true, false, 2, true, 0);
				}
			}
		}
		else if (!unk_0xB346476EF1A64897(iVar2))
		{
			fVar1 = unk_0xE83D4F9BA2A38914(iVar2);
			if ((fVar1 + 90f) >= 360f)
			{
				fVar1 = ((fVar1 + 90f) - 360f);
			}
			...
			unk_0x6B9BBD38AB0796DF(iVar2, iParam0, 0, 0.4f, -2.2f, -1.2f, 0f, 0f, fVar1, false, false, false, false, 2, true, 0);
		}
	}
...
void func_213(bool bParam0)
{
	...
	if (unk_0x997ABD671D25CA0B(iLocal_1187, false))
	{
		iVar0 = unk_0x9A9112A0FE9A4713(iLocal_1187, false);
		unk_0x961AC54BF0613F5D(iVar0, true, true);
	}
	else
	{
		unk_0x961AC54BF0613F5D(iLocal_1187, true, true);
	}
	func_219(&iLocal_1164);
	if (unk_0x7239B21A38F536BA(iLocal_1184[1]))
	{
		unk_0x06843DA7060A026B(iLocal_1184[1], -158.84f, -942.24f, 31.44f, true, false, false, true);
	}
	else
	{
		iLocal_1184[1] = unk_0x509D5878EB39E842(bLocal_1181, -158.84f, -942.24f, 31.44f, true, true, false);
		unk_0x06843DA7060A026B(iLocal_1184[1], -158.84f, -942.24f, 31.44f, true, false, false, true);
		unk_0x8524A8B0171D5E07(iLocal_1184[1], Local_1202[1 /*3*/], 2, true);
	}
	if (iVar0 == 0)
	{
		unk_0x6B9BBD38AB0796DF(iLocal_1187, iLocal_1184[1], 0, Local_1212, 0f, 0f, 74.1208f, false, false, true, false, 2, true, 0);
	}
	else
	{
		unk_0x6B9BBD38AB0796DF(iVar0, iLocal_1184[1], 0, 0.4f, -2.2f, -1.2f, 0f, 0f, 74.1208f, false, false, false, false, 2, true, 0);
	}
	if (bParam0)
	{
	}
	...
	{
		unk_0x961AC54BF0613F5D(iLocal_1187, false, false);
	}
...
int func_214(int iParam0, var uParam1, float fParam2)
{
	...
	{
		case 0:
			unk_0xD76B57B44F1E6F8B(unk_0xD80958FC74E988A6(), unk_0x1899F328B0E12848(iParam0, Local_1207), 1f, -1, fParam2, 0.5f);
			iLocal_1160++;
			break;
		...
		case 1:
			...
			{
				unk_0x3A87E44BB9A01D54(unk_0xD80958FC74E988A6(), &bLocal_1428, true);
		...
		case 2:
			...
			{
				iLocal_1176 = unk_0x8C18E0F9080ADD73(unk_0x1899F328B0E12848(iParam0, Local_1207), unk_0xAFBD61CC738D9EB9(iParam0, 2), 2);
				unk_0xEEA929141F699854(unk_0xD80958FC74E988A6(), iLocal_1176, "oddjobs@assassinate@construction@", "ig_1_button", 4f, -4f, 1, 0, 1000f, 0);
				iLocal_1160++;
			}
			break;
		
		case 3:
			if (unk_0x25D39B935A038A26(iLocal_1176) && unk_0xE4A310B1D7FA73CC(iLocal_1176) > 0.9f)
			{
				iLocal_1160++;
			}
			break;
		...
		case 4:
			...
			Var0.f_2 = -1.333402f;
			unk_0x6B9BBD38AB0796DF(unk_0xD80958FC74E988A6(), iParam0, 0, Var0, 0f, 0f, (unk_0xE83D4F9BA2A38914(unk_0xD80958FC74E988A6()) - unk_0xE83D4F9BA2A38914(iParam0)), true, true, false, false, 2, true, 0);
...
void func_215()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0x7239B21A38F536BA(Local_1104[iVar0 /*19*/]))
		{
			if (unk_0xE31C2C72B8692B64(Local_1104[iVar0 /*19*/]))
			{
				unk_0x9614299DCB53E54B(&(Local_1104[iVar0 /*19*/]));
			}
			else
			{
				unk_0x2595DD4236549CE3(&(Local_1104[iVar0 /*19*/]));
			}
		}
		iVar0++;
	}
...
int func_217()
{
	iLocal_139 = unk_0x9CD27B0045628463();
	return iLocal_139;
}
...
{
	if ((((((func_35(iLocal_1187, Param0, 1) <= 1.65f && !unk_0x886E37EC497200B6(iLocal_1187)) && !unk_0x47E4E977581C5B55(unk_0xD80958FC74E988A6())) && func_66(3f) == 0) && !func_223()) && !unk_0xCEDABC5900A0BF97(iLocal_1187)) && !unk_0x997ABD671D25CA0B(iLocal_1187, false))
	{
		return 1;
	}
	return 0;
...
void func_227()
{
	switch (iLocal_1159)
	{
		case 0:
			...
			if (unk_0x7239B21A38F536BA(iLocal_1226))
			{
				if (!unk_0x5F9532F3B5CC2551(iLocal_1226, false) && !unk_0x5F9532F3B5CC2551(unk_0xBB40DD2270B65366(iLocal_1226, -1, false), false))
				{
					unk_0xDAD029E187A2BEB4(unk_0xBB40DD2270B65366(iLocal_1226, -1, false), iLocal_1226, 0, iLocal_1187, 0f, 0f, 180f, 8, 20f, 30f, -1f, 325, 40, -1f, 0);
				}
				else
				{
					unk_0x629BFA74418D6239(&iLocal_1226);
				}
			}
...
void func_228()
{
	if (unk_0xA6DB27D19ECBB7DA(iLocal_1107))
	{
		unk_0x86A652570E5F25DD(&iLocal_1107);
	}
	if (unk_0xA6DB27D19ECBB7DA(iLocal_1108))
	{
		unk_0x86A652570E5F25DD(&iLocal_1108);
	}
}
...
void func_229()
{
	...
	switch (iLocal_1159)
	{
		case 0:
			...
			func_241(5);
			func_240(0);
			if ((!unk_0x5F9532F3B5CC2551(iLocal_1188, false) && !unk_0x5F9532F3B5CC2551(iLocal_1226, false)) && !unk_0xA3EE4A07279BB9DB(iLocal_1188, iLocal_1226, false))
			{
				unk_0xC20E50AA46D09CA8(iLocal_1188, iLocal_1226, 20000, false, 2f, 1, 0);
			}
			if (bLocal_1135)
			{
		...
		case 1:
			...
			{
				if (!unk_0x5F9532F3B5CC2551(Local_1103[1 /*19*/], false))
				{
					unk_0xF166E48407BAC484(Local_1103[1 /*19*/], iLocal_1187, 0, 16);
				}
				if (!unk_0x5F9532F3B5CC2551(Local_1103[2 /*19*/], false))
				{
					unk_0xF166E48407BAC484(Local_1103[2 /*19*/], iLocal_1187, 0, 16);
				}
				func_239();
				unk_0xC1B1E9A034A63A62(0);
				iLocal_1159++;
...
void func_230()
{
	if (!iLocal_1132)
	{
		if (!unk_0x5F9532F3B5CC2551(Local_1102[3 /*19*/], false))
		{
			if (unk_0xC86D67D52A707CF8(Local_1102[3 /*19*/], unk_0xD80958FC74E988A6(), true) || unk_0x84A2DD9AC37C35C1(Local_1102[3 /*19*/]))
			{
				unk_0xC5F68BE9613E2D18(Local_1102[3 /*19*/], 1, 0f, -4f, 2f, 0f, 0.2f, 0f, 0, true, true, true, false, true);
				unk_0x1A9205C1B9EE827F(Local_1102[3 /*19*/], false, false);
				unk_0x4A4722448F18EEF5(Local_1102[3 /*19*/], true);
				unk_0x6B76DC1F3AE6E6A3(Local_1102[3 /*19*/], false, 0);
				iLocal_1132 = 1;
			}
		}
	}
	if (!iLocal_1133)
	{
		if (!unk_0x5F9532F3B5CC2551(Local_1102[3 /*19*/], false))
		{
			if (!unk_0x84A2DD9AC37C35C1(Local_1102[3 /*19*/]) && !unk_0x47E4E977581C5B55(Local_1102[3 /*19*/]))
			{
				if (!unk_0x20B60995556D004F(Local_1102[3 /*19*/], Local_1195, 5f, 5f, 5f, false, true, 0))
				{
					unk_0x06843DA7060A026B(Local_1102[3 /*19*/], Local_1195, true, false, false, true);
					iLocal_1133 = 1;
				}
			}
		}
	...
	switch (iLocal_1166)
	{
		case 0:
			if (bLocal_1150)
			{
				if (!unk_0x84A2DD9AC37C35C1(Local_1102[3 /*19*/]))
				{
					if (!unk_0xD05BFF0C0A12C68F(Local_1102[3 /*19*/]))
					{
						unk_0x7AEFB85C1D49DEB6(Local_1102[3 /*19*/], 0);
						unk_0x428CA6DBD1094446(Local_1102[3 /*19*/], false);
						if (unk_0x77F1BEB8863288D5(Local_1102[3 /*19*/], 167901368) != 1 && unk_0x77F1BEB8863288D5(Local_1102[3 /*19*/], 167901368) != 0)
						{
							unk_0x08DA95E8298AE772(Local_1102[3 /*19*/], iLocal_1187, -1, joaat("FIRING_PATTERN_FULL_AUTO"));
						}
					}
				}
				iLocal_1163 = unk_0xD53343AA4FB7DD28(5000, 10000);
		...
		case 1:
			if (!unk_0x84A2DD9AC37C35C1(Local_1102[3 /*19*/]))
			{
				Local_1205 = { unk_0x3FEF770D40960D5A(Local_1102[3 /*19*/], true) };
				if (Local_1205.f_2 > 294f)
				{
					if (!unk_0x20B60995556D004F(Local_1102[3 /*19*/], Local_1195, 2f, 2f, 2f, false, true, 0))
					{
						if (unk_0x77F1BEB8863288D5(Local_1102[3 /*19*/], 2106541073) != 1 && unk_0x77F1BEB8863288D5(Local_1102[3 /*19*/], 2106541073) != 0)
						{
							unk_0xD76B57B44F1E6F8B(Local_1102[3 /*19*/], Local_1195, 2f, 20000, 40000f, 0.5f);
						}
					}
					else if (unk_0x77F1BEB8863288D5(Local_1102[3 /*19*/], 167901368) != 1 && unk_0x77F1BEB8863288D5(Local_1102[3 /*19*/], 167901368) != 0)
					{
						unk_0x08DA95E8298AE772(Local_1102[3 /*19*/], iLocal_1187, -1, joaat("FIRING_PATTERN_FULL_AUTO"));
					}
				}
...
void func_231()
{
	...
	if (unk_0x7239B21A38F536BA(iLocal_1226))
	{
		if (unk_0x7239B21A38F536BA(iLocal_1188))
		{
			if (!unk_0x4C241E39B23DF959(iLocal_1226, false) || unk_0x84A2DD9AC37C35C1(unk_0xBB40DD2270B65366(iLocal_1226, -1, false)))
			{
				if (!iLocal_1136)
				{
					if (!unk_0x5F9532F3B5CC2551(iLocal_1226, false))
					{
						if (unk_0x1C8A4C2C19E68EEC(iLocal_1226))
						{
							unk_0x54833611C17ABDEA(iLocal_1226);
						}
						if (unk_0x886E37EC497200B6(iLocal_1226))
						{
							unk_0x0DC7CABAB1E9B67E(iLocal_1226, true, 1);
							unk_0xF19D095E42D430CC(iLocal_1226, true, true);
							unk_0x45F6D8EEF34ABEF1(iLocal_1226, 10f);
							unk_0xB664292EAECF7FA6(iLocal_1226, 3);
						}
						else
						{
							func_234();
			...
			else if (iLocal_1130 == 0)
			{
				if (!unk_0x84A2DD9AC37C35C1(iLocal_1188))
				{
					if (unk_0xA3EE4A07279BB9DB(iLocal_1188, iLocal_1226, false))
					{
						iLocal_1130 = 1;
					}
				}
...
void func_232()
{
	...
	{
		case 0:
			if (!unk_0x5F9532F3B5CC2551(iLocal_1188, false) && !unk_0x5F9532F3B5CC2551(iLocal_1226, false))
			{
				if (unk_0xA3EE4A07279BB9DB(iLocal_1188, iLocal_1226, false))
				{
					unk_0xFD280B4D7F3ABC4D(iLocal_1226, 1f);
					unk_0xDAD029E187A2BEB4(unk_0xBB40DD2270B65366(iLocal_1226, -1, false), iLocal_1226, 0, iLocal_1187, 0f, 0f, 10f, 9, 20f, 30f, -1f, 325, 40, -1f, 0);
				}
			}
			func_31(&iLocal_1242);
			iLocal_940 = 1;
		...
		case 1:
			if (!unk_0x84A2DD9AC37C35C1(Local_1103[0 /*19*/]))
			{
				if (unk_0x7239B21A38F536BA(iLocal_1188))
				{
					if (!unk_0x84A2DD9AC37C35C1(iLocal_1188))
					{
						if (unk_0x84A2DD9AC37C35C1(Local_1103[1 /*19*/]) && unk_0x84A2DD9AC37C35C1(Local_1103[2 /*19*/]))
						{
							...
							{
								unk_0xDAD029E187A2BEB4(Local_1103[0 /*19*/], iLocal_1226, 0, iLocal_1187, 0f, 0f, 0f, 8, 30f, 300f, -1f, 325, 40, -1f, 0);
								iLocal_940 = 2;
							}
						}
...
void func_234()
{
	...
	while (iVar0 < 3)
	{
		if (!unk_0x84A2DD9AC37C35C1(Local_1103[iVar0 /*19*/]))
		{
			unk_0x9F7794730795E019(Local_1103[iVar0 /*19*/], 3, true);
			unk_0xF166E48407BAC484(Local_1103[iVar0 /*19*/], unk_0xD80958FC74E988A6(), 0, 16);
		}
		iVar0++;
	}
}
...
void func_235()
{
	...
	if (!iLocal_1146)
	{
		if (unk_0x7239B21A38F536BA(iLocal_1226) && !unk_0x5F9532F3B5CC2551(iLocal_1226, false))
		{
			if (unk_0xBB40DD2270B65366(iLocal_1226, true, false) != 0)
			{
				iLocal_1192 = unk_0xBB40DD2270B65366(iLocal_1226, true, false);
				iLocal_1192 = iLocal_1192;
			}
			if (unk_0xBB40DD2270B65366(iLocal_1226, 2, false) != 0)
			{
				iLocal_1193 = unk_0xBB40DD2270B65366(iLocal_1226, 2, false);
			}
			if (unk_0x22AC59A870E6A669(iLocal_1226, true, false))
			{
				unk_0x3841422E9C488D8C(&iVar0);
				unk_0xE8854A4326B9E12B(&iVar0);
				unk_0x7AA80209BDA643EB(0, iLocal_1226, 0);
				unk_0xF166E48407BAC484(0, iLocal_1187, 0, 16);
				unk_0x39E72BC99E6360CB(iVar0);
				if (!unk_0x5F9532F3B5CC2551(iLocal_1193, false))
				{
					unk_0x5ABA3986D90D8A3B(iLocal_1193, iVar0);
				}
				unk_0x3841422E9C488D8C(&iVar0);
				iLocal_1146 = 1;
			}
...
void func_238(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 1:
			...
			while (iVar0 <= 4)
			{
				if (unk_0x7239B21A38F536BA(Local_1098[iVar0 /*19*/]))
				{
					if (!unk_0x84A2DD9AC37C35C1(Local_1098[iVar0 /*19*/]))
					{
						unk_0x7AEFB85C1D49DEB6(Local_1098[iVar0 /*19*/], iParam1);
					}
				}
				iVar0++;
			}
		...
		case 2:
			...
			while (iVar0 <= 2)
			{
				if (unk_0x7239B21A38F536BA(Local_1099[iVar0 /*19*/]))
				{
					if (!unk_0x84A2DD9AC37C35C1(Local_1099[iVar0 /*19*/]))
					{
						unk_0x7AEFB85C1D49DEB6(Local_1099[iVar0 /*19*/], iParam1);
					}
				}
				iVar0++;
			}
		...
		case 3:
			...
			while (iVar0 <= 5)
			{
				if (unk_0x7239B21A38F536BA(Local_1100[iVar0 /*19*/]))
				{
					if (!unk_0x84A2DD9AC37C35C1(Local_1100[iVar0 /*19*/]))
					{
						unk_0x7AEFB85C1D49DEB6(Local_1100[iVar0 /*19*/], iParam1);
					}
				}
				iVar0++;
			}
		...
		case 4:
			...
			while (iVar0 <= 1)
			{
				if (unk_0x7239B21A38F536BA(Local_1101[iVar0 /*19*/]))
				{
					if (!unk_0x84A2DD9AC37C35C1(Local_1101[iVar0 /*19*/]))
					{
						unk_0x7AEFB85C1D49DEB6(Local_1101[iVar0 /*19*/], iParam1);
					}
				}
				iVar0++;
			}
		...
		case 5:
			...
			while (iVar0 <= 3)
			{
				if (unk_0x7239B21A38F536BA(Local_1102[iVar0 /*19*/]))
				{
					if (!unk_0x84A2DD9AC37C35C1(Local_1102[iVar0 /*19*/]))
					{
						unk_0x7AEFB85C1D49DEB6(Local_1102[iVar0 /*19*/], iParam1);
					}
				}
				iVar0++;
			}
		...
		case 6:
			...
			while (iVar0 <= 2)
			{
				if (unk_0x7239B21A38F536BA(Local_1103[iVar0 /*19*/]))
				{
					if (!unk_0x84A2DD9AC37C35C1(Local_1103[iVar0 /*19*/]))
					{
						unk_0x7AEFB85C1D49DEB6(Local_1103[iVar0 /*19*/], iParam1);
					}
				}
				iVar0++;
			}
...
void func_239()
{
	...
	while (iVar1 <= 3)
	{
		if (iVar1 == 0)
		{
			if (!unk_0x84A2DD9AC37C35C1(Local_1102[iVar1 /*19*/]))
			{
				if (unk_0x5A859503B0C08678())
				{
					unk_0x9D3151A373974804(Local_1102[iVar1 /*19*/], Local_1102[iVar1 /*19*/].f_10, 15f, false, false);
					unk_0x3841422E9C488D8C(&iVar0);
					unk_0xE8854A4326B9E12B(&iVar0);
					unk_0x9B53BB6E8943AF53(0, iLocal_1187, 250, false);
					unk_0xB2A16444EAD9AE47(0, -141.3603f, -946.2284f, 268.135f, iLocal_1187, 2f, true, 0.5f, 4f, true, 0, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
					unk_0xF166E48407BAC484(0, iLocal_1187, 0, 16);
					unk_0x39E72BC99E6360CB(iVar0);
					unk_0x5ABA3986D90D8A3B(Local_1102[iVar1 /*19*/], iVar0);
					unk_0x3841422E9C488D8C(&iVar0);
					unk_0x4D9CA1009AFBD057(Local_1102[iVar1 /*19*/], 2);
					unk_0x971D38760FBC02EF(Local_1102[iVar1 /*19*/], true);
				}
			}
		}
		else if (iVar1 == 1)
		...
		else if (iVar1 == 2)
		{
			if (!unk_0x84A2DD9AC37C35C1(Local_1102[iVar1 /*19*/]))
			{
				unk_0xF166E48407BAC484(Local_1102[iVar1 /*19*/], iLocal_1187, 0, 16);
				unk_0x9D3151A373974804(Local_1102[iVar1 /*19*/], Local_1102[iVar1 /*19*/].f_10, 10f, false, false);
				unk_0x4D9CA1009AFBD057(Local_1102[iVar1 /*19*/], 2);
				unk_0x971D38760FBC02EF(Local_1102[iVar1 /*19*/], true);
			}
		}
...
{
	unk_0x963D27A58DF860AC(bLocal_1182);
	if (!bLocal_1135)
	{
		if (unk_0x98A4EB5D89A0C952(bLocal_1182))
		{
			bLocal_1135 = true;
		}
	}
	if (bLocal_1135)
	{
		if (!bLocal_1128)
		{
			if (!unk_0x7239B21A38F536BA(iLocal_1226))
			{
				iLocal_1226 = unk_0xAF35D0D2583051B0(bLocal_1182, Local_1213, fLocal_1214, true, true, false);
				unk_0x2497C4717C8B881E(iLocal_1226, true, true, false);
				unk_0x3B988190C0AA6C0B(iLocal_1226, false);
				unk_0x0DC7CABAB1E9B67E(iLocal_1226, true, 1);
				if (bParam0)
				{
					iLocal_1188 = unk_0x7DD959874C1FD534(iLocal_1226, 26, iLocal_1177[0], false, true, true);
				}
				else
				{
					iLocal_1188 = unk_0xD49F9B0955C367DE(26, iLocal_1177[0], Local_1215, fLocal_1216, true, true);
				}
				unk_0x45EEE61580806D63(iLocal_1188);
				func_392(&uLocal_1259, 3, iLocal_1188, "MAFIABOSS", 0, 1);
				unk_0x9F7794730795E019(iLocal_1188, 3, false);
				unk_0xBF0FD6E56C964FCB(iLocal_1188, joaat("weapon_pistol"), -1, true, true);
				unk_0x4D9CA1009AFBD057(iLocal_1188, 2);
				unk_0x7AEFB85C1D49DEB6(iLocal_1188, 10);
				unk_0x0DC7CABAB1E9B67E(iLocal_1188, true, 1);
				unk_0xC80A74AC829DDD92(iLocal_1188, iLocal_1229);
				unk_0x9F8AA94D6D97DBF4(iLocal_1188, true);
				unk_0x153973AB99FE8980(iLocal_1226, "ASSASSINATION_CONSTRUCT_HELI_GROUP", 0f);
				func_241(6);
				bLocal_1128 = true;
			}
		}
...
void func_241(int iParam0)
{
	...
	if (iParam0 == 1)
	{
		...
		while (iVar0 <= 4)
		{
			if (!unk_0x7239B21A38F536BA(Local_1098[iVar0 /*19*/]) && !func_243(Local_1098[iVar0 /*19*/].f_10))
			{
				if ((iVar0 % 2) == 0)
				{
					Local_1098[iVar0 /*19*/] = unk_0xD49F9B0955C367DE(26, iLocal_1177[0], Local_1098[iVar0 /*19*/].f_10, Local_1098[iVar0 /*19*/].f_13, true, true);
					unk_0x262B14F48D29DE80(Local_1098[iVar0 /*19*/], 3, 0, unk_0xD53343AA4FB7DD28(true, 4), 0);
				}
				else
				{
					Local_1098[iVar0 /*19*/] = unk_0xD49F9B0955C367DE(26, iLocal_1177[1], Local_1098[iVar0 /*19*/].f_10, Local_1098[iVar0 /*19*/].f_13, true, true);
				}
				if (iVar0 == 0)
				{
					unk_0xBDA5DF49D080FE4E(Local_1098[iVar0 /*19*/], "miss_Ass0", 1, false, true);
				}
				else if (iVar0 == 1)
				{
					unk_0xBDA5DF49D080FE4E(Local_1098[iVar0 /*19*/], "miss_Ass4", 1, false, true);
				}
				else if (iVar0 == 2)
				{
					unk_0x4A58A47A72E3FCB4(Local_1098[iVar0 /*19*/], 10f, 10f, true);
				}
				else if (iVar0 == 3)
				{
					unk_0xBDA5DF49D080FE4E(Local_1098[iVar0 /*19*/], "miss_Ass6", 1, false, true);
				}
				else if (iVar0 == 4)
				{
					unk_0xBDA5DF49D080FE4E(Local_1098[iVar0 /*19*/], "miss_Ass3", 1, false, true);
				}
				func_242(&Local_1098, iVar0, 0);
				unk_0x0DC7CABAB1E9B67E(Local_1098[iVar0 /*19*/], true, 1);
				unk_0x9F7794730795E019(Local_1098[iVar0 /*19*/], 50, true);
				unk_0xC158D28142A34608(Local_1098[iVar0 /*19*/]);
			}
			iVar0++;
		}
	}
	if (iParam0 == 2)
	{
		...
		while (iVar0 <= 2)
		{
			if (!unk_0x7239B21A38F536BA(Local_1099[iVar0 /*19*/]))
			{
				if (unk_0x7239B21A38F536BA(iLocal_1224))
				{
					if (unk_0x4C241E39B23DF959(iLocal_1224, false))
					{
						if (iVar0 == 0)
						{
							Local_1099[iVar0 /*19*/] = unk_0x7DD959874C1FD534(iLocal_1224, 26, iLocal_1177[0], -1, true, true);
							unk_0x262B14F48D29DE80(Local_1099[iVar0 /*19*/], 3, 0, unk_0xD53343AA4FB7DD28(true, 4), 0);
						}
						else if (iVar0 == 1)
						{
							Local_1099[iVar0 /*19*/] = unk_0x7DD959874C1FD534(iLocal_1224, 26, iLocal_1177[0], false, true, true);
							unk_0x262B14F48D29DE80(Local_1099[iVar0 /*19*/], 3, 0, unk_0xD53343AA4FB7DD28(true, 4), 0);
						}
						else if (iVar0 == 2)
						{
							Local_1099[iVar0 /*19*/] = unk_0x7DD959874C1FD534(iLocal_1224, 26, iLocal_1177[1], true, true, true);
						}
						unk_0x9F7794730795E019(Local_1099[iVar0 /*19*/], 3, false);
					}
					func_242(&Local_1099, iVar0, 1);
					unk_0x9F7794730795E019(Local_1099[iVar0 /*19*/], 50, true);
					unk_0xC158D28142A34608(Local_1099[iVar0 /*19*/]);
				}
			}
			iVar0++;
		}
	...
	else if (iParam0 == 3)
	{
		...
		while (iVar0 <= 5)
		{
			if (!unk_0x7239B21A38F536BA(Local_1100[iVar0 /*19*/]))
			{
				if ((iVar0 % 2) == 0)
				{
					Local_1100[iVar0 /*19*/] = unk_0xD49F9B0955C367DE(26, iLocal_1177[0], Local_1100[iVar0 /*19*/].f_10, Local_1100[iVar0 /*19*/].f_13, true, true);
					unk_0x262B14F48D29DE80(Local_1100[iVar0 /*19*/], 3, 0, unk_0xD53343AA4FB7DD28(true, 4), 0);
				}
				else
				{
					Local_1100[iVar0 /*19*/] = unk_0xD49F9B0955C367DE(26, iLocal_1177[1], Local_1100[iVar0 /*19*/].f_10, Local_1100[iVar0 /*19*/].f_13, true, true);
				}
				func_242(&Local_1100, iVar0, 1);
				unk_0x9F7794730795E019(Local_1100[iVar0 /*19*/], 50, true);
				unk_0x9D64D7405520E3D3(Local_1100[iVar0 /*19*/], true);
				if (iVar0 == 0)
				{
					if (!unk_0x84A2DD9AC37C35C1(Local_1100[iVar0 /*19*/]))
					{
						unk_0xEA47FE3719165B94(Local_1100[iVar0 /*19*/], "oddjobs@assassinate@construction@", "unarmed_fold_arms", 8f, -8f, -1, 1, 0f, false, false, false);
					}
				}
			}
			iVar0++;
	...
	else if (iParam0 == 4)
	{
		...
		while (iVar0 <= 1)
		{
			if (!unk_0x7239B21A38F536BA(Local_1101[iVar0 /*19*/]))
			{
				if ((iVar0 % 2) == 0)
				{
					Local_1101[iVar0 /*19*/] = unk_0xD49F9B0955C367DE(26, iLocal_1177[0], Local_1101[iVar0 /*19*/].f_10, Local_1101[iVar0 /*19*/].f_13, true, true);
					unk_0x262B14F48D29DE80(Local_1101[iVar0 /*19*/], 3, 0, unk_0xD53343AA4FB7DD28(true, 4), 0);
					unk_0x9B53BB6E8943AF53(Local_1101[iVar0 /*19*/], unk_0xD80958FC74E988A6(), -1, false);
					unk_0x262B14F48D29DE80(Local_1101[iVar0 /*19*/], 0, 0, 0, 0);
					unk_0x262B14F48D29DE80(Local_1101[iVar0 /*19*/], 2, 0, 0, 0);
					unk_0x262B14F48D29DE80(Local_1101[iVar0 /*19*/], 3, 0, 2, 0);
					unk_0x262B14F48D29DE80(Local_1101[iVar0 /*19*/], 4, 0, 2, 0);
					unk_0x262B14F48D29DE80(Local_1101[iVar0 /*19*/], 11, 1, 0, 0);
				}
				else
				{
					Local_1101[iVar0 /*19*/] = unk_0xD49F9B0955C367DE(26, iLocal_1177[1], Local_1101[iVar0 /*19*/].f_10, Local_1101[iVar0 /*19*/].f_13, true, true);
					unk_0x9B53BB6E8943AF53(Local_1101[iVar0 /*19*/], unk_0xD80958FC74E988A6(), -1, false);
					unk_0x262B14F48D29DE80(Local_1101[iVar0 /*19*/], 0, 0, 2, 0);
					unk_0x262B14F48D29DE80(Local_1101[iVar0 /*19*/], 3, 0, 0, 0);
					unk_0x262B14F48D29DE80(Local_1101[iVar0 /*19*/], 4, 0, 1, 0);
					unk_0x262B14F48D29DE80(Local_1101[iVar0 /*19*/], 8, 0, 0, 0);
					unk_0x262B14F48D29DE80(Local_1101[iVar0 /*19*/], 11, 1, 1, 0);
				}
				if (unk_0x7239B21A38F536BA(iLocal_1184[1]))
				{
					if (iVar0 == 0)
					{
						unk_0x6B9BBD38AB0796DF(Local_1101[iVar0 /*19*/], iLocal_1184[1], 0, Local_1212, 0f, 0f, 84.24f, false, false, false, false, 2, true, 0);
						func_392(&uLocal_1259, 4, Local_1101[iVar0 /*19*/], "OJAcsGUARD", 0, 1);
					}
					else if (iVar0 == 1)
					{
						unk_0x6B9BBD38AB0796DF(Local_1101[iVar0 /*19*/], iLocal_1184[1], 0, -1.34f, -2.36f, -1.34f, 0f, 0f, 84.24f, false, false, false, false, 2, true, 0);
						func_392(&uLocal_1259, 5, Local_1101[iVar0 /*19*/], "OJAcsGUARD2", 0, 1);
					}
				}
			}
			func_242(&Local_1101, iVar0, 1);
			unk_0x9F7794730795E019(Local_1101[iVar0 /*19*/], 50, true);
			iVar0++;
		}
	}
	else if (iParam0 == 5)
		...
		if (!bLocal_1127)
		{
			...
			while (iVar0 <= (4 - iVar1))
			{
				if (!unk_0x7239B21A38F536BA(Local_1102[iVar0 /*19*/]))
				{
					if ((iVar0 % 2) == 0)
					{
						Local_1102[iVar0 /*19*/] = unk_0xD49F9B0955C367DE(26, iLocal_1177[0], Local_1102[iVar0 /*19*/].f_10, Local_1102[iVar0 /*19*/].f_13, true, true);
						unk_0x262B14F48D29DE80(Local_1102[iVar0 /*19*/], 3, 0, unk_0xD53343AA4FB7DD28(true, 4), 0);
					}
					else
					{
						Local_1102[iVar0 /*19*/] = unk_0xD49F9B0955C367DE(26, iLocal_1177[1], Local_1102[iVar0 /*19*/].f_10, Local_1102[iVar0 /*19*/].f_13, true, true);
					}
					if (iVar0 == 3)
					{
						unk_0x9B53BB6E8943AF53(Local_1102[iVar0 /*19*/], unk_0xD80958FC74E988A6(), -1, true);
						unk_0x428CA6DBD1094446(Local_1102[iVar0 /*19*/], true);
					}
					func_242(&Local_1102, iVar0, 1);
					unk_0x9F7794730795E019(Local_1102[iVar0 /*19*/], 50, true);
				}
				iVar0++;
			}
			bLocal_1127 = true;
	...
	else if (iParam0 == 6)
	{
		...
		while (iVar0 <= 2)
		{
			if (!unk_0x7239B21A38F536BA(Local_1103[iVar0 /*19*/]))
			{
				if (unk_0x4C241E39B23DF959(iLocal_1226, false))
				{
					if (iVar0 == 0)
					{
						Local_1103[iVar0 /*19*/] = unk_0x7DD959874C1FD534(iLocal_1226, 26, iLocal_1177[0], -1, true, true);
						unk_0x262B14F48D29DE80(Local_1103[iVar0 /*19*/], 3, 0, unk_0xD53343AA4FB7DD28(true, 4), 0);
						unk_0xBF0FD6E56C964FCB(Local_1103[0 /*19*/], joaat("weapon_assaultrifle"), -1, true, true);
					}
					else if (iVar0 == 1)
					{
						Local_1103[1 /*19*/] = unk_0x7DD959874C1FD534(iLocal_1226, 26, iLocal_1177[1], 2, true, true);
						unk_0xBF0FD6E56C964FCB(Local_1103[1 /*19*/], joaat("weapon_carbinerifle"), -1, true, true);
					}
					else if (iVar0 == 2)
					{
						Local_1103[2 /*19*/] = unk_0x7DD959874C1FD534(iLocal_1226, 26, iLocal_1177[0], true, true, true);
						unk_0x262B14F48D29DE80(Local_1103[iVar0 /*19*/], 3, 0, unk_0xD53343AA4FB7DD28(true, 4), 0);
						unk_0xBF0FD6E56C964FCB(Local_1103[2 /*19*/], joaat("weapon_carbinerifle"), -1, true, true);
					}
					unk_0x9F8AA94D6D97DBF4(Local_1103[iVar0 /*19*/], true);
					unk_0x9F7794730795E019(Local_1103[iVar0 /*19*/], 3, false);
					unk_0x4D9CA1009AFBD057(Local_1103[iVar0 /*19*/], 2);
					unk_0x7AEFB85C1D49DEB6(Local_1103[iVar0 /*19*/], 0);
					unk_0xC80A74AC829DDD92(Local_1103[iVar0 /*19*/], iLocal_1229);
					unk_0x9F7794730795E019(Local_1103[iVar0 /*19*/], 50, true);
					unk_0x1913FE4CBF41C463(Local_1103[iVar0 /*19*/], 115, true);
				}
			}
			iVar0++;
		}
...
void func_242(int iParam0, int iParam1, bool bParam2)
{
	...
	unk_0xC80A74AC829DDD92((*iParam0)[iParam1 /*19*/], iLocal_1229);
...
void func_244(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_324(unk_0x442E0A7EDE4A738A(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_317(unk_0x442E0A7EDE4A738A(), 1);
			if (iVar4 != -1)
			{
...
{
	func_246(&Global_106934, unk_0x442E0A7EDE4A738A(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_246(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_10();
	...
	if (!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()))
	{
		...
		func_277(unk_0xD80958FC74E988A6());
		func_270(unk_0xD80958FC74E988A6(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_269())
		{
			func_265(unk_0xD80958FC74E988A6(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	if (unk_0x4C241E39B23DF959(iParam0, false))
	{
		...
		*uParam1 = unk_0xF11BC2DD9A3E7195(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x933D6A9EEC1BACD0(&(uParam1->f_77), func_258(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_271(int iParam0, var uParam1)
{
	...
	if (!unk_0x84A2DD9AC37C35C1(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0xEFFED78E9011134D(iParam0, func_276(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x310836EE7129BA33(iVar5, &Var7) && !func_273(Var7.f_1)) && iVar9 < 51)
			{
...
int func_281(var uParam0)
{
	if (!unk_0x5F9532F3B5CC2551(unk_0xD80958FC74E988A6(), false) && !unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()))
	{
		if (func_303())
		{
			*uParam0 = func_287(unk_0x3FEF770D40960D5A(unk_0xD80958FC74E988A6(), false), 6, -1, 0, 1, -1);
...
int func_287(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam1 == 6 || iParam1 == func_302(iVar0))
		{
			...
			{
				fVar1 = unk_0xF1B760881820C952(Param0, func_288(iVar0, 0), true);
...
int func_299()
{
	return func_300(unk_0x4F8644AF03D0E0D6());
}
...
var func_304()
{
	...
	func_314(&uVar0, unk_0x494E97C2EF27C470());
	func_313(&uVar0, unk_0x13D2B8ADD79640F2());
	func_312(&uVar0, unk_0x25223CA6B4D20B7F());
	func_307(&uVar0, unk_0x3D10BC92A4DB1D35());
	func_306(&uVar0, unk_0xBBC72712E80257A1());
	func_305(&uVar0, unk_0x961777E64BDAF717());
	return uVar0;
}
...
void func_307(var uParam0, bool bParam1)
{
	...
	if (bParam1 < 1 || bParam1 > func_308(iVar0, iVar1))
	{
		return;
	}
...
var func_309(bool bParam0)
{
	return (unk_0x97EF1E5BCE9DC075(bParam0, 26) & 31 * func_310(BitTest(bParam0, 31), -1, 1)) + 2011;
}
...
void func_326()
{
	...
	switch (iLocal_1159)
	{
		case 0:
			...
			unk_0x8DFCED7A656F8802(true);
			unk_0x239528EACDC3E7DE(unk_0x4F8644AF03D0E0D6(), true);
			unk_0xA56F01F3765B93A0(Local_1199, 10f, true, false, false, false);
			unk_0x8DFCED7A656F8802(true);
			unk_0xC1B1E9A034A63A62(0);
			iLocal_1159++;
			break;
	...
	if (iLocal_1159 >= 3)
	{
		...
		else if (unk_0xB16FCE9DDC7BA182())
		{
			...
			if (bLocal_1127 && bLocal_1128)
			{
				func_197();
				func_327(1, 1);
				unk_0x8E2530AA8ADA980E(iLocal_1187, 243.9563f);
				unk_0xB4EC2312F4E5B1F1(0f);
				unk_0x6D0858B8EDFD2B7D(0f, 1f);
				func_200(1, 1, 1);
				func_196();
...
void func_327(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		if (unk_0x7239B21A38F536BA(iLocal_1184[1]))
		{
			unk_0x06843DA7060A026B(iLocal_1184[1], -158.84f, -942.24f, 270.46f, true, false, false, true);
		}
		else
		{
			iLocal_1184[1] = unk_0x509D5878EB39E842(bLocal_1181, -158.84f, -942.24f, 270.46f, true, true, false);
			unk_0x06843DA7060A026B(iLocal_1184[1], -158.84f, -942.24f, 270.46f, true, false, false, true);
			unk_0x8524A8B0171D5E07(iLocal_1184[1], Local_1202[1 /*3*/], 2, true);
		}
	}
	if (bParam1)
	{
		unk_0x6B9BBD38AB0796DF(iLocal_1187, iLocal_1184[1], 0, Local_1212, 0f, 0f, 269f, false, false, true, false, 2, true, 0);
		unk_0x961AC54BF0613F5D(iLocal_1187, false, false);
		unk_0x8D32347D6D4C40A2(unk_0x4F8644AF03D0E0D6(), true, 0);
		unk_0xB4EC2312F4E5B1F1(0f);
	}
	if (!unk_0x7239B21A38F536BA(iLocal_1185[1]))
	{
		iLocal_1185[1] = unk_0x509D5878EB39E842(bLocal_1183, Local_1203[1 /*3*/], true, true, false);
		unk_0x6B9BBD38AB0796DF(iLocal_1185[1], iLocal_1184[1], 0, Local_1206, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
	}
}
...
void func_328()
{
	...
	if (!unk_0x5F9532F3B5CC2551(unk_0xD80958FC74E988A6(), false))
	{
		...
		if (iVar0 == joaat("weapon_unarmed") && (bLocal_1428 != joaat("weapon_unarmed") && bLocal_1428 != 0))
		{
			unk_0xADF692B254977C0C(unk_0xD80958FC74E988A6(), bLocal_1428, true);
			unk_0x2E1202248937775C(unk_0xD80958FC74E988A6(), bLocal_1428, &iVar1);
			iVar2 = unk_0xA38DCFFCEA8962FA(unk_0xD80958FC74E988A6(), bLocal_1428, true);
			bVar3 = unk_0x015A522136D7F951(unk_0xD80958FC74E988A6(), bLocal_1428);
			if ((iVar1 < iVar2 && unk_0x77F1BEB8863288D5(unk_0xD80958FC74E988A6(), 1785177548) != 1) && bVar3 > iVar1)
			{
...
void func_330()
{
	...
	while (iVar0 < 2)
	{
		if (unk_0x84A2DD9AC37C35C1(Local_1101[iVar0 /*19*/]))
		{
			Var1 = { unk_0x3FEF770D40960D5A(Local_1101[iVar0 /*19*/], false) };
			if (unk_0xF1B760881820C952(Var1, Local_1199, true) < 3.25f)
			{
				unk_0x9614299DCB53E54B(&(Local_1101[iVar0 /*19*/]));
			}
		}
		iVar0++;
	}
...
void func_331()
{
	...
	switch (iLocal_1159)
	{
		case 0:
			...
			if (!unk_0xA6DB27D19ECBB7DA(iLocal_1109))
			{
				iLocal_1109 = unk_0x5A039BB0BCA604B6(-154.799f, -941.62f, 269.1f);
				unk_0x4F7D8A9BFB0B43E9(iLocal_1109, false);
				unk_0xEAA0FFE120D92784(iLocal_1109, "ASS_CS_TARGET");
			}
			else
			{
				unk_0xAE2AF67E9D9AF65D(iLocal_1109, -154.799f, -941.62f, 269.1f);
			}
			if (iLocal_1162 < 4)
			{
				iLocal_1162 = 4;
		...
		case 1:
			...
			{
				unk_0x8A97BCA30A0CE478(Local_1199, 5f, joaat("prop_conslift_lift"), true);
				func_335(0);
				iLocal_1159++;
			}
			break;
		...
		else if (iVar1 == 5)
		{
			if (!iLocal_1123)
			{
				if (func_66(50f) != 0)
				{
					...
					unk_0xF166E48407BAC484(iVar0, iLocal_1187, 0, 16);
					iLocal_1123 = 1;
				}
			}
		}
...
void func_332(int iParam0, int iParam1)
{
	...
	while (iVar0 <= (iParam1 - 1))
	{
		if (!unk_0x84A2DD9AC37C35C1((*iParam0)[iVar0 /*19*/]))
		{
			...
			unk_0xF166E48407BAC484((*iParam0)[iVar0 /*19*/], iLocal_1187, 0, 16);
		}
		iVar0++;
	}
}
...
void func_334()
{
	...
	while (iVar0 <= 1)
	{
		if (!unk_0x84A2DD9AC37C35C1(Local_1101[iVar0 /*19*/]))
		{
			unk_0x961AC54BF0613F5D(Local_1101[iVar0 /*19*/], false, false);
			if (iVar0 == 0)
			{
				unk_0x9D3151A373974804(Local_1101[iVar0 /*19*/], -145.5655f, -941.1028f, 113.2452f, 10f, false, false);
			}
			else if (iVar0 == 1)
			{
				unk_0x9D3151A373974804(Local_1101[iVar0 /*19*/], -152.5679f, -947.0895f, 113.1339f, 10f, false, false);
			}
			unk_0x971D38760FBC02EF(Local_1101[iVar0 /*19*/], true);
			...
			unk_0xB2A16444EAD9AE47(0, Var2, iLocal_1187, 2f, false, 0.5f, 0f, true, 0, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
			unk_0xF166E48407BAC484(0, iLocal_1187, 0, 16);
			unk_0x39E72BC99E6360CB(iVar1);
			unk_0x5ABA3986D90D8A3B(Local_1101[iVar0 /*19*/], iVar1);
			unk_0x3841422E9C488D8C(&iVar1);
		}
		iVar0++;
	}
...
void func_335(bool bParam0)
{
	if (!unk_0x7239B21A38F536BA(iLocal_1184[1]))
	{
		if (bParam0)
		{
			iLocal_1184[1] = unk_0x509D5878EB39E842(bLocal_1181, Local_1203[1 /*3*/], true, true, false);
		}
		else
		{
			iLocal_1184[1] = unk_0x509D5878EB39E842(bLocal_1181, Local_1203[1 /*3*/], true, true, false);
			unk_0x06843DA7060A026B(iLocal_1184[1], -158.84f, -942.24f, 125.8f, true, false, false, true);
		}
		unk_0x8524A8B0171D5E07(iLocal_1184[1], Local_1202[1 /*3*/], 2, true);
	}
	else
...
void func_336()
{
	...
	uVar0 = uVar0;
	if (unk_0x7239B21A38F536BA(iLocal_1184[0]))
	{
		Var1 = { unk_0x3FEF770D40960D5A(iLocal_1184[0], true) };
	}
	switch (iLocal_1159)
	{
		case 0:
			...
			unk_0x239528EACDC3E7DE(unk_0x4F8644AF03D0E0D6(), true);
			unk_0xA56F01F3765B93A0(Local_1198, 10f, true, false, false, false);
			unk_0xC1B1E9A034A63A62(0);
			iLocal_1159++;
			break;
			...
			if (unk_0x7239B21A38F536BA(iLocal_1184[0]))
			{
				if (Var1.f_2 >= 115.4f || iLocal_1120)
				{
					...
					else
					{
						...
						{
							unk_0x961AC54BF0613F5D(unk_0x9A9112A0FE9A4713(iLocal_1187, false), false, false);
						}
						unk_0xC1B1E9A034A63A62(0);
						func_219(&iLocal_1164);
						iLocal_1159++;
...
void func_337(bool bParam0)
{
	...
	if (unk_0x7239B21A38F536BA(iLocal_1184[0]))
	{
		unk_0x06843DA7060A026B(iLocal_1184[0], -182.17f, -1016.09f, 115.46f, true, false, false, true);
	}
	else
	{
		iLocal_1184[0] = unk_0x509D5878EB39E842(bLocal_1181, -182.17f, -1016.09f, 115.46f, true, true, false);
		unk_0x06843DA7060A026B(iLocal_1184[0], -182.17f, -1016.09f, 115.46f, true, false, false, true);
		unk_0x8524A8B0171D5E07(iLocal_1184[0], Local_1202[0 /*3*/], 2, true);
		unk_0x0DC7CABAB1E9B67E(iLocal_1184[0], true, 1);
	}
	if (!unk_0x7239B21A38F536BA(iLocal_1185[0]) && unk_0x7239B21A38F536BA(iLocal_1184[0]))
	{
		iLocal_1185[0] = unk_0x509D5878EB39E842(bLocal_1183, Local_1203[0 /*3*/], true, true, false);
		unk_0x6B9BBD38AB0796DF(iLocal_1185[0], iLocal_1184[0], 0, Local_1206, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
	}
	if (bParam0)
	{
		unk_0x6B9BBD38AB0796DF(iLocal_1187, iLocal_1184[0], 0, Local_1212, 0f, 0f, 340f, false, false, true, false, 2, true, 0);
		unk_0x961AC54BF0613F5D(iLocal_1187, false, false);
		unk_0x8E2530AA8ADA980E(iLocal_1187, 340.3911f);
		unk_0x8D32347D6D4C40A2(unk_0x4F8644AF03D0E0D6(), true, 0);
		unk_0xB4EC2312F4E5B1F1(0f);
	}
}
...
void func_338()
{
	...
	while (iVar0 <= 5)
	{
		if (!unk_0x84A2DD9AC37C35C1(Local_1100[iVar0 /*19*/]))
		{
			if (unk_0x77F1BEB8863288D5(Local_1100[iVar0 /*19*/], 242628503) != 1)
			{
				if (iVar0 == 0)
				{
					unk_0x9D3151A373974804(Local_1100[iVar0 /*19*/], Local_1100[iVar0 /*19*/].f_10, 10f, false, false);
					unk_0x0DC7CABAB1E9B67E(Local_1100[iVar0 /*19*/], true, 1);
				}
				else if (iVar0 == 1)
				{
					unk_0x9D3151A373974804(Local_1100[iVar0 /*19*/], Local_1100[iVar0 /*19*/].f_10, 10f, false, false);
				...
				{
					unk_0x9D3151A373974804(Local_1100[iVar0 /*19*/], -151.3457f, -948.0886f, 113.1339f, 10f, false, false);
				}
				else if (iVar0 == 3)
				{
					unk_0x9D3151A373974804(Local_1100[iVar0 /*19*/], -145.5338f, -986.0398f, 113.1282f, 10f, false, false);
				}
				else if (iVar0 == 4)
				{
					unk_0x9D3151A373974804(Local_1100[iVar0 /*19*/], -139.7715f, -968.064f, 113.1339f, 10f, false, false);
				}
				else if (iVar0 == 5)
				{
					unk_0x9D3151A373974804(Local_1100[iVar0 /*19*/], -154.0288f, -960.1566f, 113.1317f, 10f, false, false);
				}
				unk_0xE8854A4326B9E12B(&iVar1);
				if (iVar0 == 0)
				{
				...
				unk_0xF166E48407BAC484(0, iLocal_1187, 0, 16);
				unk_0x39E72BC99E6360CB(iVar1);
				unk_0x5ABA3986D90D8A3B(Local_1100[iVar0 /*19*/], iVar1);
				unk_0x3841422E9C488D8C(&iVar1);
				unk_0x4D9CA1009AFBD057(Local_1100[iVar0 /*19*/], 2);
				unk_0xFF41B4B141ED981C(Local_1100[iVar0 /*19*/], 13, 3f);
				unk_0x971D38760FBC02EF(Local_1100[iVar0 /*19*/], true);
			}
		}
		iVar0++;
	}
...
void func_339()
{
	switch (iLocal_1159)
	{
		case 0:
			...
			if (!unk_0xA6DB27D19ECBB7DA(iLocal_1109))
			{
				iLocal_1109 = unk_0x5A039BB0BCA604B6(-184.599f, -1015.819f, 254.2567f);
				unk_0x4F7D8A9BFB0B43E9(iLocal_1109, false);
				unk_0xEAA0FFE120D92784(iLocal_1109, "ASS_CS_TARGET");
			}
			iLocal_1159++;
		...
		case 1:
			if (func_222(Local_1198) && !func_345())
			{
				...
				if (unk_0x580417101DDB492F(0, 51) || unk_0x580417101DDB492F(2, 51))
				{
					if (func_220("ASS_CS_ELEHELP"))
					{
						iLocal_1225 = unk_0xB6997A7EB3F5C8C0();
						if (iLocal_1225 != 0)
						{
							if (unk_0x4C241E39B23DF959(iLocal_1225, false))
							{
								unk_0xAD738C3085FE7E11(iLocal_1225, true, false);
							}
						}
...
void func_340()
{
	...
	while (iVar0 <= 4)
	{
		if (!unk_0x84A2DD9AC37C35C1(Local_1098[iVar0 /*19*/]))
		{
			if (iVar0 == 0)
			{
				unk_0x4D9CA1009AFBD057(Local_1098[iVar0 /*19*/], 2);
			}
			else if (iVar0 == 1)
			{
				unk_0x4D9CA1009AFBD057(Local_1098[iVar0 /*19*/], 2);
			...
			{
				unk_0x9D3151A373974804(Local_1098[iVar0 /*19*/], Local_1098[iVar0 /*19*/].f_10, 10f, false, false);
			}
			else if (iVar0 == 3)
			{
				unk_0x9D3151A373974804(Local_1098[iVar0 /*19*/], Local_1098[iVar0 /*19*/].f_10, 10f, false, false);
			...
			{
				unk_0x9D3151A373974804(Local_1098[iVar0 /*19*/], -176.2501f, -1026.913f, 26.2752f, 25f, false, false);
				unk_0x4D9CA1009AFBD057(Local_1098[iVar0 /*19*/], 1);
			}
			if (unk_0x77F1BEB8863288D5(Local_1098[iVar0 /*19*/], -1253019028) == 1)
			{
				unk_0xF1C03A5352243A30(Local_1098[iVar0 /*19*/]);
				unk_0xE1EF3C1216AFF2CD(Local_1098[iVar0 /*19*/]);
			}
			unk_0xF166E48407BAC484(Local_1098[iVar0 /*19*/], iLocal_1187, 0, 16);
			unk_0x971D38760FBC02EF(Local_1098[iVar0 /*19*/], true);
		}
		iVar0++;
	}
}
...
void func_341()
{
	...
	if (!iLocal_1134)
	{
		if (unk_0x7239B21A38F536BA(iLocal_1224) && !unk_0x5F9532F3B5CC2551(iLocal_1224, false))
		{
			Var0 = { unk_0x3FEF770D40960D5A(iLocal_1224, true) };
			if (func_35(unk_0xD80958FC74E988A6(), Var0, 1) <= 5f)
			{
				func_344();
				iLocal_1134 = 1;
			}
	...
	if (!iLocal_1119)
	{
		if (unk_0x7239B21A38F536BA(iLocal_1224))
		{
			if (((bLocal_1113 && unk_0x51210CED3DA1C78A(iLocal_1187, -125.446f, -999.097f, 27.228f, -173.264f, -1095.935f, 27.228f, 98f, false, false, 0)) || (bLocal_1113 && func_38(iLocal_1224, 1) < 50f)) || (bLocal_1113 && func_34(Local_1198, 0) < 50f))
			{
				func_343();
				iLocal_1119 = 1;
			}
...
void func_342()
{
	if (!bLocal_1118)
	{
		if (unk_0x4C241E39B23DF959(iLocal_1224, false))
		{
			if (((((!unk_0xF5134943EA29868C(iLocal_1224) || unk_0x84A2DD9AC37C35C1(unk_0xBB40DD2270B65366(iLocal_1224, -1, false))) || func_35(iLocal_1224, -177.2643f, -1036.083f, 26.2322f, 0) <= 8f) || unk_0x679BE1DAF71DA874(iLocal_1224, 0, 3000)) || unk_0x679BE1DAF71DA874(iLocal_1224, 2, 3000)) || unk_0x679BE1DAF71DA874(iLocal_1224, 3, 3000))
			{
...
void func_343()
{
	...
	if (unk_0x7239B21A38F536BA(iLocal_1224))
	{
		if (unk_0x4C241E39B23DF959(iLocal_1224, false))
		{
			if (!unk_0xF5134943EA29868C(iLocal_1224))
			{
				iVar0 = 0;
				while (iVar0 <= 2)
				{
					if (!unk_0x84A2DD9AC37C35C1(Local_1099[iVar0 /*19*/]))
					{
						if (Local_1099[iVar0 /*19*/] == unk_0xBB40DD2270B65366(iLocal_1224, -1, false))
						{
							if (!unk_0xB65B60556E2A9225("ASSASSINATION_CONSTRUCT_CAR_ARRIVES"))
							{
								unk_0x013A80FC08F6E4F2("ASSASSINATION_CONSTRUCT_CAR_ARRIVES");
							}
							unk_0x3123FAA6DB1CF7ED(Local_1099[iVar0 /*19*/], iLocal_1224, "OJAScs_101", 52, 0, 0, -1, -1f, false, 2f);
							unk_0x971D38760FBC02EF(Local_1099[iVar0 /*19*/], true);
							bLocal_1149 = true;
						}
						else
						{
							unk_0xF166E48407BAC484(Local_1099[iVar0 /*19*/], iLocal_1187, 0, 16);
							unk_0x971D38760FBC02EF(Local_1099[iVar0 /*19*/], true);
							bLocal_1149 = true;
						}
					}
...
void func_344()
{
	...
	while (iVar1 <= 2)
	{
		if (!unk_0x84A2DD9AC37C35C1(Local_1099[iVar1 /*19*/]))
		{
			unk_0x9F7794730795E019(Local_1099[iVar1 /*19*/], 3, true);
			if (iVar1 != 2)
			{
				unk_0x9D3151A373974804(Local_1099[iVar1 /*19*/], Local_1098[3 /*19*/].f_10, 10f, false, false);
				unk_0x4D9CA1009AFBD057(Local_1099[iVar1 /*19*/], 2);
			}
			unk_0x3841422E9C488D8C(&iVar0);
			unk_0xE8854A4326B9E12B(&iVar0);
			...
			unk_0xF166E48407BAC484(0, iLocal_1187, 0, 16);
			unk_0x39E72BC99E6360CB(iVar0);
			unk_0x5ABA3986D90D8A3B(Local_1099[iVar1 /*19*/], iVar0);
			unk_0x3841422E9C488D8C(&iVar0);
		}
		iVar1++;
	}
...
void func_346()
{
	iLocal_1184[0] = unk_0x509D5878EB39E842(bLocal_1181, Local_1203[0 /*3*/], true, true, false);
	unk_0x8524A8B0171D5E07(iLocal_1184[0], Local_1202[0 /*3*/], 2, true);
	iLocal_1185[0] = unk_0x509D5878EB39E842(bLocal_1183, Local_1203[0 /*3*/], true, true, false);
	unk_0x6B9BBD38AB0796DF(iLocal_1185[0], iLocal_1184[0], 0, Local_1206, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
}
...
void func_347()
{
	...
	{
		case 0:
			if ((func_351(5f, 0) && unk_0xD0263801A4C5B0BB()) || ((func_351(1084227584, 1) && func_30(&iLocal_1254)) && func_27(&iLocal_1254) > 15f))
			{
				if (!iLocal_1143)
				{
					iLocal_1167 = unk_0x2CE544C68FB812A0(-69.7777f, -923.6335f, 28.2933f, 10f, 0f, false);
					if (!unk_0x5F9532F3B5CC2551(unk_0xD80958FC74E988A6(), false))
					{
						if (unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false))
						{
							iLocal_1227 = unk_0x9A9112A0FE9A4713(unk_0xD80958FC74E988A6(), false);
							if (unk_0x7239B21A38F536BA(iLocal_1227))
							{
								if (!unk_0x5F9532F3B5CC2551(iLocal_1227, false))
								{
									unk_0x1B9C0099CB942AC6(iLocal_1227, "OFF");
								}
							}
						}
					}
					...
					if (!unk_0x84A2DD9AC37C35C1(iLocal_1188))
					{
						unk_0x2208438012482A1A(iLocal_1188, true, false);
						unk_0xEA47FE3719165B94(iLocal_1188, "oddjobs@assassinate@construction@", "CS_GetInLift", 1000f, -4f, 9500, 0, 0f, false, false, false);
					}
					if (!unk_0x84A2DD9AC37C35C1(iLocal_1189))
					{
						unk_0x2208438012482A1A(iLocal_1189, true, false);
						unk_0xEA47FE3719165B94(iLocal_1189, "oddjobs@assassinate@construction@", "idle_a", 1000f, -4f, -1, 1, 0f, false, false, false);
						unk_0x69F4BE8C8CC4796C(iLocal_1189, iLocal_1188, -1, 0, 2);
					}
					unk_0x8A97BCA30A0CE478(Local_1199, 5f, joaat("prop_conslift_lift"), true);
					func_335(1);
					if (unk_0x7239B21A38F536BA(iLocal_1184[1]))
					{
						if (!unk_0x84A2DD9AC37C35C1(iLocal_1188))
						{
							unk_0x6B9BBD38AB0796DF(iLocal_1188, iLocal_1184[1], 0, -1.75f, -1.88f, -1.3f, 0f, 0f, 84.2f, false, false, false, false, 2, true, 0);
						}
					}
					iLocal_1155 = unk_0x6ABFA3E16460F22D(26379945, -147.5668f, -958.6139f, 114.8839f, -1.648425f, -0.29868f, 24.55094f, 31.35205f, false, 2);
					iLocal_1156 = unk_0x6ABFA3E16460F22D(26379945, -147.2354f, -957.6655f, 114.8667f, -1.648426f, -0.29868f, 25.52002f, 31.35205f, false, 2);
					unk_0x6A25241C340D3822(iLocal_1155, "HAND_SHAKE", 0.2f);
					unk_0x6A25241C340D3822(iLocal_1156, "HAND_SHAKE", 0.2f);
					iLocal_1143 = 1;
				}
				else
				{
					...
					unk_0x9FBDA379383A52A4(iLocal_1156, iLocal_1155, 4800, 0, 1);
		...
		case 1:
			...
			{
				unk_0xBFD8727AEA3CCEBA(iLocal_1155, -152.6485f, -944.8f, 114.2028f, 2.386309f, -0.295268f, 43.69577f, 31.34258f, false, 1, 1, 2);
				unk_0xBFD8727AEA3CCEBA(iLocal_1156, -152.7505f, -944.6934f, 114.2089f, 2.386309f, -0.295268f, 43.69577f, 31.34258f, false, 1, 1, 2);
				unk_0x6A25241C340D3822(iLocal_1155, "HAND_SHAKE", 0.2f);
				unk_0x6A25241C340D3822(iLocal_1156, "HAND_SHAKE", 0.2f);
				unk_0x9FBDA379383A52A4(iLocal_1156, iLocal_1155, 6000, 0, 1);
				iLocal_1159++;
			}
			unk_0xA76359FC80B2438E(1f);
			break;
		...
		case 2:
			...
			{
				unk_0xBFD8727AEA3CCEBA(iLocal_1155, -165.2002f, -938.0276f, 113.4667f, 4.389886f, 0.213688f, -112.1127f, 32.21227f, false, 1, 1, 2);
				unk_0xBFD8727AEA3CCEBA(iLocal_1156, -164.6229f, -937.1241f, 113.4675f, 77.82435f, 0.213692f, -131.0643f, 32.21227f, false, 1, 1, 2);
				unk_0x6A25241C340D3822(iLocal_1155, "HAND_SHAKE", 0.2f);
				unk_0x6A25241C340D3822(iLocal_1156, "HAND_SHAKE", 0.2f);
				unk_0x9FBDA379383A52A4(iLocal_1156, iLocal_1155, 4250, 1, 1);
				func_219(&iLocal_1164);
				iLocal_1159++;
			}
			unk_0xA76359FC80B2438E(1f);
		...
		case 5:
			...
			else
			{
				...
				func_191(&uLocal_1259, 5);
				unk_0x9614299DCB53E54B(&iLocal_1188);
				unk_0x9614299DCB53E54B(&iLocal_1189);
				func_219(&iLocal_1164);
				func_196();
				func_41();
				unk_0x0A41540E63C9EE17();
...
void func_350(bool bParam0)
{
	if (!unk_0x7239B21A38F536BA(iLocal_1188))
	{
		if (bParam0)
		{
			iLocal_1188 = unk_0xD49F9B0955C367DE(26, iLocal_1177[0], -153.2591f, -941.5044f, 113.1339f, 263f, true, true);
			unk_0x45EEE61580806D63(iLocal_1188);
			func_392(&uLocal_1259, 3, iLocal_1188, "MAFIABOSS", 0, 1);
			iLocal_1189 = unk_0xD49F9B0955C367DE(26, iLocal_1177[1], -153.6352f, -942.8479f, 113.1339f, 66f, true, true);
			unk_0xC8A9481A01E63C28(iLocal_1189, 0);
			unk_0xBF0FD6E56C964FCB(iLocal_1189, joaat("weapon_smg"), -1, true, true);
		}
		if (!unk_0x84A2DD9AC37C35C1(iLocal_1189))
		{
...
int func_351(float fParam0, int iParam1)
{
	...
	if (((unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false) && func_352(unk_0x9A9112A0FE9A4713(unk_0xD80958FC74E988A6(), false), fParam0, 1, 1056964608, 0, 1, 0)) && !unk_0x886E37EC497200B6(unk_0xD80958FC74E988A6())) || !unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false))
	{
...
void func_354()
{
	...
	switch (iLocal_1159)
	{
		case 0:
			...
			if (unk_0x20B60995556D004F(unk_0xD80958FC74E988A6(), Local_1211, 5f, 5f, 2f, true, true, 0))
			{
			}
			if (func_356(Local_1211, 5f) && unk_0x908CBECC2CAA3690(unk_0x4F8644AF03D0E0D6()))
			{
				if (unk_0xA6DB27D19ECBB7DA(iLocal_1108))
				{
					unk_0x86A652570E5F25DD(&iLocal_1108);
		...
		case 1:
			if ((unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false) && func_352(unk_0x9A9112A0FE9A4713(unk_0xD80958FC74E988A6(), false), 10f, 1, 1056964608, 0, 1, 0)) || !unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false))
			{
				if (!bLocal_1113)
				{
					func_31(&iLocal_1254);
...
void func_358()
{
	if (!unk_0x7239B21A38F536BA(Local_1104[0 /*19*/]))
	{
		Local_1104[0 /*19*/] = unk_0xD49F9B0955C367DE(26, iLocal_1177[1], -111.9202f, -943.5192f, 28.2288f, 344.7112f, true, true);
		unk_0x0DC7CABAB1E9B67E(Local_1104[0 /*19*/], true, 1);
		unk_0x9F7794730795E019(Local_1104[0 /*19*/], 50, true);
		unk_0xC158D28142A34608(Local_1104[0 /*19*/]);
		func_359(0);
	}
	if (!unk_0x7239B21A38F536BA(Local_1104[1 /*19*/]))
	{
		Local_1104[1 /*19*/] = unk_0xD49F9B0955C367DE(26, iLocal_1177[1], -197.8959f, -1078.97f, 20.6882f, 166.4473f, true, true);
		unk_0x0DC7CABAB1E9B67E(Local_1104[1 /*19*/], true, 1);
		unk_0x9F7794730795E019(Local_1104[1 /*19*/], 50, true);
		unk_0xC158D28142A34608(Local_1104[1 /*19*/]);
		func_359(1);
	}
	if (!unk_0x7239B21A38F536BA(Local_1104[2 /*19*/]))
	{
		Local_1104[2 /*19*/] = unk_0xD49F9B0955C367DE(26, iLocal_1177[1], -82.0262f, -1023.124f, 27.3748f, 269.8311f, true, true);
		unk_0x0DC7CABAB1E9B67E(Local_1104[2 /*19*/], true, 1);
		unk_0x9F7794730795E019(Local_1104[2 /*19*/], 50, true);
		unk_0xC158D28142A34608(Local_1104[2 /*19*/]);
		func_359(2);
	}
}
...
{
	unk_0x9F8AA94D6D97DBF4(Local_1104[iParam0 /*19*/], true);
	unk_0xBF0FD6E56C964FCB(Local_1104[iParam0 /*19*/], joaat("weapon_microsmg"), -1, false, true);
	unk_0x4D9CA1009AFBD057(Local_1104[iParam0 /*19*/], 2);
	unk_0x3C606747B23E497B(Local_1104[iParam0 /*19*/], 2);
	unk_0xEA47FE3719165B94(Local_1104[iParam0 /*19*/], "oddjobs@assassinate@construction@", "unarmed_fold_arms", 8f, -4f, -1, 1, 0f, false, false, false);
	unk_0xC80A74AC829DDD92(Local_1104[iParam0 /*19*/], iLocal_1229);
}
...
int func_360()
{
	...
	unk_0x963D27A58DF860AC(iLocal_1177[0]);
	unk_0x963D27A58DF860AC(iLocal_1177[1]);
	if (unk_0x98A4EB5D89A0C952(iLocal_1177[0]) && unk_0x98A4EB5D89A0C952(iLocal_1177[1]))
	{
		iVar0 = 1;
	}
	else
...
void func_361()
{
	if (!unk_0x7239B21A38F536BA(iLocal_1228))
	{
		if (!unk_0x5F9532F3B5CC2551(unk_0xD80958FC74E988A6(), false))
		{
			if (unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false))
			{
				iLocal_1228 = unk_0x9A9112A0FE9A4713(unk_0xD80958FC74E988A6(), false);
				if (unk_0x7239B21A38F536BA(iLocal_1228) && !unk_0x5F9532F3B5CC2551(iLocal_1228, false))
				{
...
void func_363()
{
	...
	if (!unk_0x7239B21A38F536BA(iLocal_944))
	{
		return;
	}
	if (!unk_0x5F9532F3B5CC2551(unk_0xD80958FC74E988A6(), false))
	...
	if (unk_0xB7A628320EFF8E47(Var0, Local_946) > 10000f)
	{
		if (unk_0x7239B21A38F536BA(iLocal_944))
		{
			unk_0xE532F5D78798DAAB(joaat("p_phonebox_01b_s"));
			unk_0x539E0AE3E6634B9F(&iLocal_944);
		}
		if (unk_0x7239B21A38F536BA(iLocal_943))
		{
			unk_0xEA1C610A04DB6BBB(iLocal_943, true, false);
			unk_0x1A9205C1B9EE827F(iLocal_943, true, false);
		}
	}
}
...
void func_364()
{
	...
	{
		case 0:
			if (iLocal_1114 || unk_0x50CAD495A460B305(Local_1429, 10f) > 0)
			{
				iLocal_941 = 1;
			}
			break;
		...
		case 1:
			...
			{
				func_31(&iLocal_1239);
				if (!unk_0x84A2DD9AC37C35C1(iLocal_1194))
				{
					func_392(&uLocal_1259, 4, iLocal_1194, "OJAcsGUARD", 0, 1);
					func_64(&uLocal_1259, "OJASAUD", "OJAScs_ALERT", 8, 0, 0, 0);
					if (unk_0x77F1BEB8863288D5(iLocal_1194, -1253019028) == 1)
					{
						unk_0xF1C03A5352243A30(iLocal_1194);
						unk_0xE1EF3C1216AFF2CD(iLocal_1194);
					}
					if (!unk_0x997ABD671D25CA0B(iLocal_1194, false))
					{
						if (func_39(iLocal_1194, iLocal_1187, 1) > 5f)
						{
							unk_0x97465886D35210E9(iLocal_1194, iLocal_1187, iLocal_1187, 2f, false, 0.5f, 4f, true, false, joaat("FIRING_PATTERN_FULL_AUTO"));
						}
						else
						{
							unk_0x9B53BB6E8943AF53(iLocal_1194, iLocal_1187, -1, false);
						}
					}
				}
			}
...
int func_365()
{
	...
	if (!unk_0x5F9532F3B5CC2551(iLocal_1187, false))
	{
		if (((unk_0x51210CED3DA1C78A(iLocal_1187, -113.319f, -941.315f, -100f, -171.373f, -1095.764f, 100f, 100f, false, false, 0) || unk_0x51210CED3DA1C78A(iLocal_1187, Local_1209[0 /*3*/], Local_1208[0 /*3*/], fLocal_1210[0], false, true, 0)) || unk_0x51210CED3DA1C78A(iLocal_1187, Local_1209[1 /*3*/], Local_1208[1 /*3*/], fLocal_1210[1], false, true, 0)) || unk_0x51210CED3DA1C78A(iLocal_1187, Local_1209[2 /*3*/], Local_1208[2 /*3*/], fLocal_1210[2], false, true, 0))
		{
			bLocal_1139 = true;
		}
		else
	...
	switch (iLocal_1169)
	{
		case 0:
			...
			while (iVar0 < 3)
			{
				if (!unk_0x84A2DD9AC37C35C1(Local_1104[iVar0 /*19*/]))
				{
					if (iLocal_1105[iVar0])
					{
						unk_0xEA47FE3719165B94(Local_1104[iVar0 /*19*/], "oddjobs@assassinate@construction@", "unarmed_fold_arms", 4f, -4f, -1, 1, 0f, false, false, false);
						iLocal_1105[iVar0] = 0;
					}
					if (unk_0x51210CED3DA1C78A(iLocal_1187, Local_1209[0 /*3*/], Local_1208[0 /*3*/], fLocal_1210[0], false, true, 0))
					{
						iLocal_1170 = 0;
					}
					else if (unk_0x51210CED3DA1C78A(iLocal_1187, Local_1209[1 /*3*/], Local_1208[1 /*3*/], fLocal_1210[1], false, true, 0))
					{
						iLocal_1170 = 1;
					}
					else if (unk_0x51210CED3DA1C78A(iLocal_1187, Local_1209[2 /*3*/], Local_1208[2 /*3*/], fLocal_1210[2], false, true, 0))
					{
						iLocal_1170 = 2;
					}
					else
					...
					if (iLocal_1170 != -1)
					{
						...
						if (!unk_0x84A2DD9AC37C35C1(Local_1104[iLocal_1170 /*19*/]))
						{
							unk_0x5AD23D40115353AC(Local_1104[iLocal_1170 /*19*/], unk_0xD80958FC74E988A6(), -1);
						}
						iLocal_1169 = 1;
						break;
					}
		...
		case 3:
			if (!unk_0x84A2DD9AC37C35C1(Local_1104[iLocal_1170 /*19*/]))
			{
				...
				if (func_64(&uLocal_1259, "OJASAUD", "OJAScs_WRN2", 9, 0, 0, 0))
				{
					if (!unk_0x84A2DD9AC37C35C1(Local_1104[iLocal_1170 /*19*/]))
					{
						unk_0x9B53BB6E8943AF53(Local_1104[iLocal_1170 /*19*/], unk_0xD80958FC74E988A6(), -1, true);
		...
		case 5:
			...
			while (iVar0 < 3)
			{
				if (!unk_0x84A2DD9AC37C35C1(Local_1104[iVar0 /*19*/]))
				{
					unk_0xE1EF3C1216AFF2CD(Local_1104[iVar0 /*19*/]);
					unk_0xF166E48407BAC484(Local_1104[iVar0 /*19*/], unk_0xD80958FC74E988A6(), 0, 16);
				}
				iVar0++;
			}
			bLocal_1113 = true;
...
int func_367()
{
	...
	while (iVar0 < 3)
	{
		if (!unk_0x5F9532F3B5CC2551(Local_1104[iVar0 /*19*/], false))
		{
...
void func_369(bool bParam0)
{
	if (!unk_0xA6DB27D19ECBB7DA(iLocal_1108))
	{
		...
		unk_0xEAA0FFE120D92784(iLocal_1108, "ASS_CS_STATION");
...
int func_371(struct<3> Param0, bool bParam1)
{
	...
	unk_0xD38744167B2FA257(iVar0, func_134(unk_0x10FAB35428CCC9D7(), 1f, 1f));
...
void func_379()
{
	...
	func_241(3);
	if (!unk_0x84A2DD9AC37C35C1(Local_1100[0 /*19*/]))
	{
		unk_0x06843DA7060A026B(Local_1100[0 /*19*/], -152.2697f, -1003.765f, 113.1382f, true, false, false, true);
	}
	func_338();
	func_337(0);
	...
	unk_0x2208438012482A1A(iLocal_1187, true, false);
	unk_0x4172393E6BE1FECE(iLocal_1187, -182.1094f, -1004.058f, 113.1362f, -1, false, 0f, false, false, 0, false);
	func_374(0, -1, 1);
	unk_0xB4EC2312F4E5B1F1(90f);
	unk_0x6D0858B8EDFD2B7D(0f, 1f);
	unk_0xB302540597885499(unk_0x4F8644AF03D0E0D6());
...
void func_380()
{
	bLocal_1427 = func_381(1);
	if (bLocal_1427 != 0)
	{
		unk_0xBF0FD6E56C964FCB(unk_0xD80958FC74E988A6(), bLocal_1427, false, false, false);
	}
	else
	{
		bLocal_1427 = unk_0x8483E98E8B888AE2(unk_0xD80958FC74E988A6(), false);
		unk_0xBF0FD6E56C964FCB(unk_0xD80958FC74E988A6(), bLocal_1427, false, false, false);
	}
}
...
void func_382(bool bParam0, bool bParam1)
{
	...
	if (!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()))
	{
		...
		else
		{
			...
			unk_0xBF0FD6E56C964FCB(unk_0xD80958FC74E988A6(), bParam0, false, false, false);
		}
	}
}
...
void func_385()
{
	if (!unk_0xAFC1CA75AD4074D1(iLocal_1425))
	{
		iLocal_1175 = 0;
		unk_0x933D6A9EEC1BACD0(&iLocal_1175, 3);
		unk_0x933D6A9EEC1BACD0(&iLocal_1175, 4);
		iLocal_1425 = unk_0xFBA08C503DD5FA58(joaat("pickup_parachute"), -140.6149f, -945.9811f, 268.1331f, iLocal_1175, 1, true, 0);
		if (!unk_0xAFC1CA75AD4074D1(iLocal_1426))
		{
			iLocal_1426 = unk_0x891804727E0A98B7(joaat("pickup_parachute"), -149.709f, -966.41f, 269.23f, 87f, 22f, 90f, 0, -1, 2, true, 0);
		}
	}
}
...
void func_386()
{
	if (!unk_0xAFC1CA75AD4074D1(iLocal_1424))
	{
		iLocal_1424 = unk_0x891804727E0A98B7(joaat("pickup_health_standard"), -170.47f, -1016.089f, 114.537f, 0f, 0f, 65f, 0, -1, 2, true, 0);
	}
}
...
void func_387(bool bParam0)
{
	...
	while (iVar0 < 5)
	{
		if (bParam0)
		{
			if (unk_0x7239B21A38F536BA(iLocal_1186[iVar0]))
			{
				unk_0x3AE22DEB5BA5A3E6(&(iLocal_1186[iVar0]));
			}
		}
		else if (!unk_0x7239B21A38F536BA(iLocal_1186[iVar0]))
		{
			iLocal_1186[iVar0] = unk_0x509D5878EB39E842(joaat("prop_conc_blocks01a"), Var1[iVar0 /*3*/], true, true, false);
			unk_0x8E2530AA8ADA980E(iLocal_1186[iVar0], fVar2[iVar0]);
			unk_0x428CA6DBD1094446(iLocal_1186[iVar0], true);
		}
		iVar0++;
	}
}
...
void func_389()
{
	if (!unk_0x7239B21A38F536BA(iLocal_1223))
	{
		iLocal_1223 = unk_0xAF35D0D2583051B0(bLocal_1178, Local_1196, fLocal_1157, true, true, false);
	}
	if (!unk_0x7239B21A38F536BA(iLocal_1224))
	{
		iLocal_1224 = unk_0xAF35D0D2583051B0(bLocal_1179, -130.3431f, -1096.441f, 21.3323f, 337f, true, true, false);
		unk_0x153973AB99FE8980(iLocal_1224, "ASSASSINATION_CONSTRUCT_CAR_GROUP", 0f);
	}
}

void func_390()
{
	iLocal_1155 = unk_0x6ABFA3E16460F22D(26379945, -150.9599f, -944.2627f, 114.3693f, 3.6074f, -0.2888f, 15.6398f, 50f, false, 2);
	iLocal_1156 = unk_0x6ABFA3E16460F22D(26379945, -150.6499f, -945.0825f, 114.3487f, 1.2634f, -0.2776f, 28.5068f, 50f, false, 2);
}
...
int func_391()
{
	...
	iVar0 = 0;
	if (((((((((((unk_0x98A4EB5D89A0C952(bLocal_1178) && unk_0x98A4EB5D89A0C952(bLocal_1179)) && unk_0x98A4EB5D89A0C952(bLocal_1180)) && unk_0x98A4EB5D89A0C952(bLocal_1181)) && unk_0x98A4EB5D89A0C952(joaat("prop_conc_blocks01a"))) && unk_0x98A4EB5D89A0C952(bLocal_1183)) && unk_0x02245FE4BED318B8(3)) && unk_0xD031A9162D01088C("oddjobs@assassinate@construction@")) && unk_0xCB4E8BE8A0063C5D("OJAScs_101")) && unk_0x300D614A4C785FC4(102, "OJAScs")) && unk_0x2F844A8B08D76685("Freight_Elevator", false, -1)) && unk_0x2F844A8B08D76685("SCRIPT\ASSASSINATION_MULTI", false, -1))
	{
		iVar0 = 1;
	}
	return iVar0;
...
void func_393()
{
	...
	unk_0x8EDF950167586B7C(0, "WORLD_HUMAN_GUARD_STAND", Local_1204[0 /*3*/], -139.4077f, -993.4732f, 26.2754f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x8EDF950167586B7C(1, "WORLD_HUMAN_GUARD_STAND", Local_1204[1 /*3*/], -116.1392f, -987.4984f, 26.38541f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x8EDF950167586B7C(2, "WORLD_HUMAN_GUARD_STAND", Local_1204[2 /*3*/], -128.4685f, -979.0341f, 26.2754f, unk_0xD53343AA4FB7DD28(5000, 10000));
	...
	unk_0x8EDF950167586B7C(0, "WORLD_HUMAN_GUARD_STAND", Local_1204[3 /*3*/], -138.0908f, -980.1388f, 26.3835f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x8EDF950167586B7C(1, "WORLD_HUMAN_GUARD_STAND", Local_1204[4 /*3*/], 0f, 0f, 0f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x8EDF950167586B7C(2, "WORLD_HUMAN_GUARD_STAND", Local_1204[5 /*3*/], -150.6753f, -982.7073f, 26.3835f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x23083260DEC3A551(0, 1);
	unk_0x23083260DEC3A551(1, 2);
	unk_0x23083260DEC3A551(2, 0);
	unk_0xB043ECA801B8CBC1();
	...
	unk_0x8EDF950167586B7C(0, "WORLD_HUMAN_GUARD_STAND", Local_1204[6 /*3*/], 0f, 0f, 0f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x8EDF950167586B7C(1, "WORLD_HUMAN_GUARD_STAND", Local_1204[7 /*3*/], 0f, 0f, 0f, 0);
	unk_0x8EDF950167586B7C(2, "WORLD_HUMAN_GUARD_STAND", Local_1204[8 /*3*/], 0f, 0f, 0f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x23083260DEC3A551(0, 1);
	unk_0x23083260DEC3A551(1, 2);
	unk_0x23083260DEC3A551(2, 0);
	unk_0xB043ECA801B8CBC1();
	...
	unk_0x8EDF950167586B7C(0, "WORLD_HUMAN_GUARD_STAND", Local_1204[9 /*3*/], -108.7927f, -1033.771f, 26.2731f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x8EDF950167586B7C(1, "WORLD_HUMAN_GUARD_STAND", Local_1204[10 /*3*/], -115.0062f, -1054.933f, 26.2892f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x8EDF950167586B7C(2, "WORLD_HUMAN_GUARD_STAND", Local_1204[11 /*3*/], -144.801f, -1043.662f, 26.2912f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x23083260DEC3A551(0, 1);
	unk_0x23083260DEC3A551(1, 2);
	unk_0x23083260DEC3A551(2, 0);
	unk_0xB043ECA801B8CBC1();
	...
	unk_0x8EDF950167586B7C(0, "WORLD_HUMAN_GUARD_STAND", Local_1204[12 /*3*/], -130.3284f, -998.4552f, 26.2731f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x8EDF950167586B7C(1, "WORLD_HUMAN_GUARD_STAND", Local_1204[13 /*3*/], -142.5782f, -1008.276f, 26.2731f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x23083260DEC3A551(0, 1);
	...
	unk_0x8EDF950167586B7C(0, "WORLD_HUMAN_GUARD_STAND", Local_1204[14 /*3*/], -194.7176f, -1062.09f, 21.8847f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x8EDF950167586B7C(1, "WORLD_HUMAN_GUARD_STAND", Local_1204[15 /*3*/], -167.7465f, -1038.089f, 26.2798f, 0);
	unk_0x8EDF950167586B7C(2, "WORLD_HUMAN_GUARD_STAND", Local_1204[16 /*3*/], -194.7176f, -1062.09f, 21.8847f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x23083260DEC3A551(0, 1);
	unk_0x23083260DEC3A551(1, 2);
	unk_0x23083260DEC3A551(2, 0);
	unk_0xB043ECA801B8CBC1();
	...
	unk_0x8EDF950167586B7C(0, "WORLD_HUMAN_GUARD_STAND", Local_1204[17 /*3*/], -194.4449f, -1017.974f, 28.2895f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x8EDF950167586B7C(1, "WORLD_HUMAN_GUARD_STAND", Local_1204[18 /*3*/], -182.4519f, -1021.044f, 28.2863f, unk_0xD53343AA4FB7DD28(5000, 10000));
	unk_0x23083260DEC3A551(0, 1);
	unk_0x23083260DEC3A551(1, 0);
	unk_0xB043ECA801B8CBC1();
	unk_0xAF8A443CCC8018DC();
...
void func_394()
{
	...
	unk_0xF372BC22FCB88606("ConstructionEnemies", &iLocal_1229);
	unk_0xBF25EB89375A37AD(5, iLocal_1229, joaat("player"));
	unk_0xBF25EB89375A37AD(5, joaat("player"), iLocal_1229);
}
...
void func_397()
{
	unk_0x963D27A58DF860AC(bLocal_1178);
	unk_0x963D27A58DF860AC(bLocal_1179);
	unk_0x963D27A58DF860AC(bLocal_1180);
	unk_0x963D27A58DF860AC(bLocal_1181);
	unk_0x963D27A58DF860AC(joaat("prop_conc_blocks01a"));
	unk_0x963D27A58DF860AC(bLocal_1183);
	...
	unk_0x2F844A8B08D76685("Freight_Elevator", false, -1);
	unk_0x2F844A8B08D76685("SCRIPT\ASSASSINATION_MULTI", false, -1);
...
void func_398()
{
	...
	bLocal_1178 = joaat("utillitruck3");
	bLocal_1179 = joaat("seminole");
	bLocal_1180 = joaat("prop_conslift_door");
	bLocal_1181 = joaat("prop_conslift_lift");
	bLocal_1182 = joaat("maverick");
	bLocal_1183 = joaat("prop_sub_release");
}
	...
	switch (iLocal_942)
	{
		case 0:
			...
			if (bLocal_962)
			{
				if (unk_0x7239B21A38F536BA(iLocal_943))
				{
					...
					if (unk_0x7239B21A38F536BA(iLocal_943))
					{
						unk_0xEA1C610A04DB6BBB(iLocal_943, false, false);
						unk_0x1A9205C1B9EE827F(iLocal_943, false, false);
						unk_0x1760FFA8AB074D66(iLocal_943, false);
						iLocal_944 = unk_0x509D5878EB39E842(joaat("p_phonebox_01b_s"), 809.3085f, -1074.928f, 27.6018f, true, true, false);
						unk_0x8524A8B0171D5E07(iLocal_944, 0f, 0f, 0.091681f, 2, true);
						unk_0x1A9205C1B9EE827F(iLocal_944, false, false);
						unk_0x1760FFA8AB074D66(iLocal_944, false);
						unk_0xEA1C610A04DB6BBB(unk_0xD80958FC74E988A6(), true, false);
					}
					iLocal_1097 = unk_0x219C7B8D53E429FD(809.3085f, -1074.928f, 27.6018f, 350f, 12, 127);
					func_202(1, 1, 1, 0, 0, 0, 0);
					if (!unk_0x5F9532F3B5CC2551(unk_0xD80958FC74E988A6(), false))
					{
						unk_0x2208438012482A1A(unk_0xD80958FC74E988A6(), false, false);
						unk_0x06843DA7060A026B(unk_0xD80958FC74E988A6(), Local_947, true, false, false, true);
						unk_0x8E2530AA8ADA980E(unk_0xD80958FC74E988A6(), fLocal_948);
						unk_0xADF692B254977C0C(unk_0xD80958FC74E988A6(), joaat("weapon_unarmed"), true);
						unk_0xA7B2458D0AD6DED8(unk_0xD80958FC74E988A6(), true);
					}
					iLocal_970 = unk_0x8C18E0F9080ADD73(Local_968, Local_969, 2);
					if (unk_0x7239B21A38F536BA(iLocal_944))
					{
						unk_0x272E4723B56A3B96(iLocal_970, iLocal_944, -1);
					}
					unk_0xEEA929141F699854(unk_0xD80958FC74E988A6(), iLocal_970, "oddjobs@assassinate@construction@call", "ass_construction_call_p1", 1000f, -2f, 2, 0, 1000f, 0);
					unk_0xC77720A12FE14A86(iLocal_944, iLocal_970, "ass_construction_call_phone", "oddjobs@assassinate@construction@call", 1000f, -2f, 0, 1000f);
					unk_0xDD19FA1C6D657305(Local_947, 5f);
					if (!unk_0xA7A932170592B50E(iLocal_945))
					{
						iLocal_945 = unk_0x6ABFA3E16460F22D(26379945, Local_952, Local_953, 34.0542f, true, 2);
						unk_0x07E5B515DB0636FC(true, false, 3000, true, false, 0);
						unk_0x6A25241C340D3822(iLocal_945, "HAND_SHAKE", 0.2f);
					}
					func_392(&uLocal_1259, 3, 0, "LESTER", 0, 1);
					func_392(&uLocal_1259, 1, unk_0xD80958FC74E988A6(), "FRANKLIN", 0, 1);
					unk_0xA0EBB943C300E693(false);
					unk_0xA6294919E56FF02A(false);
				...
				else
				{
					...
					if (!unk_0x7239B21A38F536BA(iLocal_943))
					{
						iLocal_943 = unk_0xE143FA2249364369(Local_946, 5f, joaat("prop_phonebox_01b"), true, false, true);
					}
				}
			}
			break;
		...
		case 1:
			...
			if (!iLocal_961)
			{
				if (!unk_0x5F9532F3B5CC2551(unk_0xD80958FC74E988A6(), false))
				{
					if (unk_0x25D39B935A038A26(iLocal_970))
					{
						if (unk_0xE4A310B1D7FA73CC(iLocal_970) > 0.05f)
						{
			...
			if (func_30(&iLocal_954))
			{
				if ((func_27(&iLocal_954) > fLocal_949 || (unk_0x25D39B935A038A26(iLocal_970) && unk_0xE4A310B1D7FA73CC(iLocal_970) >= 0.961f)) || bLocal_960)
				{
					iLocal_942 = 3;
				}
			}
		...
		case 2:
			...
			if (bLocal_960)
			{
				if (unk_0xB16FCE9DDC7BA182())
				{
					...
					unk_0x43D3807C077261E3(iLocal_944, -1000f, true);
					unk_0x4EDE34FBADD967A6(0);
		...
		case 3:
			...
			if (unk_0x07C313F94746702C(iLocal_1097))
			{
				unk_0x1EE7D8DF4425F053(iLocal_1097);
			}
			unk_0x1A9205C1B9EE827F(iLocal_944, true, false);
			unk_0xA0EBB943C300E693(true);
			unk_0xA6294919E56FF02A(true);
			unk_0xE1EF3C1216AFF2CD(unk_0xD80958FC74E988A6());
			unk_0x8D32347D6D4C40A2(unk_0x4F8644AF03D0E0D6(), true, 0);
			...
			unk_0x3AE22DEB5BA5A3E6(&iLocal_943);
			iLocal_938 = 4;
			break;
	}
}
...
int func_402(int iParam0, float fParam1, struct<3> Param2, struct<3> Param3, float fParam4, bool bParam5, float fParam6)
{
	if (unk_0xA7A932170592B50E(*iParam0))
	{
		if (func_30(&iLocal_957))
		{
			...
			{
				unk_0x4D41783FB745E42E(iLocal_945, Param2);
				unk_0x85973643155D0B07(iLocal_945, Param3, 2);
				unk_0xB13C14F66A00D047(iLocal_945, fParam4);
				if (bParam5)
				{
					unk_0x6A25241C340D3822(iLocal_945, "HAND_SHAKE", fParam6);
				}
				return 1;
			}
		}
...
void func_410()
{
	if (iLocal_1430 > 0)
	{
		if (unk_0x50CAD495A460B305(Local_1429, 5f) > 0)
		{
			if (unk_0x4C241E39B23DF959(iLocal_1223, false))
			{
				if (unk_0x7D5DABE888D2D074(iLocal_1223) > 499f)
				{
					unk_0x70DB57649FA8D0D8(iLocal_1223, 499f);
				}
			}
		}
	}
	switch (iLocal_1430)
	{
		case 0:
			if (func_34(Local_1429, 0) < 100f)
			{
				if (unk_0x4C241E39B23DF959(iLocal_1223, false))
				{
					unk_0xFAEE099C6F890BB8(iLocal_1223, false, false, false, false, false, false, false, false);
					unk_0x192547247864DFDD(iLocal_1223, true);
					unk_0x465BF26AB9684352(iLocal_1223, false);
				}
				unk_0x4F5212C7AD880DF8(Local_1429, 1.5f, 2f, 1f);
				iLocal_1430++;
			}
			break;
		
		case 1:
			unk_0x4F5212C7AD880DF8(Local_1429 + Vector(0f, 0.35f, 0.25f), 1.5f, 2f, 1f);
			iLocal_1430++;
			break;
		
		case 2:
			unk_0x4F5212C7AD880DF8(Local_1429 + Vector(0f, 0.7f, 0.5f), 1.5f, 2f, 1f);
			iLocal_1430++;
			break;
		
		case 3:
			unk_0x4F5212C7AD880DF8(Local_1429 + Vector(0f, 1.05f, 0.75f), 1.5f, 2f, 1f);
			iLocal_1430++;
			break;
		
		case 4:
			unk_0x4F5212C7AD880DF8(Local_1429 + Vector(0f, 1.4f, 1f), 1.5f, 2f, 1f);
			iLocal_1430++;
			break;
		
		case 5:
			unk_0x4F5212C7AD880DF8(Local_1429 + Vector(0f, 1.75f, 1.25f), 1.5f, 2f, 1f);
			iLocal_1430++;
			break;
		
		case 6:
			unk_0x4F5212C7AD880DF8(Local_1429 + Vector(0f, 2.15f, 1.5f), 1.5f, 2f, 1f);
			iLocal_1430++;
			break;
		
		case 7:
			unk_0x4F5212C7AD880DF8(Local_1429 + Vector(0f, 2.4f, 1.8f), 1.5f, 2f, 1f);
			iLocal_1430++;
			break;
		
		case 8:
			unk_0x99AC7F0D8B9C893D(1f);
			unk_0x967278682CB6967A(Local_1429, 1f);
			iLocal_1430++;
			break;
		
		case 9:
			unk_0x967278682CB6967A(Local_1429 + Vector(0f, 0.7f, 0.5f), 1f);
			iLocal_1430++;
			break;
		
		case 10:
			unk_0x967278682CB6967A(Local_1429 + Vector(0f, 1.4f, 1f), 1f);
			iLocal_1430++;
			break;
		
		case 11:
			unk_0x967278682CB6967A(Local_1429 + Vector(0f, 2.15f, 1.5f), 1f);
			iLocal_1430++;
			break;
	...
	switch (iLocal_1173)
	{
		case 0:
			if (!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()))
			{
				...
				if (((unk_0x298B91AE825E5705(unk_0xD80958FC74E988A6()) || unk_0x5FFF4CFC74D8FB80(unk_0xD80958FC74E988A6())) || iVar2) || unk_0x51210CED3DA1C78A(iLocal_1187, -117.225f, -977.2565f, 200.1625f, -135.9228f, -971.2293f, 268.8807f, 11f, false, true, 0))
				{
					fVar1 = unk_0xB7A628320EFF8E47(Var0, Local_1201);
		...
		case 1:
			if (bLocal_1141)
			{
				...
				if (unk_0x7239B21A38F536BA(iLocal_1224))
				{
					unk_0x18EB48CFC41F2EA0(iLocal_1224, 0f);
				}
				iLocal_1159 = 0;
				iLocal_938 = 13;
				iLocal_1173 = 2;
...
{
	if ((((((((((!unk_0x7239B21A38F536BA(iParam0) || !unk_0x4C241E39B23DF959(iParam0, false)) || func_263(iParam0, 0, 0)) || func_263(iParam0, 1, 0)) || func_263(iParam0, 2, 0)) || func_253(iParam0) != 145) || func_434(iParam0)) || func_433(iParam0)) || func_432(iParam0)) || func_431(iParam0)) || !func_419(unk_0x9F47B058362C84B5(iParam0)))
	{
		if (func_433(iParam0))
		{
		}
...
int func_420(bool bParam0, bool bParam1)
{
	...
	{
		if ((func_425() || unk_0x48AF36444B965238()) || func_424())
		{
		}
		else if (!func_427())
		{
...
int func_444(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (bVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_446(iParam0, uVar1[iVar3], 1) && func_445(unk_0x3FEF770D40960D5A(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_24(Param1, 0f, 0f, 0f, 0)) || unk_0xF1B760881820C952(unk_0x3FEF770D40960D5A(iParam0, true), unk_0x3FEF770D40960D5A(uVar1[iVar3], true), true) < 10f)
					{
...
void func_448(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0x7239B21A38F536BA(Global_97772[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x9F47B058362C84B5(Global_97772[iVar0]) == func_255(iParam0, iParam1))
				{
...
void func_449(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (unk_0x4C241E39B23DF959(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				unk_0x933D6A9EEC1BACD0(&(uParam1->f_77), func_258(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					unk_0x933D6A9EEC1BACD0(&(uParam1->f_77), func_258(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					unk_0x933D6A9EEC1BACD0(&(uParam1->f_77), func_258(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						unk_0x933D6A9EEC1BACD0(&(uParam1->f_77), func_258(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("dinghy5"))
		{
			...
			{
				unk_0x933D6A9EEC1BACD0(&(uParam1->f_77), func_258(4));
			}
		}
		...
		{
			unk_0x933D6A9EEC1BACD0(&(uParam1->f_77), func_258(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					unk_0x933D6A9EEC1BACD0(&(uParam1->f_77), func_258(iVar5));
				}
				iVar5++;
			}
		}
		...
		if (((func_450() && unk_0xA0948AB42D7BA0DE(uParam1->f_66)) && unk_0xE43701C36CAFF1A4(iParam0)) && !unk_0x423E8DE37D934D89(iParam0, joaat("avenger")))
		{
...
int func_455(int iParam0, var uParam1, var uParam2)
{
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (unk_0x772960298DA26FDB(*iParam0, bVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_460(*iParam0, bVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_459(unk_0x9F47B058362C84B5(*iParam0), 1) && unk_0x772960298DA26FDB(*iParam0, 24) != func_458(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x6AF0636DDEDCB6DD(*iParam0, 24, func_458(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_457(iParam0);
	if (func_456(*iParam0))
	{
...
int func_460(var uParam0, bool bParam1, bool bParam2)
{
	if (!func_461() && unk_0x00834EAC4A96E010(uParam0, bParam1, bParam2))
	{
		return 1;
	}
	return 0;
...
int func_467(int iParam0)
{
	if (unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false))
	{
		if (!func_473(unk_0x4F8644AF03D0E0D6(), -1))
		{
	...
	if (func_469(unk_0x4F8644AF03D0E0D6()) == 3)
	{
		if (unk_0x7239B21A38F536BA(iParam0) && unk_0x4C241E39B23DF959(iParam0, false))
		{
...
void func_488()
{
	...
	func_493();
	unk_0x0A41540E63C9EE17();
	unk_0x1033371FC8E842A7(iLocal_1167);
	func_216(&Local_1098, 5);
	func_216(&Local_1099, 3);
	func_216(&Local_1100, 6);
	func_216(&Local_1101, 2);
	...
	unk_0xE532F5D78798DAAB(iLocal_1177[0]);
	unk_0xE532F5D78798DAAB(iLocal_1177[1]);
	unk_0xE532F5D78798DAAB(bLocal_1180);
	unk_0xE532F5D78798DAAB(bLocal_1181);
	unk_0xE532F5D78798DAAB(bLocal_1183);
	unk_0xE163A4BCE4DE6F11(iLocal_1177[0], false);
	unk_0xD9E3006FB3CBD765(Local_1198, 5f, joaat("prop_conslift_lift"), false);
	unk_0xD9E3006FB3CBD765(Local_1199, 5f, joaat("prop_conslift_lift"), false);
	unk_0x41B4893843BBDB74("DT1_21_prop_lift_on");
	unk_0xEE6C5AD3ECE0A82D("DT1_21_ConSiteAssass");
	if (unk_0x7239B21A38F536BA(iLocal_1184[1]))
	{
		if (unk_0xEFBE71898A993728(iLocal_1187, iLocal_1184[1]))
		{
			unk_0x961AC54BF0613F5D(iLocal_1187, true, true);
		}
	}
	if (unk_0x7239B21A38F536BA(iLocal_1184[0]))
	{
		if (unk_0xEFBE71898A993728(iLocal_1187, iLocal_1184[0]))
		{
			unk_0x961AC54BF0613F5D(iLocal_1187, true, true);
		}
	}
	...
	unk_0x5D6B2D4830A67C62(Local_1429, 10f);
	if (unk_0x7239B21A38F536BA(iLocal_943))
	{
		unk_0xEA1C610A04DB6BBB(iLocal_943, true, false);
		unk_0x1A9205C1B9EE827F(iLocal_943, true, false);
		unk_0x1760FFA8AB074D66(iLocal_943, true);
	}
...
void func_489()
{
	...
	if (unk_0x7239B21A38F536BA(iLocal_1226))
	{
		unk_0x18EB48CFC41F2EA0(iLocal_1226, 0f);
	}
	if (unk_0xB65B60556E2A9225("ASSASSINATION_CONSTRUCT_CUTSCENE"))
	{
		unk_0xDFE8422B3B94E688("ASSASSINATION_CONSTRUCT_CUTSCENE");
...
void func_490()
{
	if (unk_0x7239B21A38F536BA(iLocal_1223))
	{
		unk_0x629BFA74418D6239(&iLocal_1223);
	}
	if (unk_0x7239B21A38F536BA(iLocal_1226))
	{
		unk_0x629BFA74418D6239(&iLocal_1226);
...
void func_491()
{
	if (unk_0x7239B21A38F536BA(iLocal_1226))
	{
		if (unk_0xE31C2C72B8692B64(iLocal_1226))
		{
			unk_0xEA386986E786A54F(&iLocal_1226);
		}
		else
		{
			unk_0x629BFA74418D6239(&iLocal_1226);
	...
	if (unk_0x7239B21A38F536BA(iLocal_1188))
	{
		if (unk_0xE31C2C72B8692B64(iLocal_1188))
		{
			unk_0x9614299DCB53E54B(&iLocal_1188);
		}
		else
...
void func_492()
{
	if (unk_0x7239B21A38F536BA(uLocal_1191[0]))
	{
		unk_0x9614299DCB53E54B(&(uLocal_1191[0]));
	}
	if (unk_0x7239B21A38F536BA(uLocal_1191[1]))
	{
		unk_0x9614299DCB53E54B(&(uLocal_1191[1]));
	}
}
...
void func_493()
{
	if (unk_0xAFC1CA75AD4074D1(iLocal_1425))
	{
		unk_0x3288D8ACAECD2AB2(iLocal_1425);
	}
	if (unk_0xAFC1CA75AD4074D1(iLocal_1426))
	{
		unk_0x3288D8ACAECD2AB2(iLocal_1426);
	}
}
...
void func_494()
{
	if (unk_0xAFC1CA75AD4074D1(iLocal_1424))
	{
		unk_0x3288D8ACAECD2AB2(iLocal_1424);
	}
}
