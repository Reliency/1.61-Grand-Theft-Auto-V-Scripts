...
int func_2()
{
	...
	{
		if (unk_0x7239B21A38F536BA(bLocal_235))
		{
			if (unk_0x1F0B79228E461EC9(Global_100162, &sLocal_239, &cLocal_271, 3))
			{
				if (unk_0x28D3FED7190D3A0B(Global_100162))
				{
					unk_0xEE08C992D238C5D1(Global_100162, 0, false);
					unk_0xE1EF3C1216AFF2CD(Global_100162);
					return 0;
				}
				fVar0 = unk_0xE4A310B1D7FA73CC(bLocal_280);
				if (!iLocal_234)
				{
				...
				if (fVar0 < 0.2812f)
				{
					if (iLocal_281 != 0)
					{
						unk_0x8F75998877616996(iLocal_281, false);
						iLocal_281 = 0;
					}
				}
				else if (fVar0 < 0.4778f)
				{
					if (iLocal_281 == 0)
					{
						iLocal_281 = unk_0x1AE42C1660FD6517("scr_lamgraff_paint_spray", bLocal_235, 0f, 0f, 0f, 0f, 0f, 0f, 1f, false, false, false);
						unk_0x7F8F65877F88783B(iLocal_281, fLocal_282, fLocal_283, fLocal_284, false);
					}
				}
...
int func_26()
{
	...
	if (!unk_0x84A2DD9AC37C35C1(Global_100162))
	{
		if (unk_0x7239B21A38F536BA(bLocal_235))
		{
			if (unk_0x1F0B79228E461EC9(Global_100162, &sLocal_239, &cLocal_255, 3))
			{
				if (unk_0x28D3FED7190D3A0B(Global_100162))
				{
					unk_0xEE08C992D238C5D1(Global_100162, 0, false);
				...
				{
					unk_0xE1EF3C1216AFF2CD(Global_100162);
					if (!unk_0x25D39B935A038A26(bLocal_280))
					{
						bLocal_280 = unk_0x8C18E0F9080ADD73(Local_237, 0f, 0f, bLocal_238, 2);
						unk_0xD9A897A4C6C2974F(bLocal_280, true);
					}
					unk_0xEEA929141F699854(Global_100162, bLocal_280, &sLocal_239, &cLocal_271, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
			{
				...
				{
					unk_0xE1EF3C1216AFF2CD(Global_100162);
					unk_0xD86D101FCFD00A4B(Global_100162, 16);
					if (!unk_0x25D39B935A038A26(bLocal_280))
					{
						bLocal_280 = unk_0x8C18E0F9080ADD73(Local_237, 0f, 0f, bLocal_238, 2);
						unk_0xD9A897A4C6C2974F(bLocal_280, true);
...
int func_29(int iParam0, bool bParam1)
{
	...
	if (!unk_0xD9D2CFFF49FAB35F())
	{
		...
		else if (bParam1 == func_30(Global_100162) && bParam1 != 0)
		{
			Global_100162 = 0;
		}
	}
...
void func_37()
{
	unk_0x963D27A58DF860AC(bLocal_236);
	unk_0x944955FB2A3935C8();
	while (!unk_0x7239B21A38F536BA(Global_100162) || !unk_0x98A4EB5D89A0C952(bLocal_236))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	...
	if (unk_0x7239B21A38F536BA(Global_100162))
	{
		if (!unk_0x84A2DD9AC37C35C1(Global_100162))
		{
			unk_0x919BE13EED931959(Global_100162, -1);
		}
		unk_0xC80A74AC829DDD92(Global_100162, joaat("player"));
	}
	unk_0xAD738C3085FE7E11(Global_100162, true, true);
	unk_0x1913FE4CBF41C463(Global_100162, 132, true);
	unk_0x26695EC767728D84(Global_100162, 16);
	func_39(&Global_100162, Global_95445);
	func_38(&uLocal_68, 1, unk_0xD80958FC74E988A6(), "FRANKLIN", 0, 1);
	bLocal_235 = unk_0x509D5878EB39E842(bLocal_236, unk_0x3FEF770D40960D5A(Global_100162, true), true, true, false);
	unk_0x6B9BBD38AB0796DF(bLocal_235, Global_100162, unk_0x3F428D08BE5AAE31(Global_100162, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
}
...
void func_40()
{
	...
	func_46(iLocal_67, &Local_237, &bLocal_238, &cVar0);
	bLocal_236 = joaat("prop_cs_spray_can");
	Var1.f_1 = -1;
	Var1.f_17 = 4;
	Var1.f_17.f_8 = 4;
	Var1.f_17.f_13 = 4;
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_44(uParam1, 17, 1785177548, 1785177548, unk_0x313CE5879CEB6FCD(-5f, 5f), unk_0x313CE5879CEB6FCD(-5f, 5f), 0f, unk_0x313CE5879CEB6FCD(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_44(uParam1, 144, 1785177548, 1785177548, unk_0x313CE5879CEB6FCD(-5f, 5f), unk_0x313CE5879CEB6FCD(-5f, 5f), 0f, unk_0x313CE5879CEB6FCD(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_44(uParam1, 43, 1785177548, 1785177548, unk_0x313CE5879CEB6FCD(-5f, 5f), unk_0x313CE5879CEB6FCD(-5f, 5f), 0f, unk_0x313CE5879CEB6FCD(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_44(var uParam0, int iParam1, int iParam2, int iParam3, struct<3> Param4, bool bParam5)
{
