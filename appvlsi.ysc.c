			...
			switch (Global_20266.f_1)
			{
				case 7:
					if (iLocal_21 == 1)
					{
						...
						{
							unk_0x67C540AA08E4A6F5(-1, "Lester_Laugh_Phone", "DLC_HEIST_HACKING_SNAKE_SOUNDS", true);
							Global_20244 = 1;
							func_10();
							func_5();
...
void func_2()
{
	unk_0x77ED170667F50170("DLC_MPHEIST/HEIST_HACK_SNAKE");
...
void func_10()
{
	if (iLocal_21 == 0)
	{
		unk_0x2F844A8B08D76685("DLC_MPHEIST/HEIST_HACK_SNAKE", false, -1);
		while (unk_0x2F844A8B08D76685("DLC_MPHEIST/HEIST_HACK_SNAKE", false, -1) == 0)
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		...
		unk_0xC6796A8FFA375E53();
		func_11(Global_20247, "DISPLAY_VIEW", 23f, unk_0xBBDA792448DB5A89(true), -1082130432, -1082130432, -1082130432);
		iLocal_21 = 1;
	}
	else if (iLocal_21 == 1)
	{
