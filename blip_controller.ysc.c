...
void __EntryFunction__()
{
	...
	unk_0x933D6A9EEC1BACD0(&(Global_32338[iVar2 /*23*/].f_11), 18);
	iVar2 = 0;
	iVar2 = 0;
	while (iVar2 < 263)
	{
			...
			while (iVar2 < 263)
			{
				...
				if (bVar7)
				{
					...
					if (iVar9 > 0)
					{
						if (iVar8 > 0)
						{
							unk_0xE80492A9AC099A93(&(Global_32338[iVar2 /*23*/].f_11), false);
						}
						else if (BitTest(Global_32338[iVar2 /*23*/].f_11, 15))
						{
							unk_0x933D6A9EEC1BACD0(&(Global_32338[iVar2 /*23*/].f_11), false);
						}
					}
					else if (BitTest(Global_32338[iVar2 /*23*/].f_11, 15))
					{
					...
					{
						bVar10 = false;
						if (!unk_0xA6DB27D19ECBB7DA(Global_32338[iVar2 /*23*/].f_19))
						{
							...
							if (BitTest(Global_32338[iVar2 /*23*/].f_11, 19))
							{
								switch (iLocal_53)
								{
									...
									case 2:
										...
										{
											Global_32338[iVar2 /*23*/].f_19 = unk_0x46818D79B1F7499A(Global_32338[iVar2 /*23*/][0 /*3*/], Global_32338[iVar2 /*23*/].f_10);
											unk_0x45FF974EEE1C8734(Global_32338[iVar2 /*23*/].f_19, 128);
											unk_0x75A16C3DA34F1245(Global_32338[iVar2 /*23*/].f_19, false);
										}
										else
										{
											Global_32338[iVar2 /*23*/].f_19 = unk_0x5A039BB0BCA604B6(Global_32338[iVar2 /*23*/][iLocal_53 /*3*/]);
											unk_0xDF735600A4696DAF(Global_32338[iVar2 /*23*/].f_19, Global_32338[iVar2 /*23*/].f_12[iLocal_53]);
										}
										break;
									
									default:
										Global_32338[iVar2 /*23*/].f_19 = unk_0x5A039BB0BCA604B6(1f, 2f, 3f);
										break;
								}
							}
							...
							{
								Global_32338[iVar2 /*23*/].f_19 = unk_0x5A039BB0BCA604B6(Global_32338[iVar2 /*23*/][0 /*3*/]);
								unk_0xDF735600A4696DAF(Global_32338[iVar2 /*23*/].f_19, Global_32338[iVar2 /*23*/].f_12[0]);
							}
							if (Global_32338[iVar2 /*23*/].f_16 == 1)
							{
								bVar10 = true;
						...
						else
						{
							if (BitTest(Global_32338[iVar2 /*23*/].f_11, 19))
							{
								switch (iLocal_53)
								{
									...
									case 0:
									case 2:
										unk_0xAE2AF67E9D9AF65D(Global_32338[iVar2 /*23*/].f_19, Global_32338[iVar2 /*23*/][iLocal_53 /*3*/]);
										break;
							...
							{
								unk_0xAE2AF67E9D9AF65D(Global_32338[iVar2 /*23*/].f_19, Global_32338[iVar2 /*23*/][0 /*3*/]);
							}
							if (BitTest(Global_32338[iVar2 /*23*/].f_11, 9))
							{
								if (iLocal_43)
								{
									unk_0xB14552383D39CE3E(Global_32338[iVar2 /*23*/].f_19, true);
									iLocal_43 = 0;
								}
								else
								{
									unk_0x2E8D9498C56DD0D1(Global_32338[iVar2 /*23*/].f_19, true);
									iLocal_43 = 1;
								}
								unk_0xD3CD6FD297AE87CC(Global_32338[iVar2 /*23*/].f_19, 10000);
								unk_0xE80492A9AC099A93(&(Global_32338[iVar2 /*23*/].f_11), 9);
							}
							else
							{
								unk_0xB14552383D39CE3E(Global_32338[iVar2 /*23*/].f_19, false);
							}
						}
					...
					else
					{
						if (unk_0xA6DB27D19ECBB7DA(Global_32338[iVar2 /*23*/].f_19))
						{
							unk_0x86A652570E5F25DD(&(Global_32338[iVar2 /*23*/].f_19));
							iVar5++;
							if (Global_32338[iVar2 /*23*/].f_16 == 1)
							{
								func_18(iVar2);
				...
				unk_0xE80492A9AC099A93(&(Global_32338[iVar2 /*23*/].f_11), 18);
				iVar11 = 30;
...
void func_2()
{
	...
	{
		if (func_5(Global_113386.f_2363.f_539.f_4321) != unk_0x9F47B058362C84B5(unk_0xD80958FC74E988A6()))
		{
...
void func_11()
{
	...
	Var0 = { func_17(unk_0xA5EDC40EF369B48D()) };
	iVar1 = -1;
	fVar2 = 1000000f;
	iVar3 = 0;
	iVar3 = 0;
	while (iVar3 < 7)
	{
		...
		{
			if (unk_0xA6DB27D19ECBB7DA(Global_32338[iLocal_51[iVar3] /*23*/].f_19))
			{
				fVar4 = unk_0xF1B760881820C952(Var0, unk_0x586AFE3FF72D996E(Global_32338[iLocal_51[iVar3] /*23*/].f_19), true);
				if (fVar4 < fVar2)
				{
					fVar2 = fVar4;
					iVar1 = iVar3;
	...
	while (iVar3 < 7)
	{
		if (iLocal_51[iVar3] != -1)
		{
			...
			else if (unk_0xA6DB27D19ECBB7DA(Global_32338[iLocal_51[iVar3] /*23*/].f_19))
			{
...
void func_20(int iParam0, int iParam1)
{
	...
	unk_0x03D7FB09E75D6B7E(iParam0, func_22(iParam1));
	...
	if (!unk_0xCA042B6957743895(&(Global_32338[iParam1 /*23*/].f_20)))
	{
		if (unk_0xAC09CA973C564252(&(Global_32338[iParam1 /*23*/].f_20)))
		{
			unk_0xEAA0FFE120D92784(iParam0, &(Global_32338[iParam1 /*23*/].f_20));
		}
	}
			...
			if (BitTest(Global_32338[iParam1 /*23*/].f_11, 8))
			{
				if (!func_29(iParam1))
				{
					...
					else
					{
						...
						{
							unk_0xBE8BE4FE60E27B72(iParam0, BitTest(Global_32338[iParam1 /*23*/].f_11, 5));
							unk_0xAE9FC9EF6A9FAC79(iParam0, 3);
							unk_0xBE8BE4FE60E27B72(iParam0, true);
	...
	if (BitTest(Global_32338[iParam1 /*23*/].f_11, 19))
	{
		switch (iVar0)
		{
			...
			case 0:
			case 2:
				unk_0xAE2AF67E9D9AF65D(Global_32338[iParam1 /*23*/].f_19, Global_32338[iParam1 /*23*/][iVar0 /*3*/]);
				break;
			}
	}
...
int func_22(int iParam0)
{
	...
	iVar1 = unk_0x53158863FCC0893A(Global_32338[iVar0 /*23*/].f_11, 21, 26);
	return iVar1;
}
...
int func_26(int iParam0)
{
	...
	else if (!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()))
	{
		...
		iVar2 = unk_0x05B7A89BD78797FC(Global_95479[iParam0 /*10*/].f_3, &sVar1);
...
int func_34(int iParam0)
{
	...
	{
		unk_0x933D6A9EEC1BACD0(&(Global_32338[iParam0 /*23*/].f_11), 18);
		return 1;
	}
...
int func_36()
{
	...
	if (unk_0x5F9532F3B5CC2551(unk_0x43A66C31C68491C0(unk_0xA5EDC40EF369B48D()), false))
	{
		return 0;
	}
...
int func_40()
{
	if (unk_0xE28E54788CE8F12D(unk_0xA5EDC40EF369B48D()) != iLocal_45)
	{
		iLocal_45 = unk_0xE28E54788CE8F12D(unk_0xA5EDC40EF369B48D());
		return 1;
	}
	return 0;
}
...
int func_41()
{
	...
	if (unk_0x25223CA6B4D20B7F() != bLocal_44)
	{
		bLocal_44 = unk_0x25223CA6B4D20B7F();
		return 1;
	}
	return 0;
}
...
void func_46(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		unk_0x933D6A9EEC1BACD0(&(Global_32338[iVar0 /*23*/].f_11), 2);
	}
	else
	{
		unk_0xE80492A9AC099A93(&(Global_32338[iVar0 /*23*/].f_11), 2);
	}
	if (Global_32335 == 1)
	{
		Global_32336 = 1;
...
void func_47(int iParam0, char* sParam1)
{
	...
	if (unk_0xA6DB27D19ECBB7DA(Global_32338[iVar0 /*23*/].f_19))
	{
		unk_0xEAA0FFE120D92784(Global_32338[iVar0 /*23*/].f_19, sParam1);
	}
}
