		...
		while (iVar1 != 2)
		{
			if (func_13(&(Global_32299[iVar0 /*7*/])))
			{
				if (func_12(iVar0, Var2))
				{
					...
					{
						if (unk_0x46E9AE36D8FA6417(Global_32299[iVar0 /*7*/].f_5))
						{
							unk_0xF745B37630DF176B(Global_32299[iVar0 /*7*/].f_5, 1);
						}
...
void func_1(int iParam0)
{
	...
	if (unk_0xF030907CCBB8A9FD(sVar0) != 0)
	{
		if (unk_0x2C83A9DA6BFFC4F9(bVar1) == 0)
		{
			...
			Global_32299[iParam0 /*7*/].f_5 = unk_0xE81651AD79516E48(sVar0, iVar2);
...
int func_5(var uParam0, struct<3> Param1)
{
	...
	if (unk_0xB7A628320EFF8E47(Param1, uParam0->f_2) > uParam0->f_1)
	{
		return 0;
	}
	if (!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()))
	{
		if (unk_0x51210CED3DA1C78A(unk_0xD80958FC74E988A6(), -2080.115f, 3292.193f, -11.667f, -2112.049f, 3224.331f, 11.667f, 115f, true, false, 0))
		{
			return 0;
		}
	}
...
{
	Param1.f_2 = 0f;
	if (!unk_0x46E9AE36D8FA6417(Global_32299[iParam0 /*7*/].f_5))
	{
		return 1;
	}
	...
	if (func_9() && !func_6(6))
	{
		if (!func_10(Global_32299[iParam0 /*7*/], 1))
		{
			...
			{
				if (unk_0x2C83A9DA6BFFC4F9(joaat("golf")) == 0)
				{
					return 1;
				}
			}
	...
	if (unk_0xB7A628320EFF8E47(Global_32299[iParam0 /*7*/].f_2, Param1) > (Global_32299[iParam0 /*7*/].f_1 + 400f))
	{
		return 1;
	}
	return 0;
