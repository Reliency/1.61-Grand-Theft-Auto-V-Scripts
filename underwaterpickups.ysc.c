...
void __EntryFunction__()
{
	...
	func_24(Var0);
	bLocal_4 = func_4();
	Local_5 = { unk_0x3FEF770D40960D5A(unk_0xD80958FC74E988A6(), false) };
	func_1();
	while (true)
	{
...
void func_1()
{
	...
	while (iVar0 < 20)
	{
		if (func_3(iVar0, &iVar1, &Var2, &Var3, &bVar5))
		{
			if (func_2(Var3, 0f, 0f, 0f, 0))
			{
				bVar4 = false;
				unk_0x933D6A9EEC1BACD0(&bVar4, true);
				unk_0x933D6A9EEC1BACD0(&bVar4, 4);
				unk_0x933D6A9EEC1BACD0(&bVar4, 3);
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0xFBA08C503DD5FA58(iVar1, Var2, bVar4, bVar5, true, false);
					}
				}
				else if (unk_0xB7A628320EFF8E47(Var2, Local_5) > 400f)
				{
					...
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							iLocal_3[iVar0] = unk_0xFBA08C503DD5FA58(iVar1, Var2, bVar4, -1, true, false);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0x891804727E0A98B7(iVar1, Var2, Var3, bVar4, 10000, 2, true, false);
					}
				}
				else if (unk_0xB7A628320EFF8E47(Var2, Local_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						iLocal_3[iVar0] = unk_0x891804727E0A98B7(iVar1, Var2, Var3, bVar4, -1, 2, true, false);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
var func_11(bool bParam0)
{
	return (unk_0x97EF1E5BCE9DC075(bParam0, 26) & 31 * func_12(BitTest(bParam0, 31), -1, 1)) + 2011;
}
...
void func_15(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	bVar2 = func_9(*uParam0);
	bVar3 = func_8(*uParam0);
	bVar4 = func_7(*uParam0);
	bVar5 = func_6(*uParam0);
	...
	iVar0 = (iVar0 + iParam6);
	func_16(uParam0, bVar5, bVar4, bVar3, bVar2, iVar1, iVar0);
}

void func_16(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, int iParam6)
{
	func_22(uParam0, bParam1);
	func_21(uParam0, bParam2);
	func_20(uParam0, bParam3);
	func_19(uParam0, iParam5);
	func_18(uParam0, bParam4);
...
void func_18(var uParam0, bool bParam1)
{
	...
	if (bParam1 < 1 || bParam1 > func_14(iVar0, iVar1))
	{
		return;
	}
...
bool func_23()
{
	...
	func_18(&uVar0, unk_0x3D10BC92A4DB1D35());
	func_19(&uVar0, unk_0xBBC72712E80257A1());
