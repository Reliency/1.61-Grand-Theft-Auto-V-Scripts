...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_343(unk_0xD80958FC74E988A6()))
		{
			func_339();
			func_335();
	...
	switch (iLocal_69)
	{
		case 0:
			...
			if (unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false))
			{
				...
				if (func_37(iVar0) && unk_0x9F47B058362C84B5(iVar0) == joaat("towtruck"))
				{
					func_36(iVar0, 2);
				}
			}
			if (!unk_0xCA042B6957743895(sLocal_179))
			{
				func_34(sLocal_179);
			}
			else
...
void func_3()
{
	...
	unk_0xB6BA2444AB393DA2(iLocal_40);
...
void func_39()
{
	...
	switch (iLocal_69)
	{
		...
		case 1:
			if (!func_107(unk_0xD80958FC74E988A6(), Local_186, 270f, 1))
			{
				iLocal_69 = 2;
			}
...
void func_43(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()) && !func_48(unk_0x4F8644AF03D0E0D6())) && !func_45(unk_0x4F8644AF03D0E0D6(), 0)) && !func_44()) && !bParam4) && !bParam5)
			{
				unk_0x3882114BDE571AD4(unk_0xD80958FC74E988A6(), false);
			}
		}
		else if (((!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()) && !func_48(unk_0x4F8644AF03D0E0D6())) && !bParam4) && !bParam5)
		{
			unk_0x3882114BDE571AD4(unk_0xD80958FC74E988A6(), false);
		}
		Global_78317 = 0;
...
int func_53(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)
{
	...
	if (Global_113386.f_7688.f_136 < 9)
	{
		...
		Var0.f_1 = iParam12;
		iVar1 = 0;
		unk_0x933D6A9EEC1BACD0(&iVar1, bParam5);
		Var0.f_2 = iVar1;
		Var0.f_6 = iParam6;
		Var0.f_14 = iParam7;
		Var0.f_7 = iParam10;
...
int func_85()
{
	...
	if (unk_0x4F8644AF03D0E0D6() == func_88())
	{
		return 0;
	}
...
void func_108()
{
	...
	switch (iLocal_69)
	{
		case 0:
			if (func_122(iLocal_68, bLocal_28))
			{
				if (unk_0xE28E54788CE8F12D(unk_0x4F8644AF03D0E0D6()) == 0)
				{
					...
					{
						if (unk_0xA3EE4A07279BB9DB(unk_0xD80958FC74E988A6(), iLocal_200, false))
						{
		...
		case 3:
			...
			{
				if (!unk_0xA3EE4A07279BB9DB(unk_0xD80958FC74E988A6(), Local_199.f_0, false))
				{
					unk_0xF75B0D629E1C063D(unk_0xD80958FC74E988A6(), Local_199.f_0, -1);
				}
				else
				{
...
int func_113(int iParam0, struct<3> Param1, int* iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10)
{
	...
	if ((iParam3 == 1 || iParam3 == 2) || iParam3 == 3)
	{
		if (iParam4 == 0)
		{
			...
			if (!unk_0x20B60995556D004F(unk_0xD80958FC74E988A6(), Param1, fParam10, fParam10, 2f, false, true, 2))
			{
				...
				{
					unk_0xCF708001E1E536DD(func_119(func_77()));
				}
				*iParam5 = 1;
			...
			else
			{
				...
				{
					fVar0 = (fParam10 / 2f);
					if (func_107(unk_0xD80958FC74E988A6(), Param1, fVar0, 1))
					{
						*iParam5 = 0;
	...
	else
	{
		...
		if (!*iParam6)
		{
			...
			{
				unk_0xCF708001E1E536DD(func_115(func_77(), 0));
			}
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_149(1, Local_185, 0))
			{
				...
				else if (((func_149(2, Local_199.f_1, Local_199.f_4) && func_149(3, Local_197.f_1, Local_197.f_4)) && func_149(4, Local_198.f_1, Local_198.f_4)) && func_141(0))
				{
					...
					unk_0x0FC2D89AC25A5814(joaat("towtruck"), true);
					unk_0x0FC2D89AC25A5814(joaat("s_m_y_garbage"), true);
					if (unk_0xBC8DBDCA2436F7E8(Local_199.f_0) != 0)
					{
						iVar0 = unk_0xBC8DBDCA2436F7E8(Local_199.f_0);
		...
		case 1:
			if (bParam1)
			{
				...
				{
					func_124(unk_0xD80958FC74E988A6(), 1197.861f, -353.011f, 68.0929f, 278.9647f);
					func_123();
					bLocal_28 = false;
					unk_0xEB47EC4E34FB7EE1("DRIVE", false);
					unk_0xEB47EC4E34FB7EE1("WORLD_VEHICLE_ATTRACTOR", false);
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	unk_0xF372BC22FCB88606("Enemies", &iLocal_40);
	unk_0xC80A74AC829DDD92(Local_45[0 /*11*/], iLocal_40);
	unk_0xC80A74AC829DDD92(Local_45[1 /*11*/], iLocal_40);
	unk_0xEA02E132F5C68722(Local_45[0 /*11*/], true, 0f);
	unk_0xEA02E132F5C68722(Local_45[1 /*11*/], true, 0f);
...
void func_129()
{
	if (!unk_0xA3EE4A07279BB9DB(Local_45[0 /*11*/], iLocal_43, false))
	{
		unk_0x15D3A79D4E44B913(Local_45[0 /*11*/], unk_0x1899F328B0E12848(iLocal_43, func_137(1)), 1f, -1, 0.25f, false, 40000f);
		Local_45[0 /*11*/].f_7 = 1;
	}
	else
	{
...
{
	if (!unk_0x22AC59A870E6A669(iLocal_43, false, false))
	{
		func_131(bParam0);
		if (iLocal_48 != (iLocal_41 - 1))
		{
			if (iLocal_48 == 4)
			{
				unk_0x195AEEB13CEFE2EE(Local_45[0 /*11*/], iLocal_43, Local_46[iLocal_48 /*25*/], 15f, 2883755, Local_46[iLocal_48 /*25*/].f_6);
			}
			else
			{
				unk_0xE2A2AA2F659D77A7(Local_45[0 /*11*/], iLocal_43, Local_46[iLocal_48 /*25*/], 15f, 0, false, 2883755, Local_46[iLocal_48 /*25*/].f_6, Local_46[iLocal_48 /*25*/].f_7);
			}
		...
		{
			unk_0x480142959D337D00(Local_45[0 /*11*/], iLocal_43, 15f, 786599);
			Local_45[0 /*11*/].f_8 = Local_45[0 /*11*/].f_7;
...
void func_131(bool bParam0)
{
	if (iLocal_48 != -1)
	{
		...
		{
			unk_0xC12321827687FE4D(Local_46[iLocal_48 /*25*/].f_11 - Local_46[iLocal_48 /*25*/].f_14, Local_46[iLocal_48 /*25*/].f_11 + Local_46[iLocal_48 /*25*/].f_14, true, true);
		}
	}
	if (!bParam0)
	{
	...
	if (iLocal_48 != -1)
	{
		if (!func_136(Local_46[iLocal_48 /*25*/].f_11) && !func_136(Local_46[iLocal_48 /*25*/].f_14))
		{
			unk_0xC12321827687FE4D(Local_46[iLocal_48 /*25*/].f_11 - Local_46[iLocal_48 /*25*/].f_14, Local_46[iLocal_48 /*25*/].f_11 + Local_46[iLocal_48 /*25*/].f_14, false, true);
		}
	}
}
...
int func_132()
{
	...
	{
		Var1 = { unk_0x3FEF770D40960D5A(iLocal_43, true) };
		iVar2 = 0;
		while (iVar2 <= (iLocal_41 - 1))
		{
			fVar5 = unk_0xF1B760881820C952(Var1, Local_46[iVar2 /*25*/], true);
		...
		fVar7 = func_133(Local_46[iVar0 /*25*/] - Var1, unk_0x0A794A5A57F8DF91(iLocal_43));
		iVar3 = iVar0;
		iVar8 = 0;
		while (fVar7 < 0f && iVar8 < 40)
		{
			...
			Var1 = { unk_0x3FEF770D40960D5A(iLocal_43, true) };
			fVar7 = func_133(Local_46[iVar3 /*25*/] - Var1, unk_0x0A794A5A57F8DF91(iLocal_43));
			iVar8++;
		}
		if (iVar8 >= 40)
		{
...
int func_135()
{
	...
	iVar0 = unk_0xD53343AA4FB7DD28(false, (iLocal_41 - 1));
...
Vector3 func_137(bool bParam0)
{
	...
	if (!bParam0)
	{
		iVar1 = unk_0xFB71170B7E76ACBA(iLocal_43, "wheel_rf");
	}
	else
	{
		iVar1 = unk_0xFB71170B7E76ACBA(iLocal_43, "wheel_lf");
	}
	Var0 = { unk_0x44A8FCB8ED227738(iLocal_43, iVar1) };
	Var0 = { unk_0x2274BC1C4885E333(iLocal_43, Var0) };
	if (!bParam0)
	{
...
void func_143(var uParam0)
{
	...
	func_98(uParam0, iVar0, unk_0xD80958FC74E988A6(), sVar1, 0, 1);
}
...
int func_148()
{
	if (unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false))
	{
		if (unk_0x423E8DE37D934D89(unk_0x9A9112A0FE9A4713(unk_0xD80958FC74E988A6(), false), joaat("trash")))
		{
			...
			iLocal_200 = unk_0x9A9112A0FE9A4713(unk_0xD80958FC74E988A6(), false);
			if (func_37(iLocal_200))
			{
				return 1;
			}
...
int func_149(int iParam0, struct<3> Param1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			unk_0x71A78003C8E71424(sLocal_180, false);
		...
		case 2:
			if (func_37(Global_96938[0]))
			{
				...
				if (func_37(Local_199.f_0))
				{
					...
					unk_0x92F0CF722BC4202F(Local_199.f_0, true);
					unk_0x3910051CCECDB00C(Local_199.f_0, true);
					return 1;
				}
			}
		...
		case 3:
			...
			{
				if (!unk_0x3317DEDB88C95038(Global_96938.f_9[0], true))
				{
					unk_0xAD738C3085FE7E11(Global_96938.f_9[0], true, true);
					Local_197.f_0 = Global_96938.f_9[0];
					if (func_343(Local_197.f_0))
					{
						unk_0x9F8AA94D6D97DBF4(Local_197.f_0, true);
						unk_0x1913FE4CBF41C463(Local_197.f_0, 170, false);
						unk_0x70A2D1137C8ED7C9(Local_197.f_0, 65536, true);
						unk_0x9F7794730795E019(Local_197.f_0, 50, true);
						return 1;
					}
				}
				else
			...
			else if (func_150(&Local_197, Local_197.f_5, Local_197.f_1, Local_197.f_4, 1, 0, 1, 1))
			{
				if (func_37(Local_199.f_0))
				{
					unk_0xF75B0D629E1C063D(Local_197.f_0, Local_199.f_0, -1);
					unk_0x9F8AA94D6D97DBF4(Local_197.f_0, true);
					unk_0x1913FE4CBF41C463(Local_197.f_0, 170, false);
					unk_0x70A2D1137C8ED7C9(Local_197.f_0, 65536, true);
					unk_0x9F7794730795E019(Local_197.f_0, 50, true);
		...
		case 4:
			...
			{
				if (!unk_0x3317DEDB88C95038(Global_96938.f_9[1], true))
				{
					unk_0xAD738C3085FE7E11(Global_96938.f_9[1], true, true);
					Local_198.f_0 = Global_96938.f_9[1];
					if (func_343(Local_198.f_0))
					{
						unk_0x1913FE4CBF41C463(Local_198.f_0, 170, false);
						unk_0x70A2D1137C8ED7C9(Local_198.f_0, 65536, true);
						unk_0x9F7794730795E019(Local_198.f_0, 50, true);
						unk_0x9F8AA94D6D97DBF4(Local_198.f_0, true);
						unk_0x0DC7CABAB1E9B67E(Local_198.f_0, true, 1);
						return 1;
					}
				}
				else
			...
			else if (func_150(&Local_198, Local_198.f_5, Local_198.f_1, Local_198.f_4, 1, 0, 1, 1))
			{
				if (func_37(Local_199.f_0))
				{
					unk_0xF75B0D629E1C063D(Local_198.f_0, Local_199.f_0, false);
					unk_0x1913FE4CBF41C463(Local_198.f_0, 170, false);
					unk_0x70A2D1137C8ED7C9(Local_198.f_0, 65536, true);
					unk_0x9F7794730795E019(Local_198.f_0, 50, true);
					unk_0x9F8AA94D6D97DBF4(Local_198.f_0, true);
...
int func_150(int iParam0, bool bParam1, struct<3> Param2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	if (!unk_0x7239B21A38F536BA(*iParam0))
	{
		if (func_152(bParam1, "Loading", 0))
		{
			*iParam0 = unk_0xD49F9B0955C367DE(26, bParam1, Param2, fParam3, true, true);
			if (func_343(*iParam0))
			{
				if (bParam5)
				{
				...
				if (bParam6)
				{
					unk_0x9F8AA94D6D97DBF4(*iParam0, bParam6);
				}
				if (!bParam7)
				{
					unk_0x63F58F7C80513AAD(*iParam0, bParam7);
				}
				if (bParam4)
				{
					func_151(bParam1, 1);
...
int func_152(bool bParam0, char* sParam1, int iParam2)
{
...
int func_153(int iParam0, bool bParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	if (!unk_0x7239B21A38F536BA(*iParam0))
	{
		if (func_152(bParam1, "Loading", 0))
...
void func_156(int* iParam0, int iParam1)
{
	if (func_343(*iParam0))
	{
		...
		if (unk_0x1F0B79228E461EC9(*iParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 3))
		{
			...
			{
				if (func_10(Local_46[iLocal_48 /*25*/].f_17) && unk_0xB346476EF1A64897(Local_46[iLocal_48 /*25*/].f_17))
				{
					...
					unk_0x961AC54BF0613F5D(Local_46[iLocal_48 /*25*/].f_17, true, false);
					unk_0x18FF00FC7EFF559E(Local_46[iLocal_48 /*25*/].f_17, 1, unk_0x0A794A5A57F8DF91(*iParam0), false, true, true, false);
				}
			}
		}
		switch (iParam0->f_5)
	...
	else
	{
		...
		{
			if (unk_0xB346476EF1A64897(Local_46[iLocal_48 /*25*/].f_17))
			{
				unk_0x961AC54BF0613F5D(Local_46[iLocal_48 /*25*/].f_17, true, false);
				unk_0x18FF00FC7EFF559E(Local_46[iLocal_48 /*25*/].f_17, 1, unk_0x0A794A5A57F8DF91(*iParam0), false, true, true, false);
			}
		...
		if (unk_0x7239B21A38F536BA(*iParam0))
		{
			if (!func_157(unk_0xD80958FC74E988A6(), *iParam0, 150f, 1) && !bLocal_52)
			{
...
void func_158(int* iParam0)
{
	...
	switch (iParam0->f_6)
	{
		...
		case 21:
			...
			{
				if (func_177(*iParam0, unk_0xD80958FC74E988A6(), 1126825984, 1, 250, 7))
				{
					func_176(iParam0, 1);
					return;
				}
		...
		case 11:
			...
			if ((unk_0x9CD27B0045628463() - iParam0->f_1) > 5000)
			{
				...
				{
					if (unk_0x7239B21A38F536BA(Local_45[func_171(iParam0->f_10) /*11*/]))
					{
						unk_0x15D3A79D4E44B913(*iParam0, Local_54, 1f, -1, 2f, false, 40000f);
					}
				}
				iParam0->f_1 = unk_0x9CD27B0045628463();
				iParam0->f_6 = 23;
		...
		case 18:
			if (!func_184(*iParam0, -2017877118))
			{
				...
				if (func_170(unk_0x3FEF770D40960D5A(*iParam0, true), unk_0x3FEF770D40960D5A(unk_0xD80958FC74E988A6(), true)) > 1.5f)
				{
		...
		case 1:
			if (!unk_0xA3EE4A07279BB9DB(*iParam0, iLocal_43, false))
			{
				func_168(iParam0);
			}
			break;
		...
		case 6:
			...
			{
				if (!func_157(*iParam0, unk_0xD80958FC74E988A6(), 15f, 1))
				{
					func_7(&(iParam0->f_4));
					iParam0->f_6 = 7;
					iParam0->f_1 = unk_0x9CD27B0045628463();
		...
		case 7:
			if (unk_0xA3EE4A07279BB9DB(*iParam0, iLocal_43, true))
			{
				...
				if (!func_157(*iParam0, unk_0xD80958FC74E988A6(), 120f, 1))
				{
					func_5(iParam0, 1, 0, 1);
				}
			}
		...
		case 9:
			...
			if ((unk_0x9CD27B0045628463() - iParam0->f_1) > iParam0->f_2 || !func_184(*iParam0, 2104565373))
			{
				func_163(iParam0);
			}
			break;
		...
		case 16:
			...
			if ((unk_0x9CD27B0045628463() - iLocal_55) >= 9000)
			{
				if (!func_161(iParam0))
				{
					func_163(iParam0);
			...
			else if ((unk_0x9CD27B0045628463() - iLocal_55) >= 5000 && (unk_0x9CD27B0045628463() - iLocal_55) <= 5500)
			{
				if (unk_0x997ABD671D25CA0B(*iParam0, false))
				{
		...
		case 20:
			...
			{
				if (!unk_0x51210CED3DA1C78A(*iParam0, unk_0x1899F328B0E12848(iLocal_43, 5f, 0f, -2f), unk_0x3FEF770D40960D5A(iLocal_43, true) + Vector(2f, 0f, 0f), 9f, false, true, 0))
				{
					func_163(iParam0);
				}
				else
...
int func_159(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_160(Param1 - unk_0x3FEF770D40960D5A(iParam0, true)) };
	...
	{
		Var1 = { func_160(unk_0x17C07FC640E86B4E(iParam0, 31086, 0f, 5f, 0f) - unk_0x17C07FC640E86B4E(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
{
	if (unk_0x51210CED3DA1C78A(unk_0xD80958FC74E988A6(), unk_0x1899F328B0E12848(iLocal_43, 0f, 10f, -2f), unk_0x1899F328B0E12848(iLocal_43, 0f, 3f, 2f), 5f, false, true, 0) && unk_0x530944F6F4B8A214(*iParam0))
	{
		return 1;
	}
	return 0;
...
{
	unk_0xBF25EB89375A37AD(2, iLocal_40, joaat("player"));
	switch (iParam0->f_8)
	{
		case 4:
			break;
		...
		case 3:
			if (!func_184(*iParam0, 242628503))
			{
				...
				if (!unk_0xA3EE4A07279BB9DB(*iParam0, iLocal_43, false))
				{
					if (iParam0->f_10 == 0)
					{
						unk_0x15D3A79D4E44B913(*iParam0, unk_0x1899F328B0E12848(iLocal_43, func_137(1)), 1f, -1, 0.25f, false, 40000f);
						iParam0->f_7 = 1;
					}
					else
					{
						unk_0x15D3A79D4E44B913(*iParam0, unk_0x1899F328B0E12848(iLocal_43, func_137(0)), 1f, -1, 0.25f, false, 40000f);
						iParam0->f_7 = 1;
					}
				}
			}
		...
		case 9:
			...
			else if (!unk_0xA3EE4A07279BB9DB(*iParam0, iLocal_43, false))
			{
				if (iParam0->f_10 == 0)
				{
					unk_0x15D3A79D4E44B913(*iParam0, unk_0x1899F328B0E12848(iLocal_43, func_137(1)), 1f, -1, 0.25f, false, 40000f);
...
void func_164(var uParam0)
{
	if (!func_184(*uParam0, -71340211))
	{
		if (Local_46[iLocal_48 /*25*/].f_23 != 0)
		{
			if (func_10(Local_46[iLocal_48 /*25*/].f_17))
			{
				unk_0xE39B4FF4FDEBDE27(*uParam0, Local_46[iLocal_48 /*25*/].f_17, -1, 0f, 180f, 1f, 0);
			}
		}
		else
		{
			unk_0x15D3A79D4E44B913(*uParam0, Local_46[iLocal_48 /*25*/].f_19, 1f, 20000, -1f, false, func_165(Local_46[iLocal_48 /*25*/].f_19, unk_0x3FEF770D40960D5A(*uParam0, true), 1));
		}
		if (func_37(iLocal_43))
		{
			unk_0x7C65DAC73C35C862(iLocal_43, 5, false, false);
		}
...
int func_166()
{
	if (func_37(iLocal_43) && func_343(unk_0xD80958FC74E988A6()))
	{
		if (unk_0xC86D67D52A707CF8(iLocal_43, unk_0xD80958FC74E988A6(), true))
		{
			unk_0xA72CD9CA74A5ECBA(iLocal_43);
			if (func_167() || unk_0xEEF059FAD016D209(iLocal_43) < 851)
			{
				return 1;
			}
		}
...
int func_167()
{
	...
	while (bVar0 <= 5)
	{
		if (unk_0xBA291848A0815CA9(iLocal_43, bVar0, false))
		{
			iVar1++;
		}
		bVar0++;
...
{
	if (func_37(iLocal_43) && (unk_0xA3EE4A07279BB9DB(unk_0xD80958FC74E988A6(), iLocal_43, false) && !unk_0xA3EE4A07279BB9DB(*iParam0, iLocal_43, false)))
	{
		if (unk_0xD5037BA82E12416F(iLocal_43) > 0f)
		{
			iParam0->f_1 = unk_0x9CD27B0045628463();
...
int func_174(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xD38744167B2FA257(iVar0, func_175(unk_0x10FAB35428CCC9D7(), 1f, 1f));
		if (!bParam2)
		{
			unk_0x6F6F290102C02AB4(iVar0, bParam1);
		}
	...
	{
		unk_0xD38744167B2FA257(iVar0, func_175(unk_0x10FAB35428CCC9D7(), 0.7f, 0.7f));
		unk_0x6F6F290102C02AB4(iVar0, bParam1);
	}
...
void func_176(int* iParam0, int iParam1)
{
	...
	{
		if (!func_157(unk_0xD80958FC74E988A6(), *iParam0, 10f, 1))
		{
...
int func_181(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_160(unk_0x3FEF770D40960D5A(iParam1, true) - unk_0x3FEF770D40960D5A(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_185(var uParam0)
{
	...
	{
		case 1:
			if (unk_0xA3EE4A07279BB9DB(unk_0xD80958FC74E988A6(), iLocal_43, true))
			{
				func_176(uParam0, 0);
				return;
			}
		...
		case 2:
			if (unk_0xA808AA1D79230FC2(*uParam0, iLocal_43))
			{
			...
			else if (unk_0xA3EE4A07279BB9DB(unk_0xD80958FC74E988A6(), iLocal_43, true))
			{
				func_176(uParam0, 0);
				return;
			}
			...
			if (bLocal_51)
			{
				if (iLocal_48 <= 20 && iLocal_48 != -1)
				{
					if (!Local_46[iLocal_48 /*25*/].f_18)
					{
						...
						{
							if (Local_46[iLocal_48 /*25*/].f_9 && unk_0x5721B434AD84D57A(iLocal_43))
							{
								func_195();
							}
						}
		...
		case 5:
			if (func_37(iLocal_43))
			{
				unk_0x260BE8F09E326A20(iLocal_43, 25f, 10, false);
				fVar0 = unk_0xD5037BA82E12416F(iLocal_43);
				if (fVar0 < 8f)
				{
					func_194(uParam0);
				}
		...
		case 6:
			if (!func_184(*uParam0, 242628503) && unk_0x5721B434AD84D57A(iLocal_43))
			{
				if (bLocal_51)
				{
					uParam0->f_8 = uParam0->f_7;
		...
		case 7:
			...
			{
				if (unk_0xA3EE4A07279BB9DB(Local_45[1 /*11*/], iLocal_43, false) && Local_45[1 /*11*/].f_7 == 3)
				{
					func_130(0);
				}
			}
		...
		case 8:
			if (!unk_0xA3EE4A07279BB9DB(*uParam0, iLocal_43, false))
			{
				func_164(uParam0);
			}
			break;
...
void func_186(var uParam0)
{
	...
	switch (uParam0->f_9)
	{
		case 1:
			...
			{
				unk_0xE8854A4326B9E12B(&iVar0);
				if (func_170(unk_0x3FEF770D40960D5A(*uParam0, true), Local_46[iLocal_48 /*25*/].f_19) > 1.5f)
				{
					unk_0x1DDA930A0AC38571(0, Local_46[iLocal_48 /*25*/].f_19, 0);
				}
		...
		case 2:
			if (func_184(*uParam0, 242628503))
			{
				if (unk_0x1F0B79228E461EC9(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man", 3))
				{
					if (unk_0x346D81500D088F42(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man") >= 0.333f)
					{
						...
						if (func_10(Local_46[iLocal_48 /*25*/].f_17) && !unk_0xB346476EF1A64897(Local_46[iLocal_48 /*25*/].f_17))
						{
							unk_0x6B9BBD38AB0796DF(Local_46[iLocal_48 /*25*/].f_17, *uParam0, unk_0x3F428D08BE5AAE31(*uParam0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, true, true, false, false, 2, true, 0);
						}
					}
				}
			...
			else if (!func_184(*uParam0, 713668775))
			{
				if (func_37(iLocal_43))
				{
					unk_0x15D3A79D4E44B913(*uParam0, unk_0x1899F328B0E12848(iLocal_43, 0f, -4.8f, 0f), 1f, -1, 0.25f, false, unk_0xE83D4F9BA2A38914(iLocal_43));
				}
				uParam0->f_9 = 3;
			}
			unk_0x364DF566EC833DE2(*uParam0, 0.2f);
		...
		case 3:
			if (func_37(iLocal_43))
			{
				if (!func_191(unk_0x1899F328B0E12848(iLocal_43, 0f, -5.5f, 0f), iLocal_43, 1.9f, 1.9f, 8f))
				{
					if (unk_0x20B60995556D004F(*uParam0, unk_0x1899F328B0E12848(iLocal_43, 0f, -5.5f, 0f), 0.9f, 0.9f, 2f, false, true, 0))
					{
						if (!func_184(*uParam0, 713668775))
						{
							unk_0xE8854A4326B9E12B(&iVar1);
							if (func_170(unk_0x3FEF770D40960D5A(*uParam0, true), unk_0x3FEF770D40960D5A(iLocal_43, true)) > 3f)
							{
								unk_0x93B93A37987F1F3D(0, unk_0xE83D4F9BA2A38914(iLocal_43), 0);
							}
		...
		case 4:
			if (!func_191(unk_0x1899F328B0E12848(iLocal_43, 0f, -5.5f, 0f), *uParam0, 1.9f, 1.9f, 8f))
			{
				if (func_184(*uParam0, 242628503))
				{
						...
						if (unk_0x346D81500D088F42(*uParam0, "missfbi4prepp1", "_bag_throw_garbage_man") >= 0.391f)
						{
							if (func_10(Local_46[iLocal_48 /*25*/].f_17))
							{
								if (unk_0xB346476EF1A64897(Local_46[iLocal_48 /*25*/].f_17))
								{
									...
									unk_0x97B0DB5B4AA74E77(*uParam0);
									unk_0x961AC54BF0613F5D(Local_46[iLocal_48 /*25*/].f_17, true, false);
									unk_0xF6DF6E90DE7DF90F(Local_46[iLocal_48 /*25*/].f_17, 2f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f);
									unk_0x18FF00FC7EFF559E(Local_46[iLocal_48 /*25*/].f_17, 1, unk_0x0A794A5A57F8DF91(*uParam0), false, true, true, false);
								}
								if (unk_0x17FFC1B2BA35A494(Local_46[iLocal_48 /*25*/].f_17, iLocal_43))
								{
				...
				else
				{
					...
					if (func_37(iLocal_43))
					{
						unk_0x93D9BD300D7789E5(iLocal_43, 5, false);
						func_187(&(Local_46[iLocal_48 /*25*/].f_17));
					}
					func_163(uParam0);
				}
...
void func_188(var uParam0)
{
	...
	unk_0xBF25EB89375A37AD(5, iLocal_40, joaat("player"));
	func_169(uParam0);
	if (!unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false))
	{
...
int func_191(struct<3> Param0, int iParam1, struct<3> Param2)
{
	...
	if (Local_42.f_26)
	{
		if (unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false))
		{
			if (unk_0x6AC7003FA6E5575E(Local_42.f_18))
			{
				if (func_10(Local_42.f_18))
				{
					if (unk_0x4B53F92932ADFAC0(Local_42.f_18) == unk_0x9A9112A0FE9A4713(unk_0xD80958FC74E988A6(), true))
					{
						return 1;
					}
				}
		...
		else if (unk_0x524AC5ECEA15343E(Local_42.f_18))
		{
			if (func_10(Local_42.f_18))
			{
				if (unk_0x04A2A40C73395041(Local_42.f_18) == unk_0xD80958FC74E988A6())
				{
					return 1;
				}
			}
...
void func_194(var uParam0)
{
	...
	{
		unk_0xE8854A4326B9E12B(&iVar0);
		unk_0xE2A2AA2F659D77A7(0, iLocal_43, Local_46[iLocal_48 /*25*/].f_3, 8f, 0, joaat("trash"), 786469, 10f, 15f);
		unk_0x0F3E34E968EA374E(0, iLocal_43, Local_46[iLocal_48 /*25*/].f_3, Local_46[iLocal_48 /*25*/].f_8, Local_46[iLocal_48 /*25*/].f_10, 5f, true);
		unk_0x39E72BC99E6360CB(iVar0);
		unk_0x5ABA3986D90D8A3B(*uParam0, iVar0);
		unk_0x3841422E9C488D8C(&iVar0);
		uParam0->f_7 = 6;
...
void func_196(var uParam0, bool bParam1)
{
	...
	if (func_191(unk_0x1899F328B0E12848(iLocal_43, func_137(bParam1)), iLocal_43, 1.9f, 1.9f, 8f))
	{
		if (unk_0x51210CED3DA1C78A(*uParam0, unk_0x1899F328B0E12848(iLocal_43, 5f, 0f, -2f), unk_0x3FEF770D40960D5A(iLocal_43, true) + Vector(2f, 0f, 0f), 9f, false, true, 0) && unk_0x51210CED3DA1C78A(unk_0xD80958FC74E988A6(), unk_0x1899F328B0E12848(iLocal_43, 5f, 0f, -2f), unk_0x3FEF770D40960D5A(iLocal_43, true) + Vector(2f, 0f, 0f), 9f, false, true, 0))
		{
			func_197(uParam0);
		}
		else if (!func_184(*uParam0, 1227113341) && unk_0x51210CED3DA1C78A(unk_0xD80958FC74E988A6(), unk_0x1899F328B0E12848(iLocal_43, 5f, 0f, -2f), unk_0x3FEF770D40960D5A(iLocal_43, true) + Vector(2f, 0f, 0f), 9f, false, true, 0))
		{
			unk_0xE1EF3C1216AFF2CD(*uParam0);
			unk_0x6A071245EB0D1882(*uParam0, unk_0xD80958FC74E988A6(), -1, 4f, 1f, 2f, 0);
		}
	}
	else if (func_107(*uParam0, unk_0x1899F328B0E12848(iLocal_43, func_137(bParam1)), 5f, 1))
	{
		bVar0 = -1;
		if (!bParam1)
		{
		...
		unk_0xC20E50AA46D09CA8(*uParam0, iLocal_43, -1, bVar0, 1f, 8388609, 0);
		uParam0->f_7 = 2;
	}
}
...
void func_198(var uParam0)
{
	if (uParam0->f_5 != 1)
	{
		if (func_37(iLocal_43) && unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false))
		{
			if (!func_184(*uParam0, 2104565373) && unk_0xA3EE4A07279BB9DB(*uParam0, iLocal_43, false))
			{
				if (func_157(unk_0xD80958FC74E988A6(), iLocal_43, 10f, 1))
				{
					if (unk_0x17FFC1B2BA35A494(iLocal_43, unk_0xD80958FC74E988A6()))
					{
...
void func_199()
{
	...
	while (iVar0 <= (iLocal_41 - 1))
	{
		if (Local_46[iVar0 /*25*/].f_23 != 0)
		{
			...
			{
				if ((iVar0 != iLocal_48 && func_10(Local_46[iVar0 /*25*/].f_17)) && func_201(Local_46[iVar0 /*25*/].f_17, unk_0xD80958FC74E988A6(), 1) > 200f)
				{
					unk_0x539E0AE3E6634B9F(&(Local_46[iVar0 /*25*/].f_17));
					Local_46[iVar0 /*25*/].f_24 = 0;
				}
			}
			else if (Local_46[iVar0 /*25*/].f_23 != 0)
			{
				if (func_107(unk_0xD80958FC74E988A6(), Local_46[iVar0 /*25*/], 100f, 1) || func_107(Local_45[0 /*11*/], Local_46[iVar0 /*25*/], 120f, 1))
				{
...
int func_200(var uParam0, bool bParam1, struct<3> Param2, float fParam3, bool bParam4)
{
...
void func_202(int* iParam0, int iParam1, int iParam2)
{
	if (iParam0->f_5 != 1 || iParam2)
	{
		if (!func_343(Local_45[func_171(iParam1) /*11*/]))
		{
			if (!bLocal_52)
			{
				if (unk_0x7239B21A38F536BA(Local_45[func_171(iParam1) /*11*/]))
				{
					...
					{
						Local_54 = { unk_0x3FEF770D40960D5A(Local_45[func_171(iParam1) /*11*/], true) };
						iParam0->f_1 = unk_0x9CD27B0045628463();
						iParam0->f_8 = iParam0->f_7;
						iParam0->f_5 = 1;
						iParam0->f_6 = 11;
		...
		{
			if (func_181(*iParam0, Local_45[func_171(iParam1) /*11*/], 140f, 0) && func_157(Local_45[func_171(iParam1) /*11*/], unk_0xD80958FC74E988A6(), 15f, 1))
			{
				iParam0->f_5 = 1;
				iParam0->f_6 = 21;
			}
		...
		if (iParam0->f_10 == 0 && iParam0->f_7 == 4)
		{
			if (func_161(iParam0))
			{
				if (unk_0xA3EE4A07279BB9DB(*iParam0, iLocal_43, false))
				{
					...
					unk_0x9D3AF56E94C9AE98(iLocal_43, 2000f);
		...
		if (func_204(*iParam0, 1, 70f, 170f, 0, 1, 0, 0) && !func_203(iParam0))
		{
			if (unk_0x475768A975D5AD17(unk_0xD80958FC74E988A6(), 6))
			{
				if (func_37(iLocal_43))
				{
					if (unk_0xA3EE4A07279BB9DB(*iParam0, iLocal_43, false))
					{
						if (unk_0xD5037BA82E12416F(iLocal_43) > 5f)
						{
							if (iParam1 == 0)
							{
								unk_0x9454528DF15D657A(*iParam0, iLocal_43, unk_0xD80958FC74E988A6(), 8, 30f, 786469, 300f, 2f, true);
								iParam0->f_6 = 7;
								unk_0x3EB1FE9E8E908E15(Local_45[func_171(iParam1) /*11*/], -1);
								Local_45[func_171(iParam1) /*11*/].f_6 = 10;
								Local_45[func_171(iParam1) /*11*/].f_5 = 1;
								iParam0->f_5 = 1;
								iParam0->f_1 = unk_0x9CD27B0045628463();
								Local_45[func_171(iParam1) /*11*/].f_1 = unk_0x9CD27B0045628463();
							}
							else
							{
								unk_0x3EB1FE9E8E908E15(*iParam0, -1);
								iParam0->f_6 = 12;
								unk_0x9454528DF15D657A(Local_45[func_171(iParam1) /*11*/], iLocal_43, unk_0xD80958FC74E988A6(), 8, 30f, 786469, 300f, 2f, true);
						...
						else
						{
							...
							if (unk_0x7239B21A38F536BA(Local_45[func_171(iParam1) /*11*/]))
							{
								if (func_181(Local_45[func_171(iParam1) /*11*/], unk_0xD80958FC74E988A6(), 1126825984, 0))
								{
			...
			else
			{
				...
				if (func_177(Local_45[func_171(iParam1) /*11*/], *iParam0, 1126825984, 1, 250, 7))
				{
					...
					unk_0xA72CD9CA74A5ECBA(Local_45[func_171(iParam1) /*11*/]);
				}
			}
			iParam0->f_5 = 1;
		}
	...
	if (iParam0->f_5 != 1)
	{
		if (func_343(Local_45[func_171(iParam1) /*11*/]))
		{
			if (unk_0x9A497FE2DF198913(Local_45[func_171(iParam1) /*11*/]))
			{
				func_169(iParam0);
	...
	if (func_10(unk_0xD80958FC74E988A6()) && func_10(iParam0))
	{
		...
		if (!unk_0x475768A975D5AD17(unk_0xD80958FC74E988A6(), 6))
		{
			if (unk_0x4E209B2C1EAD5159(unk_0xD80958FC74E988A6()))
			{
				...
				{
					return func_208(unk_0xD80958FC74E988A6(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_205(int iParam0, float fParam1)
{
	...
	if (func_10(unk_0xD80958FC74E988A6()) && func_10(iParam0))
	{
		if (func_207(iParam0) || unk_0x7912F7FC4F6264B6(unk_0x4F8644AF03D0E0D6(), iParam0))
		{
			if (unk_0x475768A975D5AD17(unk_0xD80958FC74E988A6(), 6))
			{
				fVar0 = 40f;
...
{
	return func_177(iParam0, unk_0xD80958FC74E988A6(), fParam1, 1, 250, 7);
}
...
{
	if (func_157(iParam0, unk_0xD80958FC74E988A6(), 6f, 1))
	{
		if (!unk_0x997ABD671D25CA0B(iParam0, false))
		{
...
void func_214()
{
	if (func_37(Local_199.f_0))
	{
		if (func_157(unk_0xD80958FC74E988A6(), Local_199.f_0, 100f, 1) && !iLocal_194)
		{
		...
		else if (!func_157(unk_0xD80958FC74E988A6(), Local_199.f_0, 120f, 1) && iLocal_194)
		{
		...
		switch (*iParam2)
		{
			case 0:
				if (unk_0xA3EE4A07279BB9DB(unk_0xD80958FC74E988A6(), *iParam0, false))
				{
					...
					if (func_106(func_114(func_77()), 0, 0))
					{
						unk_0xCF708001E1E536DD(func_114(func_77()));
					}
					if (*iParam0 == iParam6)
					{
						*iParam2 = 1;
				...
				else
				{
					...
					{
						unk_0xCF708001E1E536DD(func_115(func_77(), bParam7));
					}
					if (func_77() != 33)
					{
						func_217(iParam0);
			...
			case 2:
			case 1:
				if ((!unk_0xA3EE4A07279BB9DB(unk_0xD80958FC74E988A6(), *iParam0, false) && !func_220(*iParam0)) && !func_219(*iParam0))
				{
					func_7(iParam4);
...
void func_217(int* iParam0)
{
	...
	if (unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false))
	{
		...
		if (iVar0 != *iParam0)
		{
			if (func_37(iVar0))
			{
				if (unk_0x9F47B058362C84B5(iVar0) == func_218(func_77()))
				{
					func_6(iParam0);
					*iParam0 = iVar0;
					func_36(*iParam0, 1);
...
int func_219(int iParam0)
{
	...
	if ((func_343(unk_0xD80958FC74E988A6()) && unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false)) && func_37(iParam0))
	{
...
void func_221()
{
	...
	switch (iLocal_69)
	{
		case 0:
			if (func_122(iLocal_68, bLocal_28))
			{
				if (unk_0xE28E54788CE8F12D(unk_0x4F8644AF03D0E0D6()) == 0 && !func_237())
				{
		...
		case 3:
			if (func_37(iLocal_200))
			{
				if (!unk_0xA3EE4A07279BB9DB(unk_0xD80958FC74E988A6(), iLocal_200, false))
				{
					unk_0xF75B0D629E1C063D(unk_0xD80958FC74E988A6(), iLocal_200, -1);
				}
				else
				{
	...
	while (iVar0 < 3)
	{
		...
		if (!unk_0x84A2DD9AC37C35C1(iVar2))
		{
			if (func_78(iVar2, 0))
			{
				if (!bVar1)
				{
					if (func_157(unk_0xD80958FC74E988A6(), iVar2, 5f, 1))
					{
						if (!func_237())
						{
							func_232(iVar0);
			...
			else if (unk_0xDDE6DF5AE89981D2(iVar2, true))
			{
				if (func_231(iVar2))
				{
					if (unk_0x77F1BEB8863288D5(iVar2, -1273030092) != 1 && unk_0x77F1BEB8863288D5(iVar2, -1273030092) != 0)
					{
						...
						{
							unk_0xE2A2AA2F659D77A7(iVar2, unk_0x9A9112A0FE9A4713(iVar2, false), Local_186, 20f, 0, false, 34340901, 2f, 10f);
						}
						else
						{
				...
				else if (func_229(iVar2))
				{
					if (func_37(Local_199.f_0))
					{
						if (!func_157(iVar2, Local_199.f_0, 17f, 1))
						{
							if (unk_0x77F1BEB8863288D5(iVar2, -1273030092) != 1 && unk_0x77F1BEB8863288D5(iVar2, -1273030092) != 0)
							{
								unk_0x659427E0EF36BCDE(iVar2, unk_0x9A9112A0FE9A4713(iVar2, false), Local_199.f_0, 3, 20f, 786468, 2f, 0.5f, true);
							}
						}
					}
				}
	...
	if (!func_230())
	{
		if ((!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()) && unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false)) && unk_0xE28E54788CE8F12D(unk_0x4F8644AF03D0E0D6()) == 0)
		{
			...
			if (func_37(iVar0))
			{
				...
				if (unk_0xA3EE4A07279BB9DB(iParam0, iVar0, false) && unk_0xBB40DD2270B65366(iVar0, -1, false) == iParam0)
				{
					return 1;
				}
			}
...
int func_231(int iParam0)
{
	if (!func_230())
	{
		if ((unk_0x7239B21A38F536BA(Local_199.f_0) && unk_0x4C241E39B23DF959(Local_199.f_0, false)) && !unk_0x20B60995556D004F(Local_199.f_0, Local_186, 2f, 2f, 2f, false, true, 0))
		{
			if ((!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()) && unk_0xA3EE4A07279BB9DB(unk_0xD80958FC74E988A6(), Local_199.f_0, false)) && unk_0xE28E54788CE8F12D(unk_0x4F8644AF03D0E0D6()) == 0)
			{
				if (unk_0xA3EE4A07279BB9DB(iParam0, Local_199.f_0, false) && unk_0xBB40DD2270B65366(Local_199.f_0, -1, false) == iParam0)
				{
					return 1;
				}
			}
		...
		if (iLocal_70 > 0)
		{
			if (!BitTest(Local_73[iParam0 /*8*/].f_7, 0) && iLocal_71 == 1)
			{
				if (!unk_0x7984C03AA5CC2F41())
				{
					...
					{
						unk_0x933D6A9EEC1BACD0(&(Local_73[iParam0 /*8*/].f_7), false);
					}
				}
			}
		}
		else
		{
			if ((BitTest(Local_73[iParam0 /*8*/].f_7, 0) && !BitTest(Local_73[iParam0 /*8*/].f_7, 1)) && iLocal_71 == 1)
			{
				if (!unk_0x7984C03AA5CC2F41())
				{
					...
					{
						unk_0x933D6A9EEC1BACD0(&(Local_73[iParam0 /*8*/].f_7), true);
					}
				}
			}
			if (!BitTest(Local_73[iParam0 /*8*/].f_7, 5))
			{
				if (func_235(iLocal_200, Local_186, 1) < 15f && iLocal_71 == 1)
				{
					if (!unk_0x7984C03AA5CC2F41())
					{
						...
						{
							unk_0x933D6A9EEC1BACD0(&(Local_73[iParam0 /*8*/].f_7), 5);
						}
					}
				}
			}
	...
	if (!BitTest(Local_73[iParam0 /*8*/].f_7, bParam1))
	{
		if (iLocal_375 != -1)
		{
			if (!unk_0x7984C03AA5CC2F41())
			{
				...
				{
					unk_0x933D6A9EEC1BACD0(&(Local_73[iParam0 /*8*/].f_7), bParam1);
				}
			}
		}
		else if (!func_237() && !unk_0x7984C03AA5CC2F41())
		{
...
void func_238()
{
	if (func_107(unk_0xD80958FC74E988A6(), Local_186, 220f, 1))
	{
		if (!iLocal_203 && !func_107(unk_0xD80958FC74E988A6(), Local_186, 100f, 1))
		{
			iLocal_203 = func_153(&iLocal_202, joaat("cavalcade2"), 1370.912f, -2060.055f, 50.9983f, 312.8686f, 1);
		}
	}
	else if (func_107(unk_0xD80958FC74E988A6(), Local_186, 240f, 1))
	{
		if (iLocal_203)
		{
			func_6(&iLocal_202);
...
void func_239()
{
	...
	switch (iLocal_69)
	{
		...
		case 1:
			...
			if (!bLocal_190)
			{
				if (func_343(Local_197.f_0) && unk_0x9A497FE2DF198913(Local_197.f_0))
				{
					func_241();
				}
				if (func_343(Local_198.f_0) && unk_0x9A497FE2DF198913(Local_198.f_0))
				{
					func_241();
				}
			}
...
void func_245(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_268(iParam1) && unk_0x47D6F43D77935C75(iParam1))
	{
		iVar1 = 0;
...
int func_250(char* sParam0)
{
	if (!func_251(1, 1, 0))
	{
		if ((!unk_0xCA042B6957743895(sParam0) && func_146(sParam0)) || func_146("CMN_HINT"))
		{
			unk_0x8DFCED7A656F8802(true);
		}
		return 0;
...
int func_251(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_258() || func_257(Global_4718592.f_168757)) || func_256())
	{
		...
		{
			iVar0 = unk_0x9A9112A0FE9A4713(unk_0xD80958FC74E988A6(), false);
			bVar1 = func_255(unk_0xD80958FC74E988A6(), 0);
			if (((unk_0xE33FFA906CE74880(iVar0, bVar1) || (unk_0x9F47B058362C84B5(iVar0) == joaat("apc") && bVar1 != -1)) || (unk_0x9F47B058362C84B5(iVar0) == joaat("akula") && bVar1 != -1)) || (((unk_0x9F47B058362C84B5(iVar0) == joaat("riot2") && bVar1 == 0) && func_254(iVar0, 10)) && unk_0x772960298DA26FDB(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_252(bool bParam0)
{
	if (bParam0 != func_88())
	{
		...
		else if ((Global_1575058 && bParam0 == unk_0x4F8644AF03D0E0D6()) && func_253(bParam0, 1, 0))
		{
			return Global_2689235[bParam0 /*453*/].f_318.f_6 != -1;
		}
	}
		...
		case 0:
			if (func_122(iLocal_68, 0))
			{
				...
				else
				{
					if (func_33(0))
					{
						func_124(unk_0xD80958FC74E988A6(), 1228.635f, -348.4277f, 68.0929f, 86.7244f);
...
void func_284()
{
	...
	if (unk_0x7239B21A38F536BA(iVar0))
	{
		if (unk_0x4C241E39B23DF959(iVar0, false))
		{
			func_285(iVar0, unk_0x3FEF770D40960D5A(iVar0, true), unk_0xE83D4F9BA2A38914(iVar0), 24, 0);
		}
	}
}
...
{
	if ((((((((((!unk_0x7239B21A38F536BA(iParam0) || !unk_0x4C241E39B23DF959(iParam0, false)) || func_305(iParam0, 0, 0)) || func_305(iParam0, 1, 0)) || func_305(iParam0, 2, 0)) || func_328(iParam0) != 145) || func_304(iParam0)) || func_303(iParam0)) || func_302(iParam0)) || func_301(iParam0)) || !func_289(unk_0x9F47B058362C84B5(iParam0)))
	{
		if (func_303(iParam0))
		{
		}
...
int func_290(bool bParam0, bool bParam1)
{
	...
	{
		if ((func_295() || unk_0x48AF36444B965238()) || func_294())
		{
		}
		else if (!func_297())
		{
	...
	if (unk_0x4C241E39B23DF959(iParam0, false))
	{
		...
		*uParam1 = unk_0xF11BC2DD9A3E7195(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x933D6A9EEC1BACD0(&(uParam1->f_77), func_330(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_340()
{
	...
	if (!func_37(iLocal_200))
	{
		...
		if (func_37(Local_199.f_0) && !func_157(unk_0xD80958FC74E988A6(), Local_199.f_0, fVar0, 1))
		{
			func_342(2);
		}
	}
	...
	{
		iVar1 = 0;
		if (!func_157(unk_0xD80958FC74E988A6(), iLocal_200, fVar0, 1))
		{
			iVar1++;
		}
		if (func_37(iLocal_201))
		{
			if (!func_157(unk_0xD80958FC74E988A6(), iLocal_201, fVar0, 1))
			{
				iVar1++;
			}
		}
		...
		if (func_37(Local_199.f_0))
		{
			if (!func_157(unk_0xD80958FC74E988A6(), Local_199.f_0, fVar0, 1))
			{
				iVar1++;
			}
		}
...
void func_347(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (unk_0x10FAB35428CCC9D7())
	{
		if (func_352() == 0)
		{
			bVar0 = func_350(func_351(iParam0), -1, 0);
			unk_0xE80492A9AC099A93(&bVar0, bParam1);
			func_348(func_351(iParam0), bVar0, -1, 1, 0);
		}
	}
	else
	{
...
void func_378(bool bParam0)
{
	...
	if (bParam0)
	{
		if (unk_0x7239B21A38F536BA(iLocal_200))
		{
			if (unk_0x7239B21A38F536BA(unk_0xD80958FC74E988A6()))
			{
				if (!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()))
	...
	func_145(&uLocal_56, 0, 0);
	if (unk_0xA7A932170592B50E(iLocal_184))
	{
		unk_0x07E5B515DB0636FC(false, false, 3000, true, false, 0);
		unk_0x865908C81A2C22E9(iLocal_184, false);
	}
}
...
void func_385()
{
	unk_0xE532F5D78798DAAB(Local_199.f_5);
}
