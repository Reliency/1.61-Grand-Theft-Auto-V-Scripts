...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (((!unk_0x20B60995556D004F(unk_0xD80958FC74E988A6(), -1645.555f, -1123.872f, 17.3436f, 300f, 300f, 300f, false, true, 0) || func_179()) || unk_0x05095437424397FA()) || (func_174() && !func_172()))
		{
			Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/] = 3;
		}
		func_160();
		if (BitTest(uLocal_369, 3))
		{
			...
			{
				unk_0xE80492A9AC099A93(&uLocal_369, 3);
			}
		}
		switch (func_159(unk_0x57A3BDDAD8E5AA0A()))
		{
			case 0:
				if (func_158() > 0)
				{
					Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/] = 1;
				}
				break;
			...
			case 1:
				if (func_158() > 1)
				{
					if (func_153())
					{
						Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/] = 2;
					}
				}
				break;
			...
			case 3:
				...
				if (((func_20(&uLocal_1082, 3000, 0) || func_19()) || func_18()) || func_14(unk_0x4F8644AF03D0E0D6()))
				{
					func_188();
				}
				break;
...
void func_1()
{
	...
	if (unk_0x6FF8FF40B6357D45(unk_0x9EC6603812C24710(iLocal_354)))
	{
		bVar1 = unk_0x24FB80D107371267(unk_0x9EC6603812C24710(bLocal_354));
		switch (Local_1084.f_0)
		{
			case 0:
				if (BitTest(Local_1086[bLocal_354 /*5*/].f_2, 4) && !BitTest(Local_1084.f_3[bLocal_354], 1))
				{
					unk_0xE80492A9AC099A93(&(Local_1084.f_2), false);
					unk_0xE80492A9AC099A93(&(Local_1084.f_3[bLocal_354]), false);
					unk_0x933D6A9EEC1BACD0(&(Local_1084.f_2), 2);
					iLocal_372 = 30000;
					Local_1084.f_0 = 1;
					func_5(&uLocal_370);
					unk_0x933D6A9EEC1BACD0(&(Local_1084.f_3[bLocal_354]), true);
				}
				if (BitTest(Local_1086[bLocal_354 /*5*/].f_2, 3) && !BitTest(Local_1084.f_3[bLocal_354], 0))
				{
					iVar0 = func_4(bLocal_354);
					if (iVar0 == -1)
					{
					}
					else
					{
						Local_1084.f_197[bLocal_354 /*2*/].f_1 = bVar1;
						Local_1084.f_197[bLocal_354 /*2*/] = iVar0;
						Local_1084.f_262 = func_2();
						unk_0x933D6A9EEC1BACD0(&(Local_1084.f_2), false);
						unk_0x933D6A9EEC1BACD0(&(Local_1084.f_3[bLocal_354]), false);
					}
				}
				break;
			
			case 1:
				if (BitTest(Local_1084.f_3[bLocal_354], 1))
				{
					unk_0xE80492A9AC099A93(&(Local_1084.f_3[bLocal_354]), true);
				}
				break;
		}
	}
	else if ((Local_1084.f_3[bLocal_354] != 0 || Local_1084.f_197[bLocal_354 /*2*/] != -1) || Local_1084.f_197[bLocal_354 /*2*/].f_1 != 0)
	{
		Local_1084.f_3[bLocal_354] = 0;
		Local_1084.f_197[bLocal_354 /*2*/] = -1;
		Local_1084.f_197[bLocal_354 /*2*/].f_1 = 0;
		Local_1084.f_262 = func_2();
	}
	bLocal_354++;
	if (bLocal_354 == unk_0xA6C90FBC38E395EE())
	{
		bLocal_354 = false;
	}
}
...
int func_4(bool bParam0)
{
	...
	while (iVar1 < 2)
	{
		if (BitTest(Local_1086[bParam0 /*5*/].f_2, 0))
		{
			return Local_1086[bParam0 /*5*/].f_3;
		}
		else
		{
			iVar0 = 0;
	...
	switch (Local_1084.f_0)
	{
		...
		case 1:
				...
				if (func_9())
				{
					if (Local_1084.f_262 != -1)
					{
						...
						while (iVar0 < 32)
						{
							...
							{
								unk_0xE80492A9AC099A93(&(Local_1084.f_3[iVar0]), false);
								unk_0xE80492A9AC099A93(&(Local_1084.f_3[iVar0]), true);
					...
					unk_0xE80492A9AC099A93(&(Local_1084.f_2), 3);
					unk_0xE80492A9AC099A93(&(Local_1084.f_2), 4);
					Local_1084.f_0 = 0;
				}
				else
				{
			...
			else
			{
				...
				{
					unk_0x933D6A9EEC1BACD0(&(Local_1084.f_2), 4);
				}
				if ((30000 - func_7(&uLocal_370, 0, 0)) < 3000)
				{
					unk_0x933D6A9EEC1BACD0(&(Local_1084.f_2), 3);
				}
				if (((Local_1084.f_262 != -1 && !BitTest(Local_1086[Local_1084.f_262 /*5*/].f_2, 6)) && unk_0x20B60995556D004F(unk_0x43A66C31C68491C0(Local_1084.f_197[Local_1084.f_262 /*2*/].f_1), -1661.95f, -1127.011f, 12.6973f, 1f, 1f, 2f, false, true, 0)) && BitTest(Local_1084.f_2, 2))
				{
					if (!BitTest(Local_1084.f_2, 1))
					{
						unk_0x933D6A9EEC1BACD0(&(Local_1084.f_2), true);
					}
				}
				else if (BitTest(Local_1084.f_2, 1))
				{
					unk_0xE80492A9AC099A93(&(Local_1084.f_2), true);
				}
			}
			break;
	}
...
int func_9()
{
	...
	while (bVar0 >= 0)
	{
		...
		{
			if (BitTest(Local_1086[bVar0 /*5*/].f_2, 9) || BitTest(Local_1086[bVar0 /*5*/].f_2, 10))
			{
				return 0;
			}
		}
...
int func_12()
{
	...
	while (bVar0 < 32)
	{
		...
		{
			if (unk_0x20B60995556D004F(unk_0x43A66C31C68491C0(bVar1), -1662.01f, -1126.869f, 12.6973f, 500f, 500f, 500f, false, true, 0))
			{
				return 1;
			}
		}
...
void func_31()
{
	switch (Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_1)
	{
		case 0:
			if (Local_1084.f_0 == 1)
			{
				unk_0x8DFCED7A656F8802(true);
				unk_0xE80492A9AC099A93(&uLocal_369, true);
				unk_0xE80492A9AC099A93(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 4);
				iLocal_355 = 0;
				Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_1 = 1;
			}
			else
			{
				...
				if (BitTest(Local_1084.f_3[unk_0x57A3BDDAD8E5AA0A()], 0))
				{
					Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_3 = Local_1084.f_197[unk_0x57A3BDDAD8E5AA0A() /*2*/];
					if (Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_3 != -1)
					{
						if (Global_2822699 != Local_1084.f_36[Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_3 /*10*/].f_6)
						{
							if (BitTest(uLocal_369, 0))
							{
								unk_0x8DFCED7A656F8802(true);
								unk_0xE80492A9AC099A93(&uLocal_369, false);
							}
							if (!BitTest(uLocal_369, 1))
							{
								if (BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 0))
								{
								...
								unk_0x933D6A9EEC1BACD0(&uLocal_369, true);
							}
						}
						else if (!BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 4))
						{
							unk_0x933D6A9EEC1BACD0(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 4);
							unk_0xE80492A9AC099A93(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 3);
							iLocal_379 = 1;
						}
					}
					else
				...
				else if (!BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 8))
				{
					if (((((((!func_147(0) && !func_143(unk_0x4F8644AF03D0E0D6())) && !func_142(unk_0x4F8644AF03D0E0D6(), 21)) && !unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), true)) && !unk_0x238DB2A2C23EE9EF(unk_0x4F8644AF03D0E0D6(), 0)) && unk_0xF73EB622C4F1689B(-1661.95f, -1127.011f, 12.6973f, 1f, 0, 6) == 0) && !func_141(unk_0xD80958FC74E988A6())) && !func_140(unk_0x4F8644AF03D0E0D6()))
					{
						if (!func_137())
						{
							if (!BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 0))
							{
								if (unk_0x20B60995556D004F(unk_0xD80958FC74E988A6(), -1661.95f, -1127.011f, 12.6973f, 1f, 1f, 2f, false, true, 0))
								{
									...
									unk_0x933D6A9EEC1BACD0(&uLocal_369, false);
									if (unk_0x580417101DDB492F(2, 51))
									{
										func_117();
										unk_0x933D6A9EEC1BACD0(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 3);
									}
								}
		...
		case 1:
			if (Local_1084.f_0 == 0)
			{
				if (BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 5) || BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 7))
				{
					func_83();
					func_81(25);
				}
				if (!BitTest(Local_1084.f_3[unk_0x57A3BDDAD8E5AA0A()], 0))
				{
					unk_0xE80492A9AC099A93(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 8);
				}
				unk_0x8DFCED7A656F8802(true);
				unk_0xE80492A9AC099A93(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 7);
				unk_0xE80492A9AC099A93(&uLocal_369, 2);
				unk_0xE80492A9AC099A93(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 11);
				unk_0xE80492A9AC099A93(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 6);
				Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_1 = 0;
				if (BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 0))
				{
					func_91();
				}
			...
			else
			{
				if (BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 0))
				{
					if ((Local_1084.f_262 != -1 && Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_3 != -1) && Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_3 == Local_1084.f_197[Local_1084.f_262 /*2*/])
					{
						if (!BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 7))
						{
							...
							unk_0x933D6A9EEC1BACD0(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 7);
						}
				...
				else if (((((((!func_147(0) && !func_143(unk_0x4F8644AF03D0E0D6())) && !func_142(unk_0x4F8644AF03D0E0D6(), 21)) && !unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), true)) && !unk_0x238DB2A2C23EE9EF(unk_0x4F8644AF03D0E0D6(), 0)) && unk_0xF73EB622C4F1689B(-1661.95f, -1127.011f, 12.6973f, 1f, 0, 6) == 0) && !func_76()) && !Global_1574582.f_6)
				{
					if (!func_137())
					{
						if (BitTest(Local_1084.f_2, 1))
						{
							if (Local_1084.f_197[Local_1084.f_262 /*2*/].f_1 == unk_0x4F8644AF03D0E0D6())
							{
								if (!BitTest(Local_1084.f_2, 3))
								{
									if (!BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 11))
									{
										func_77(func_78(1));
										unk_0x933D6A9EEC1BACD0(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 11);
									}
								}
							}
						}
						...
						{
							if ((!BitTest(Local_1084.f_2, 3) && !BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 9)) && Local_1084.f_262 != -1)
							{
								if (!Local_1084.f_36[Local_1084.f_197[Local_1084.f_262 /*2*/] /*10*/].f_3 >= 2)
								{
									if (BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 8))
									{
								...
								else if (!BitTest(uLocal_369, 2))
								{
									...
									unk_0x933D6A9EEC1BACD0(&uLocal_369, 2);
								}
							}
						}
					}
				...
				if (Local_1084.f_262 != -1)
				{
					if (BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 9))
					{
						func_67();
					}
					if (BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 10))
					{
						func_39();
					}
				}
...
void func_32()
{
	...
	if (unk_0x61E1DD6125A3EEE6(-1666.711f, -1127.518f, 12.6973f, 3f) && (unk_0x20B60995556D004F(unk_0xD80958FC74E988A6(), -1666.711f, -1127.518f, 12.6973f, 0.5f, 0.5f, 1f, false, true, 0) || unk_0x20B60995556D004F(unk_0xD80958FC74E988A6(), -1666.383f, -1126.286f, 12.6973f, 0.5f, 0.5f, 1f, false, true, 0)))
	{
		if (!BitTest(uLocal_369, 5))
		{
			...
			{
				func_5(&uLocal_373);
				unk_0x933D6A9EEC1BACD0(&uLocal_369, 5);
			}
		}
		else if (func_20(&uLocal_373, 2000, 0))
		{
			if (((unk_0xDE4C184B2B9B071A(unk_0xD80958FC74E988A6()) || unk_0xC5286FFC176F28A2(unk_0xD80958FC74E988A6())) || unk_0x57E457CD2C0FC168(unk_0xD80958FC74E988A6())) || unk_0xE45B7F222DE47E09(unk_0xD80958FC74E988A6()))
			{
				...
				unk_0xE80492A9AC099A93(&uLocal_369, 5);
			}
		}
	}
}
...
void func_39()
{
	...
	if (Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_4 == 0)
	{
	...
	iLocal_377 = unk_0x7CD6BC4C2BBDD526(Local_295, 0f, 0f, 0f, 2, false, false, 1f, 0f, 1f);
	unk_0x742A637471BCECD9(unk_0xD80958FC74E988A6(), iLocal_377, sLocal_356, &cLocal_365, 8f, -8f, 131072, 0, 1000f, 0);
	unk_0x9A1B3FCDB36C8697(iLocal_377);
	unk_0x8DFCED7A656F8802(true);
	func_54(unk_0x4F8644AF03D0E0D6(), 1, 0, 0);
	func_45(0);
	if (func_44(unk_0xD80958FC74E988A6()))
	{
	...
	func_41();
	unk_0x933D6A9EEC1BACD0(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 6);
	unk_0xE80492A9AC099A93(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 7);
	unk_0xE80492A9AC099A93(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), false);
	unk_0xE80492A9AC099A93(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 5);
	unk_0xE80492A9AC099A93(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 10);
	unk_0xE80492A9AC099A93(&(Global_1853348[unk_0x4F8644AF03D0E0D6() /*834*/].f_833), 14);
	func_40(func_78(1), Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_4, 0);
	Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_4 = -1;
...
void func_41()
{
	if (BitTest(uLocal_369, 8))
	{
		...
		func_42(&iLocal_300);
		func_42(&iLocal_298);
		unk_0x77ED170667F50170("SCRIPT\FERRIS_WHALE_01");
		unk_0x77ED170667F50170("SCRIPT\FERRIS_WHALE_02");
		unk_0xE80492A9AC099A93(&uLocal_369, 8);
	}
	unk_0xE80492A9AC099A93(&uLocal_369, 7);
}
...
void func_45(bool bParam0)
{
	if (bParam0)
	{
		...
		{
			func_52(0, 0);
			unk_0x933D6A9EEC1BACD0(&uLocal_369, 6);
		}
	}
	else if (BitTest(uLocal_369, 6))
	{
		func_46();
		unk_0xE80492A9AC099A93(&uLocal_369, 6);
	}
}
...
void func_47(int iParam0, int iParam1, bool bParam2)
{
	if (func_51())
	{
		...
		if ((!unk_0x05095437424397FA() && !func_48()) && !func_14(unk_0x4F8644AF03D0E0D6()))
		{
			Global_1057408 = 0;
		}
...
{
	if (!func_15(unk_0x4F8644AF03D0E0D6(), 1, 0) || iParam1)
	{
		if (!func_51())
		{
...
void func_53(int iParam0, int iParam1, int iParam2)
{
	if (!func_51() || iParam1)
	{
		Global_1574582 = 1;
		func_49(1);
		if (((!unk_0x05095437424397FA() && !func_48()) && !func_14(unk_0x4F8644AF03D0E0D6())) && !func_143(unk_0x4F8644AF03D0E0D6()))
		{
			Global_1057408 = 1;
		}
...
void func_54(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	else
	{
		...
		if (unk_0xB8DFD30D6973E135(bParam0) && (unk_0x5E9564D8246B909A(bParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_63(unk_0x4F8644AF03D0E0D6(), 0) && !func_62()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_58(iVar27) && !unk_0x26AA915AD89BFB4B(iVar27))
				{
					if (!bVar22)
					{
...
void func_67()
{
	...
	{
		if (!unk_0x2F844A8B08D76685("SCRIPT\FERRIS_WHALE_01", false, -1) || !unk_0x2F844A8B08D76685("SCRIPT\FERRIS_WHALE_02", false, -1))
		{
			...
			{
				unk_0x933D6A9EEC1BACD0(&uLocal_369, 7);
			}
			return;
		}
		else
		{
			unk_0x933D6A9EEC1BACD0(&uLocal_369, 8);
			unk_0x933D6A9EEC1BACD0(&uLocal_369, 7);
		}
	}
	switch (iLocal_378)
	{
		case 0:
			if (func_13(unk_0x4F8644AF03D0E0D6(), 1, 1) && !Global_1574582.f_6)
			{
				Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_3 = Local_1084.f_197[Local_1084.f_262 /*2*/];
				Local_295 = { unk_0x1899F328B0E12848(iLocal_290[Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_3], 0f, 0f, 0f) };
				if (!Local_1084.f_36[Local_1084.f_197[Local_1084.f_262 /*2*/] /*10*/][0])
				{
					Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_4 = 0;
				}
				...
				func_54(unk_0x4F8644AF03D0E0D6(), 0, 260, 0);
				func_45(1);
			...
			{
				unk_0xE80492A9AC099A93(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 9);
				func_40(func_78(1), Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_4, 1);
			}
			break;
		...
		case 1:
			...
			{
				iLocal_376 = unk_0x7CD6BC4C2BBDD526(Local_295, 0f, 0f, 0f, 2, true, false, 1f, 0f, 1f);
				unk_0x742A637471BCECD9(unk_0xD80958FC74E988A6(), iLocal_376, sLocal_356, &cLocal_357, 8f, -8f, 131072, 0, 1000f, 0);
				unk_0x9A1B3FCDB36C8697(iLocal_376);
				iLocal_378 = 2;
			}
			break;
		
		case 2:
			iVar2 = unk_0x02C40BF885C567B6(iLocal_376);
			if (unk_0xE4A310B1D7FA73CC(iVar2) > 0.99f)
			{
				iLocal_376 = unk_0x7CD6BC4C2BBDD526(Local_295, 0f, 0f, 0f, 2, false, true, 1f, 0f, 1f);
				unk_0x742A637471BCECD9(unk_0xD80958FC74E988A6(), iLocal_376, sLocal_356, &cLocal_361, 8f, -8f, 131072, 0, 1000f, 0);
				unk_0x9A1B3FCDB36C8697(iLocal_376);
				iLocal_378 = 3;
			}
			break;
		...
		case 3:
			...
			Var1 = { unk_0x2274BC1C4885E333(iLocal_290[Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_3], unk_0x3FEF770D40960D5A(unk_0xD80958FC74E988A6(), true)) };
			unk_0x6B9BBD38AB0796DF(unk_0xD80958FC74E988A6(), iLocal_290[Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_3], 0, Var1, 0f, 0f, unk_0xE83D4F9BA2A38914(unk_0xD80958FC74E988A6()), false, false, false, false, 2, true, 0);
			unk_0x267C78C60E806B9A(unk_0xD80958FC74E988A6(), true);
			func_68(func_78(0), Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_3, Var1, unk_0xE83D4F9BA2A38914(unk_0xD80958FC74E988A6()));
			unk_0x933D6A9EEC1BACD0(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 5);
			unk_0x933D6A9EEC1BACD0(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), false);
			unk_0xE80492A9AC099A93(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 9);
			iLocal_378 = 0;
			func_40(func_78(1), Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_4, 1);
			break;
...
int func_75(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (unk_0x10FAB35428CCC9D7() && !bParam3)
	{
		if (unk_0xF0D31AD191A74F87(unk_0xA2C6FC031D46FFF0(unk_0x7A5487FE9FAA6B48(), iParam0)) >= iParam2)
		{
			return 1;
		}
	}
	else if (unk_0xF0D31AD191A74F87(unk_0xA2C6FC031D46FFF0(unk_0x9CD27B0045628463(), iParam0)) >= iParam2)
	{
		return 1;
	}
	return 0;
...
void func_83()
{
	...
	if (BitTest(uLocal_369, 8))
	{
		iLocal_297 = unk_0x430386FE9BF80B45();
		unk_0xE65F427EB70AB1ED(iLocal_297, "GENERATOR", iLocal_291, "THE_FERRIS_WHALE_SOUNDSET", false, 0);
		iLocal_299 = unk_0x430386FE9BF80B45();
		unk_0xE65F427EB70AB1ED(iLocal_299, "SLOW_SQUEAK", iLocal_291, "THE_FERRIS_WHALE_SOUNDSET", false, 0);
		iLocal_300 = unk_0x430386FE9BF80B45();
		unk_0xE65F427EB70AB1ED(iLocal_300, "SLOW_SQUEAK", iLocal_290[1], "THE_FERRIS_WHALE_SOUNDSET", false, 0);
		iLocal_298 = unk_0x430386FE9BF80B45();
		unk_0xE65F427EB70AB1ED(iLocal_298, "CARRIAGE", iLocal_290[1], "THE_FERRIS_WHALE_SOUNDSET", false, 0);
	}
	func_84();
	unk_0xE80492A9AC099A93(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 5);
}
...
void func_91()
{
	if (BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 0))
	{
		...
		if (!unk_0xB0034A223497FFCB())
		{
			...
			if ((!BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 4) && !BitTest(Local_1084.f_3[unk_0x57A3BDDAD8E5AA0A()], 0)) && !BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 3))
			{
				if (unk_0x580417101DDB492F(2, 51))
				{
					unk_0x933D6A9EEC1BACD0(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 3);
		...
		if (iLocal_353 == 1)
		{
			...
			else
			{
				...
				unk_0x85973643155D0B07(Local_303.f_0, unk_0xAFBD61CC738D9EB9(unk_0xD80958FC74E988A6(), 2) + Local_303.f_14, 2);
...
void func_92()
{
	if (BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 0))
	{
		...
		{
			if (unk_0x85F01B8D5B90570E(iLocal_380))
			{
				if (iLocal_379)
				{
					Local_1081 = { func_105() };
					func_103(&uLocal_381);
					func_102(unk_0x0499D7B09FC9B407(2, 236, true), "AMFW_BTNCV", &uLocal_381, 0);
					if (!BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 3))
					{
						func_102(unk_0x0499D7B09FC9B407(2, 51, true), "AMFW_BTNEX", &uLocal_381, 0);
					}
					iLocal_379 = 0;
				}
		...
		{
			iLocal_380 = unk_0x11FE353CF9733E6F("instructional_buttons");
			unk_0x933D6A9EEC1BACD0(&uLocal_369, 4);
		}
	}
	else
	{
		unk_0x1D132D614DD86811(&iLocal_380);
		unk_0xE80492A9AC099A93(&uLocal_369, 4);
		iLocal_379 = 1;
	}
}
			...
			while (bVar0 < uParam2->f_693)
			{
				if (BitTest(uParam2->f_689, bVar0))
				{
					...
					if (!BitTest(uParam2->f_690, bVar0))
					{
						...
						func_97(unk_0x0499D7B09FC9B407(iVar1, iVar2, true));
						if (iVar3 < 363)
						{
							func_97(unk_0x0499D7B09FC9B407(iVar1, iVar3, true));
						}
					}
					else
					{
						...
						func_97(unk_0x80C2FD58D720C801(iVar4, iVar5, true));
					}
...
void func_106(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, float fParam7, bool bParam8)
{
	...
	if (iParam0->f_26)
	{
		iParam0->f_14 = func_107(iParam0->f_14, unk_0xBBDA792448DB5A89(-iParam0->f_21), unk_0xBBDA792448DB5A89(iParam0->f_21));
		iParam0->f_14.f_1 = func_107(iParam0->f_14.f_1, unk_0xBBDA792448DB5A89(-iParam0->f_22), unk_0xBBDA792448DB5A89(iParam0->f_22));
		iParam0->f_14.f_2 = func_107(iParam0->f_14.f_2, unk_0xBBDA792448DB5A89(-iParam0->f_20), unk_0xBBDA792448DB5A89(iParam0->f_20));
	}
...
void func_110(var uParam0)
{
	...
	if (*uParam0 == 1)
	{
		...
		if (unk_0xA7A932170592B50E(uParam0->f_10))
		{
			...
			if (!func_44(uParam0->f_8) && func_44(unk_0xD80958FC74E988A6()))
			{
			...
			{
				func_111(unk_0x3FEF770D40960D5A(uParam0->f_8, true), unk_0x3FEF770D40960D5A(uParam0->f_9, true), &uVar0, &uVar1, 1);
...
void func_113()
{
	...
	if (func_44(unk_0xD80958FC74E988A6()))
	{
		...
		if (bLocal_301)
		{
			...
			func_116(&Local_303, Var0, unk_0xAFBD61CC738D9EB9(unk_0xD80958FC74E988A6(), 2), 50f, Local_303.f_20, Local_303.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
			unk_0x61A3DBA14AB7F411(Local_303.f_0, unk_0xD80958FC74E988A6(), 31086, 0f, -0.25f, 0f, true);
		}
		else
		{
...
int func_114(var uParam0, bool bParam1, int iParam2)
{
	...
	if (*uParam0 == 1)
	{
		if (func_44(unk_0xD80958FC74E988A6()) && !func_44(uParam0->f_8))
		{
...
void func_116(var uParam0, struct<3> Param1, struct<3> Param2, float fParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10, bool bParam11)
{
	...
	*uParam0 = unk_0xC3981DCE61D9E13F("DEFAULT_SCRIPTED_CAMERA", false);
	...
	if (uParam0->f_23)
	{
		unk_0x299FAEBB108AE05B(iParam9);
	}
	uParam0->f_24 = 0;
	uParam0->f_25 = 0;
	uParam0->f_29 = 0f;
...
void func_117()
{
	...
	if (func_135(1) >= Global_262145.f_8253 || unk_0xAB3CAA6B422164DA(Global_262145.f_8253, false, false, true, -1, 0))
	{
		if (func_134())
		{
		...
		{
			unk_0x8A7B3952DD64D2B5(Global_262145.f_8253, 2, false, true, 0);
		}
		unk_0x933D6A9EEC1BACD0(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 8);
	}
	else if (!BitTest(uLocal_369, 3))
	{
		func_118(0, 31, 5);
		unk_0x933D6A9EEC1BACD0(&uLocal_369, 3);
	}
}
...
void func_118(int iParam0, int iParam1, int iParam2)
{
	...
	if (unk_0x10FAB35428CCC9D7() && func_15(unk_0x4F8644AF03D0E0D6(), 1, 0))
	{
		return;
	}
...
int func_123(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (!bVar0)
	{
		if (!unk_0xB24F0944DA203D9E(func_65()) || unk_0x810E8431C0614BF9())
		{
			Global_4535607 = 1;
			return 0;
		}
...
void func_136(char* sParam0, bool bParam1, int iParam2)
{
...
void func_149()
{
	...
	if (iLocal_355 != 0)
	{
		fVar2 = (IntToFloat(unk_0xA2C6FC031D46FFF0(unk_0x89023FBBF9200E9F(), iLocal_355)) / 1000f);
	}
	iLocal_355 = unk_0x89023FBBF9200E9F();
	...
	{
		unk_0x06843DA7060A026B(iLocal_291, Local_293, true, false, false, true);
		unk_0x8524A8B0171D5E07(iLocal_291, (-Global_2822699 - (360f / 16f)), 0f, 0f, 2, true);
		unk_0x428CA6DBD1094446(iLocal_291, true);
	}
	if (unk_0xB65B60556E2A9225("FAIRGROUND_RIDES_FERRIS_WHALE"))
	{
		if (func_44(unk_0xD80958FC74E988A6()))
		...
		unk_0xEF21A9EF089A2668("FAIRGROUND_RIDES_FERRIS_WHALE", "HEIGHT", (Var1.f_2 - fLocal_296));
	}
	iVar0 = 0;
	while (iVar0 < 16)
	{
...
void func_150(var uParam0)
{
	...
	{
		unk_0x06843DA7060A026B(iLocal_290[uParam0->f_5], Var0, true, false, false, true);
		unk_0x5927F96A78577363(iLocal_290[uParam0->f_5], 1000);
		unk_0x428CA6DBD1094446(iLocal_290[uParam0->f_5], true);
	}
}
...
Vector3 func_152(bool bParam0)
{
	...
	return unk_0x1899F328B0E12848(iLocal_291, 0f, (15.3f * unk_0x0BADBFA3B172435F(fVar0)), (-15.3f * unk_0xD0FFB162F40A139C(fVar0)));
}

int func_153()
{
	unk_0xD3BD40951412FEF6(sLocal_356);
	unk_0xD3BD40951412FEF6(sLocal_289);
	unk_0x963D27A58DF860AC(iLocal_287);
	unk_0x963D27A58DF860AC(iLocal_288);
	if (!unk_0xD031A9162D01088C(sLocal_356))
	{
		return 0;
	}
	if (!unk_0xD031A9162D01088C(sLocal_289))
	{
		return 0;
	}
	if (!unk_0x98A4EB5D89A0C952(iLocal_287))
	{
		return 0;
	}
	if (!unk_0x98A4EB5D89A0C952(iLocal_288))
	{
		return 0;
	}
	func_156();
...
void func_156()
{
	...
	iVar0 = 0;
	Global_2822699 = 0f;
	iLocal_291 = unk_0x509D5878EB39E842(iLocal_287, 0f, 1f, 2f, false, false, false);
	unk_0x06843DA7060A026B(iLocal_291, Local_293, true, false, false, true);
	unk_0x8524A8B0171D5E07(iLocal_291, Global_2822699, 0f, 0f, 2, true);
	unk_0x428CA6DBD1094446(iLocal_291, true);
	unk_0x5927F96A78577363(iLocal_291, 1000);
	unk_0x3882114BDE571AD4(iLocal_291, true);
	unk_0x1A092BB0C3808B96(iLocal_291, false);
	if (!unk_0xB65B60556E2A9225("FAIRGROUND_RIDES_FERRIS_WHALE"))
	{
		unk_0x013A80FC08F6E4F2("FAIRGROUND_RIDES_FERRIS_WHALE");
	}
...
{
	uParam0->f_5 = iParam1;
	iLocal_290[uParam0->f_5] = unk_0x509D5878EB39E842(iLocal_288, 0f, 1f, 2f, false, false, false);
	unk_0x3882114BDE571AD4(iLocal_290[uParam0->f_5], true);
	func_150(uParam0);
}
...
void func_162(int iParam0)
{
	...
	if (unk_0x83CD99A1E6061AB5())
	{
		...
		{
			unk_0xE80492A9AC099A93(&(Local_1084.f_2), 3);
			unk_0xE80492A9AC099A93(&(Local_1084.f_2), 2);
...
void func_163(int iParam0)
{
	...
	if (unk_0x2902843FCD2B2D79(1, iParam0, &Var0, 3))
	{
		if (!Var0.f_2)
		{
			if (BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 0))
			{
				unk_0x933D6A9EEC1BACD0(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 10);
			}
			else
			{
				unk_0x933D6A9EEC1BACD0(&(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2), 9);
			}
		}
	}
}
...
void func_170(int iParam0)
{
	...
	if (unk_0x2902843FCD2B2D79(1, iParam0, &Var0, 7))
	{
		if (Var0.f_2 != -1)
		{
			...
			{
				unk_0x267C78C60E806B9A(iVar1, true);
				unk_0x6B9BBD38AB0796DF(iVar1, iLocal_290[Var0.f_2], 0, Var0.f_3, 0f, 0f, Var0.f_6, false, false, false, false, 2, true, 0);
			}
		}
	}
}
...
void func_171(int iParam0)
{
	...
	if (unk_0x2902843FCD2B2D79(1, iParam0, &Var0, 2))
	{
		if (BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 0))
		{
			unk_0x267C78C60E806B9A(unk_0xD80958FC74E988A6(), true);
			Var1 = { unk_0x2274BC1C4885E333(iLocal_290[Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_3], unk_0x3FEF770D40960D5A(unk_0xD80958FC74E988A6(), true)) };
			func_68(func_133(Var0.f_1), Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_3, Var1, unk_0xE83D4F9BA2A38914(unk_0xD80958FC74E988A6()));
		}
	}
}
...
int func_180()
{
	...
	if (func_181() != 0)
	{
		if (unk_0x2C83A9DA6BFFC4F9(func_181()) == 0)
		{
			return 1;
		}
	}
...
void func_188()
{
	...
	if (unk_0x10FAB35428CCC9D7())
	{
		if (BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 0) || func_179())
		{
			if (func_151(unk_0xD80958FC74E988A6()) && unk_0xB346476EF1A64897(unk_0xD80958FC74E988A6()))
			{
				unk_0x961AC54BF0613F5D(unk_0xD80958FC74E988A6(), true, true);
			}
			if (BitTest(Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/].f_2, 0))
...
int func_197(struct<21> Param0)
{
	...
	func_199(0, -1, 0);
	unk_0x3E9B2F01C50DF595(&Local_1084, 264, 0);
	unk_0x3364AA97340CA215(&Local_1086, 161, 0);
	unk_0xAA391C728106F7AF(false);
	Local_1086[unk_0x57A3BDDAD8E5AA0A() /*5*/] = 0;
	func_198(func_78(1));
	return 1;
}
...
void func_202(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!unk_0x10FAB35428CCC9D7())
	{
		func_201();
